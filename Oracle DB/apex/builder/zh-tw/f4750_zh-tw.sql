...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,4757)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A285113023776221429')
...
,p_last_upd_yyyymmddhh24miss=>'20180830080344'
...
,p_list_item_link_text=>unistr('\5957\88DD\61C9\7528\7A0B\5F0F\6587\4EF6')
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719110388769175385.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719111277961175386.4757)
,p_list_item_display_sequence=>361
,p_list_item_link_text=>unistr('\5168\90E8\516C\7528\7A0B\5F0F')
,p_list_item_link_target=>'f?p=4800:2:&SESSION.:'
,p_parent_list_item_id=>wwv_flow_api.id(719110951891175386.4757)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719111571406175386.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719111873291175386.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719112153192175386.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719112445248175386.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719112708660175386.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719113037557175386.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719113360673175386.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719113608344175387.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719113963784175387.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719114238664175387.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719114524363175387.4757)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719114837155175388.4757)
...
,p_list_item_disp_cond_type=>'PLSQL_EXPRESSION'
,p_list_item_disp_condition=>'wwv_flow_platform.get_preference(''SERVICE_REQUESTS_ENABLED'') = ''Y'''
,p_list_text_01=>unistr('\8981\6C42\5B58\53D6\984D\5916\7684\5132\5B58\9AD4\6216\7D42\6B62\5DE5\4F5C\5340.')
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1082517820044623392.4757)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(2006202085640903486.4757)
,p_plugin_type=>'REGION TYPE'
...
,p_lov_disp_sequence=>20
,p_lov_disp_value=>unistr('\555F\7528 REST \7684 SQL')
,p_lov_return_value=>'&nbsp;'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(49859564794480260.4757)
,p_lov_disp_sequence=>30
,p_lov_disp_value=>unistr('Web \4F86\6E90\6A21\7D44')
...
'',
unistr('\4E92\52D5\5F0F\65B9\683C')))
...
,p_lov_disp_value=>unistr('SQL \5DE5\4F5C\5BA4 - Restful \670D\52D9')
...
,p_lov_disp_sequence=>2
,p_lov_disp_value=>unistr('\8981\6C42\66F4\591A\5132\5B58\9AD4')
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4757)
,p_short_name=>unistr('\8981\6C42\66F4\591A\5132\5B58\9AD4')
...
,p_short_name=>unistr('<span class="u-VisuallyHidden">\61C9\7528\7A0B\5F0F</span><span class="a-Icon icon-breadcrumb-previous" title="Apps"></span>')
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_plugin_type=>'REGION TYPE'
,p_name=>'COM.ORACLE.APEX.RAPHAEL.JUSTGAGE'
,p_display_name=>unistr('JustGage \91CF\8868 ***')
,p_supported_ui_types=>'DESKTOP'
,p_supported_component_types=>'APEX_APPLICATION_PAGE_ITEMS'
...
,p_reference_id=>7534122046207970661.4757
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
,p_files_version=>7
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024533829863217389.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024534250295217389.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024534614937217389.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024535094921217390.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2024535427124217390.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2024535094921217390.4757)
,p_display_sequence=>10
,p_display_value=>' '
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024535942300217390.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
,p_display_length=>20
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_api.id(2024535094921217390.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024536345289217391.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024536773919217391.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024537120880217391.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024537553989217391.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2024543227106217394.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2024537945517217391.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2024537553989217391.4757)
,p_display_sequence=>10
,p_display_value=>' '
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024538404894217392.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2024538819041217392.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2024538404894217392.4757)
,p_display_sequence=>10
,p_display_value=>' '
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024539372411217392.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
,p_display_length=>5
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2024538404894217392.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024539785495217392.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024540119407217392.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024540585021217392.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2024540914685217392.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2024540585021217392.4757)
,p_display_sequence=>10
,p_display_value=>'Dynamic Green-to-Red'
,p_return_value=>'GTR'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2024541471231217393.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2024540585021217392.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2024541970819217394.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2024540585021217392.4757)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024542467045217394.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2024540585021217392.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024542892625217394.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024543227106217394.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2024543631421217394.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2024543227106217394.4757)
,p_display_sequence=>10
,p_display_value=>'Normal'
,p_return_value=>'GAUGE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2024544134026217394.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2024543227106217394.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024544630930217395.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024545061199217395.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024545477572217396.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024545892399217396.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024546237864217396.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024546657668217396.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2024547063771217396.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(845156083241834533.4757)
,p_plugin_id=>wwv_flow_api.id(3321999852992080663.4757)
,p_name=>'SOURCE_SQL'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_plugin_type=>'REGION TYPE'
,p_name=>'COM.ORACLE.APEX.FLOT.LINE'
,p_display_name=>unistr('Flot \6298\7DDA\5716 v2 ***')
,p_supported_ui_types=>'DESKTOP'
,p_supported_component_types=>'APEX_APPLICATION_PAGE_ITEMS'
...
,p_substitute_attributes=>false
,p_reference_id=>7889316075630806158.4757
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'2.0'
,p_files_version=>20
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010897423255119021.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010897825219119022.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'APPLICATION'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010898246315119022.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2010914647289119032.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010898659224119022.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010899095920119022.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010899457754119023.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010899095920119022.4757)
,p_display_sequence=>10
,p_display_value=>' '
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010899949207119023.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2010899095920119022.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010900323720119023.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010900702929119023.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2010917743161119033.4757)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010901168359119023.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010900702929119023.4757)
,p_display_sequence=>10
,p_display_value=>'Don''t show'
,p_return_value=>'NONE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010901633481119023.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010900702929119023.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010902188742119024.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010900702929119023.4757)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010902617659119025.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010900702929119023.4757)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010903126484119025.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010900702929119023.4757)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010903600671119025.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010900702929119023.4757)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010904181184119025.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010904521873119025.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010904181184119025.4757)
,p_display_sequence=>10
,p_display_value=>'X'
,p_return_value=>'X'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010905012264119026.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010904181184119025.4757)
,p_display_sequence=>20
,p_display_value=>'Y'
,p_return_value=>'Y'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010905563255119026.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
,p_display_length=>20
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_api.id(2010904181184119025.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010905994167119026.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>90
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010906318148119026.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010906795173119027.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010906318148119026.4757)
,p_display_sequence=>0
,p_display_value=>'Show series name'
,p_return_value=>'SERIES'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010907272545119027.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010906318148119026.4757)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010907720387119027.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010906318148119026.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010908244493119027.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010906318148119026.4757)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010908759919119027.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2010906318148119026.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010909176730119028.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010909506334119029.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010909176730119028.4757)
,p_display_sequence=>10
,p_display_value=>' '
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010910048298119029.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010910408836119029.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010910048298119029.4757)
,p_display_sequence=>10
,p_display_value=>'Modern'
,p_return_value=>'MODERN'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010910986827119029.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010910048298119029.4757)
,p_display_sequence=>20
,p_display_value=>'Modern 2'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010911455913119029.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010910048298119029.4757)
,p_display_sequence=>30
,p_display_value=>'Solar'
,p_return_value=>'SOLAR'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010911995344119031.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010910048298119029.4757)
,p_display_sequence=>40
,p_display_value=>'Metro'
,p_return_value=>'METRO'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010912421469119031.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010910048298119029.4757)
,p_display_sequence=>50
,p_display_value=>'Custom'
,p_return_value=>'CUSTOM'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010912965228119031.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010910048298119029.4757)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010913412349119031.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2010910048298119029.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'CUSTOM'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010913841175119031.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
...
begin
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010914230673119032.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
,p_display_sequence=>12
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010914647289119032.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
,p_display_sequence=>2
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010915037606119032.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010914647289119032.4757)
,p_display_sequence=>10
,p_display_value=>'TIMESTAMP'
,p_return_value=>'TIMESTAMP'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010915529419119032.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010914647289119032.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010916010975119033.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010914647289119032.4757)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010916580553119033.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>18
,p_display_sequence=>0
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010916986838119033.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>19
,p_display_sequence=>1
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010917303227119033.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010917743161119033.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>21
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010918182501119034.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010917743161119033.4757)
,p_display_sequence=>10
,p_display_value=>'Lines'
,p_return_value=>'LINE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010918690982119034.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010917743161119033.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010919188536119034.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>22
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2010919577598119034.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2010919188536119034.4757)
,p_display_sequence=>10
,p_display_value=>' '
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010920060889119035.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>23
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2010920419638119035.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>24
,p_display_sequence=>240
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(845156251376834537.4757)
,p_plugin_id=>wwv_flow_api.id(6509424821991051573.4757)
,p_name=>'SOURCE_SQL'
,p_sql_min_column_count=>2
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_plugin_type=>'REGION TYPE'
,p_name=>'COM.ORACLE.APEX.FLOT.PIE'
,p_display_name=>unistr('Flot \5713\9905\5716 v2 ***')
,p_supported_ui_types=>'DESKTOP:JQM_SMARTPHONE'
,p_supported_component_types=>'APEX_APPLICATION_PAGE_ITEMS'
...
,p_substitute_attributes=>false
,p_reference_id=>10867904589400691404.4757
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'2.0'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006181367767903476.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'APPLICATION'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Min Aspect Ratio'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006181778775903476.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'APPLICATION'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006182168651903476.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006182566778903476.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006182917098903476.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006194385102903482.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006183392822903477.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006183725045903477.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006184174828903477.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006183725045903477.4757)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STANDARD'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006184682515903478.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006183725045903477.4757)
,p_display_sequence=>20
,p_display_value=>'Donut'
,p_return_value=>'DONUT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006185138703903478.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006183725045903477.4757)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006185655090903478.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006183725045903477.4757)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006186177809903478.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006186541478903478.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006186961665903478.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006186541478903478.4757)
,p_display_sequence=>5
,p_display_value=>'Legend'
,p_return_value=>'LEGEND'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006187480226903479.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006186541478903478.4757)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006187944089903479.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006186541478903478.4757)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006188410763903479.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006186541478903478.4757)
,p_display_sequence=>40
,p_display_value=>'Value'
,p_return_value=>'VALUE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006188999780903479.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>90
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006189396965903480.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
,p_default_value=>'10'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006188999780903479.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006189710147903480.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006189396965903480.4757)
,p_display_sequence=>10
,p_display_value=>'1%'
,p_return_value=>'1'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006190237833903480.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006189396965903480.4757)
,p_display_sequence=>20
,p_display_value=>'2%'
,p_return_value=>'2'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006190707617903480.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006189396965903480.4757)
,p_display_sequence=>30
,p_display_value=>'5%'
,p_return_value=>'5'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006191269268903480.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006189396965903480.4757)
,p_display_sequence=>40
,p_display_value=>'10%'
,p_return_value=>'10'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006191773444903480.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006189396965903480.4757)
,p_display_sequence=>50
,p_display_value=>'15%'
,p_return_value=>'15'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006192293975903481.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006189396965903480.4757)
,p_display_sequence=>60
,p_display_value=>'20%'
,p_return_value=>'20'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006192787116903482.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006193117609903482.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006193592376903482.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006193994713903482.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
...
,p_max_length=>5
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006183725045903477.4757)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006194385102903482.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006197205493903484.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006194385102903482.4757)
,p_display_sequence=>10
,p_display_value=>'Modern'
,p_return_value=>'MODERN'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006194707423903482.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006194385102903482.4757)
,p_display_sequence=>20
,p_display_value=>'Modern 2'
,p_return_value=>'MODERN2'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006195213595903483.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006194385102903482.4757)
,p_display_sequence=>30
,p_display_value=>'Solar'
,p_return_value=>'SOLAR'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006195776388903483.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006194385102903482.4757)
,p_display_sequence=>40
,p_display_value=>'Metro'
,p_return_value=>'METRO'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006196204029903483.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006194385102903482.4757)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006196714940903483.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006194385102903482.4757)
,p_display_sequence=>60
,p_display_value=>'Custom'
,p_return_value=>'CUSTOM'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006197744553903484.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006198192263903484.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006198597161903484.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>18
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006198885398903484.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>19
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(845156303650834538.4757)
,p_plugin_id=>wwv_flow_api.id(9468150220120001830.4757)
,p_name=>'SOURCE_SQL'
,p_sql_min_column_count=>1
...
unistr('<p><a target="_blank" href="&SYSTEM_HELP_URL./HTMDB/utilizing-packaged-app-admin.htm#HTMDB30151">\77AD\89E3\5176\4ED6\8CC7\8A0A ...</a></p>')))
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(818313389467802103.4757)
,p_plug_name=>unistr('\6700\5E38\4F7F\7528\7684\4F7F\7528\8005')
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4757)
...
,p_error_message=>unistr('\8981\6C42\7684\5132\5B58\9AD4\6578\91CF\7121\6548.')
...
wwv_flow_api.create_page(
 p_id=>101.4757
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4757)
,p_name=>unistr('\8981\6C42\66F4\591A\5132\5B58\9AD4 - \5B9A\7FA9\8981\6C42')
,p_step_title=>unistr('\8981\6C42\66F4\591A\5132\5B58\9AD4 - \5B9A\7FA9\8981\6C42')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
...
,p_name=>unistr('\8981\6C42\66F4\591A\5132\5B58\9AD4')
...
,p_plug_name=>unistr('\8981\6C42\66F4\591A\5132\5B58\9AD4')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'DEFAULT'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(805132117516607920.4757)
...
,p_prompt=>unistr('\8981\65B0\589E\7684\5132\5B58\9AD4\5927\5C0F (MB):')
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page(
 p_id=>104.4757
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4757)
,p_name=>unistr('\8981\6C42\66F4\591A\5132\5B58\9AD4 - \78BA\8A8D')
,p_step_title=>unistr('\8981\6C42\66F4\591A\5132\5B58\9AD4 - \78BA\8A8D')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4757)
,p_button_is_hot=>'Y'
,p_button_image_alt=>unistr('\8981\6C42\66F4\591A\5132\5B58\9AD4')
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
...
'end;'))
,p_process_error_message=>unistr('\8981\6C42\984D\5916\5132\5B58\9AD4\6642\767C\751F\932F\8AA4.')
,p_process_when_button_id=>wwv_flow_api.id(805366770901561427.4757)
,p_process_success_message=>unistr('\60A8\8981\6C42 &P101_STORAGE. MB \7684\984D\5916\5132\5B58\9AD4.')
...
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p><strong>\611F\8B1D\60A8\91DD\5C0D &PRODUCT_NAME. \63D0\4F9B\5BF6\8CB4\7684\610F\898B\56DE\994B!</strong></p>'),
unistr('<p>\9032\4E00\6B65\77AD\89E3 <a target="_blank" href="https://apex.oracle.com/pls/apex/f?p=520052:FEATURES:::NO:::">APEX 18.1 \7684\529F\80FD</a>, \4E26\4E14\6AA2\95B1 <a target="_blank" href="https://apex.oracle.com/pls/apex/apex_pm/r/520052/files/static/v56/jsdoc/index.html">JavaScript \6587\4EF6</a>.</')
||'p>',
unistr('<p>\8F38\5165\610F\898B\56DE\994B\4E4B\524D, \8ACB\5148\6AA2\95B1<a target="_blank" href="https://apex.oracle.com/pls/apex/f?p=520052:KNOWN-ISSUES:::NO:::">\5DF2\77E5\554F\984C</a>, \4E0A\9762\7684\8CC7\8A0A\90FD\5B9A\671F\4EE5\6B64\300C\6436\9BAE\7248\300D\7684\6700\5E38\898B\554F\984C\8207\9650\5236\505A\66F4\65B0.<br>'),
unistr('\8ACB\524D\5F80<a target="_blank" href="&P11001_FEEDBACK_URL.">\6436\9BAE\7248\516C\958B\610F\898B\56DE\994B</a>\77AD\89E3\56DE\8986\548C\5F8C\7E8C\8FFD\8E64.</p>'),
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
