...
,p_default_application_id=>4300
,p_default_owner=>'APEX_180200'
);
end;
/
 
prompt APPLICATION 4300 - Oracle APEX Data Workshop
--
-- Application Export:
--   Application:     4300
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,4300)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'4300')
...
,p_documentation_banner=>'Oracle Application Express data management utilities.'
,p_authentication=>'PLUGIN'
,p_authentication_id=>wwv_flow_api.id(539653303570634151)
,p_populate_roles=>'A'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(2202106852499122)
,p_name=>'Data Workshop Home Page Icons'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(260022612007597680)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(260023118587599550)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2206807807518397)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3648913903408259)
,p_name=>'data import'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(220739912737841935)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3653931134432189)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3931814922814551)
,p_name=>'Plain Text Data Import'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3932708473822070)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3933320594825587)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3933729944828323)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3934205141830584)
,p_name=>'Plain Text Data Import2'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3935014837833421)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Table Owner and Name'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'22'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3935628343837346)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'File Details'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3935901116838942)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(74707671328250039)
,p_name=>'Data Loading'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2638109323313851)
,p_list_item_display_sequence=>10
...
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>'Load data from structured flat files, such as files with comma separated data (csv) or tab separated data.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(74710220544263433)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(171168300110560910)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(75585889878824332)
,p_name=>'Data Unloading'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(75614520977877818)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(75616418561883144)
,p_list_item_display_sequence=>30
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(104358211508848205)
,p_name=>'Plain Text Data Export'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(104369115334180721)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(104371204982185568)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(112716503290208213)
,p_name=>'Excel Data Import'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204680314570920715)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(112719626353212694)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(112720322256214662)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Table Properties'
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'200,210,220,230'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(117063907614069206)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Primary Key'
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'200,210,220,230'
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(204693724897946351)
,p_name=>'Excel Data Import2'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204695520153948493)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204698011742952420)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Table Owner and Name'
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204702125748961090)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Data'
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'240,260,270'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204711009357968724)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Column Mapping'
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'240,260,270'
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(697382068928001818)
,p_name=>'APEX 5 - Administration (Header)'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697382206098001819)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697382502013001824)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697382891464001824)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697383150352001827)
,p_list_item_display_sequence=>210
,p_list_item_link_text=>'Manage Service'
,p_list_item_link_target=>'f?p=4350:21:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(697382891464001824)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697383440829001827)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697383714500001828)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697384038930001828)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697384322750001828)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697384679765001828)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697384955467001832)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697385224525001832)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697385572574001832)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(1250636556640192780)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(697413399059052182)
,p_name=>'APEX 5 - Help'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697413586319052182)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2105952923293025164)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2185440800402478745)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697414494575052183)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'---'
,p_list_item_link_target=>'separator'
,p_list_item_current_type=>'TARGET_PAGE'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697414778925052183)
,p_list_item_display_sequence=>50
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(718988657702143721)
,p_name=>'APEX 5 - Tabs'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718988842906143722)
,p_list_item_display_sequence=>100
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718989111037143726)
,p_list_item_display_sequence=>110
,p_list_item_link_text=>'Database Applications'
,p_list_item_link_target=>'f?p=4000:1500:&SESSION.::&DEBUG.::P1500_SHOW:DATABASE:'
,p_parent_list_item_id=>wwv_flow_api.id(718988842906143722)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718989405911143726)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718989747866143727)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718990080119143727)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718990361569143729)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718990613085143729)
,p_list_item_display_sequence=>150
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718990955731143729)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718991291702143729)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718991584443143730)
...
,p_parent_list_item_id=>wwv_flow_api.id(718991291702143729)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718991801399143730)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718992140150143730)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718992741957143730)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718993081390143731)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718993347641143731)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718993626969143731)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718993986713143731)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718994253577143731)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718994566071143731)
,p_list_item_display_sequence=>200
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718994850225143732)
,p_list_item_display_sequence=>210
,p_list_item_link_text=>'Object Browser'
,p_list_item_link_target=>'f?p=4500:1001:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(718994566071143731)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718995124049143732)
,p_list_item_display_sequence=>220
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718995499947143732)
,p_list_item_display_sequence=>230
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718995706005143732)
,p_list_item_display_sequence=>240
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718996015547143732)
,p_list_item_display_sequence=>241
,p_list_item_link_text=>'All Utilities'
,p_list_item_link_target=>'f?p=4500:1005:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(718995706005143732)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718996329468143733)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718996661572143733)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718996948262143733)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(31857489782444317)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(670885068143927641)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718997212313143733)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718997530238143733)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718999007388143734)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(670884758845925653)
,p_list_item_display_sequence=>250
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718999349755143734)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718998433413143734)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718998124709143734)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718998775140143734)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718999661410143734)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718999920942143734)
,p_list_item_display_sequence=>300
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719000200495143734)
,p_list_item_display_sequence=>310
,p_list_item_link_text=>'Milestones'
,p_list_item_link_target=>'f?p=4800:6006:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(718999920942143734)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719000507420143734)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719000816388143735)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719001169653143735)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719001409743143735)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719001716284143735)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719002021894143735)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719002368925143735)
,p_list_item_display_sequence=>361
,p_list_item_link_text=>'All Utilities'
,p_list_item_link_target=>'f?p=4800:2:&SESSION.:'
,p_parent_list_item_id=>wwv_flow_api.id(719002021894143735)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719002662619143736)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719002979626143737)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719003213232143737)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719003537077143737)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719003866862143737)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719004113111143737)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719004487421143737)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719004793890143738)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719005043331143738)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719005393350143738)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719005649685143739)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719005956050143739)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719006217814143739)
,p_list_item_display_sequence=>400
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719006508197143740)
...
,p_parent_list_item_id=>wwv_flow_api.id(719006217814143739)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719006810190143740)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(780156297074326443)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719007190968143740)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1930451852408035)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14848517159940928)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(91973940177572341)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1082459947139623110)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1765072320094712054)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1831722549104993877)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1917670476828940076)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(10763432184894214)
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(10766802982027753)
,p_name=>'Flow: EDIT'
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(10767409693039076)
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(10770526811204883)
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(12521431744512635)
,p_name=>'Flow: ADMIN'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(12527124696576833)
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(388304690603143191)
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(517058043352714021)
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(786533090058102287)
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(1364313342198532)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(39955524108615064)
,p_icon_sequence=>20
...
wwv_flow_api.create_flow_process(
 p_id=>wwv_flow_api.id(49906314503034042)
...
begin
wwv_flow_api.create_flow_process(
 p_id=>wwv_flow_api.id(234080556000997661)
,p_process_sequence=>1
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(5126097226)
,p_name=>'COMPANY'
,p_scope=>'GLOBAL'
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25339931440732484)
,p_name=>'F4300_IMEX_BATCH_ID'
,p_data_type=>'NUMBER'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(48603115971458169)
,p_name=>'F4300_LAST_VIEW'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(242549145362)
,p_name=>'F4300_LOAD_JOB'
,p_data_type=>'NUMBER'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(147029609296398557)
,p_name=>'FSP_AFTER_LOGIN_URL'
,p_item_comment=>'Used by Custom2 authentication for deep linking support'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(63051450385643584)
,p_name=>'G_USER_DEFAULT_DATE_FORMAT'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(48610196642071039)
,p_name=>'LAST_VIEW'
);
end;
/
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(5128100953)
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(63051862410648965)
,p_computation_sequence=>10
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(23546816846659473)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87944005995777613)
,p_lov_name=>'EXPORT.AS.FILE.Y'
,p_lov_query=>'.'||wwv_flow_api.id(87944005995777613)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87944229029777613)
,p_lov_disp_sequence=>10
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87945815476789819)
,p_lov_name=>'INCLUDE.COL.NAMES.Y'
,p_lov_query=>'.'||wwv_flow_api.id(87945815476789819)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87946002718789820)
,p_lov_disp_sequence=>10
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87953325959849588)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(182776719411)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(162716910286446218)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(236956028332134846)
,p_lov_name=>'P2_LOAD'
,p_lov_query=>'.'||wwv_flow_api.id(236956028332134846)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(236956315568134853)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'My Import'
,p_lov_return_value=>'MY'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(236956532195134859)
,p_lov_disp_sequence=>2
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87931511182663028)
,p_lov_name=>'PRESERVE.CASE.Y'
,p_lov_query=>'.'||wwv_flow_api.id(87931511182663028)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87931730659663028)
,p_lov_disp_sequence=>10
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87918702852509211)
,p_lov_name=>'RESTRICT.LOAD.FILES'
,p_lov_query=>'.'||wwv_flow_api.id(87918702852509211)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87918901897509212)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'My Import Files'
,p_lov_return_value=>'MY'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87919109206509212)
,p_lov_disp_sequence=>20
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87930425596657700)
,p_lov_name=>'YES.NO.RETURNS_Y_OR_N'
,p_lov_query=>'.'||wwv_flow_api.id(87930425596657700)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87930802381657701)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Yes'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87930609321657701)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'No'
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(182782926995)
,p_lov_name=>'YES_NO'
,p_lov_query=>'.'||wwv_flow_api.id(182782926995)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(182785927024)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Yes'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(182787927024)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'No'
,p_lov_return_value=>'N'
);
...
wwv_flow_api.create_page_group(
 p_id=>wwv_flow_api.id(216950505720834051)
,p_group_name=>'Home / Common / About / Nav'
);
wwv_flow_api.create_page_group(
 p_id=>wwv_flow_api.id(215729525348581243)
...
wwv_flow_api.create_page_group(
 p_id=>wwv_flow_api.id(215731706086585147)
,p_group_name=>'Plain Text Upload'
);
wwv_flow_api.create_page_group(
 p_id=>wwv_flow_api.id(215731303316584395)
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(6678815232629976)
,p_name=>'dataworkshop.menu'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2211613627528920)
,p_parent_id=>wwv_flow_api.id(174561719510562263)
,p_short_name=>'Data Workshop'
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6682115379645994)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
,p_link=>'f?p=&APP_ID.:230:&SESSION.::&DEBUG.:::'
,p_page_id=>230
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6686911916662790)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6690530882669221)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6692619668674394)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6694113198677405)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6695107375680103)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6828030820688031)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6829415292695176)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6830608822698182)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6837120647738320)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6844627307765634)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6848706388775367)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Unload to Text'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(7700814894541393)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(9390600588273869)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23356717195631333)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23359105981636561)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23360528181641436)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23362831810685340)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23364720380690653)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23366014557693362)
,p_parent_id=>wwv_flow_api.id(2211613627528920)
,p_short_name=>'Load Data'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(28488306101493931)
,p_parent_id=>0
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(75399131516711549)
,p_parent_id=>wwv_flow_api.id(6837120647738320)
,p_short_name=>'Text Data Load Details'
,p_link=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.:::'
,p_page_id=>7
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(164746407711995921)
,p_parent_id=>wwv_flow_api.id(174561719510562263)
,p_short_name=>'Manage Sample Dataset'
,p_link=>'f?p=&APP_ID.:100:&SESSION.'
,p_page_id=>100
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(165246328822963208)
,p_parent_id=>wwv_flow_api.id(164746407711995921)
,p_short_name=>'Load Sample Dataset - Results'
,p_link=>'f?p=&APP_ID.:130:&SESSION.::&DEBUG.:::'
,p_page_id=>130
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(165255972610970183)
,p_parent_id=>wwv_flow_api.id(164746407711995921)
,p_short_name=>'Load Sample Dataset'
,p_link=>'f?p=&APP_ID.:120:&SESSION.::&DEBUG.:::'
,p_page_id=>120
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(165268766487976362)
,p_parent_id=>wwv_flow_api.id(164746407711995921)
,p_short_name=>'Manage Sample Dataset'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(174561719510562263)
,p_parent_id=>wwv_flow_api.id(28488306101493931)
,p_short_name=>'Utilities'
,p_link=>'f?p=4500:1005:&SESSION.'
,p_page_id=>8888
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(236917018865057364)
,p_parent_id=>wwv_flow_api.id(9390600588273869)
,p_short_name=>'Spreadsheet Load Details'
,p_link=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.:::'
,p_page_id=>2
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(388323657510153942)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9113661096283)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(3485606247566446)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7505408382227958)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(208580315559534207)
,p_theme_id=>3
,p_name=>'APEX 4.2 - Wizard '
...
,p_grid_emit_empty_trail_cols=>false
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>42231511193339128
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(471759212441917909)
,p_theme_id=>3
,p_name=>'APEX 4.2 - No SideBar'
...
,p_grid_emit_empty_trail_cols=>false
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>187453329378870285
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716604580917788355)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716604939833788366)
,p_theme_id=>3
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159369298995512189)
,p_page_template_id=>wwv_flow_api.id(716604939833788366)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159369780341512189)
,p_page_template_id=>wwv_flow_api.id(716604939833788366)
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716607252394788370)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716607780903788372)
,p_theme_id=>3
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159361976488512183)
,p_page_template_id=>wwv_flow_api.id(716607780903788372)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159362487492512183)
,p_page_template_id=>wwv_flow_api.id(716607780903788372)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159362919641512183)
,p_page_template_id=>wwv_flow_api.id(716607780903788372)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159363478975512184)
,p_page_template_id=>wwv_flow_api.id(716607780903788372)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159363931520512184)
,p_page_template_id=>wwv_flow_api.id(716607780903788372)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159364483913512184)
,p_page_template_id=>wwv_flow_api.id(716607780903788372)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159364908413512185)
,p_page_template_id=>wwv_flow_api.id(716607780903788372)
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716609164058788372)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716609648731788373)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716613771837788376)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1184364303968453797)
,p_theme_id=>3
,p_name=>'APEX 4.1 - Optional Right Sidebar (Table)'
...
,p_grid_emit_empty_trail_cols=>false
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>450655205700156564
,p_translate_this_template=>'N'
);
end;
/
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(388298521291079233)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(388298732478079235)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(716616681872794730)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(716616877554794734)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(716617173062794734)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(716617477116794735)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9113673096289)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(101735615849237059)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(104263607591363808)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170264105041113342)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170268110269113348)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170269127235113349)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aRegion sideRegion #REGION_CSS_CLASSES#" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="aRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170270131526113350)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(208585513765537107)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(208585923103537108)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(208586424307537108)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aWizardRegion dividerTop" #REGION_ATTRIBUTES# id="#REGION_STATIC_ID#">',
'  <div class="wizardRegionHeading">',
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>42210116661242480
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(208586913756537109)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>42210411889242480
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(279748823389483962)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(388246039131933975)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(388246630957934005)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="a-Region #REGION_CSS_CLASSES#" #REGION_ATTRIBUTES# id="#REGION_STATIC_ID#">',
'  <div class="a-Region-header">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(388251521427936641)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716642617570817147)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716643236475817156)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716648790045817165)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716658831322817171)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716660784129817173)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716661407318817173)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716662167050817173)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716662948592817174)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716673270402817181)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716673932750817181)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716674688097817182)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716675364323817183)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716676055535817183)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aWizardRegion" #REGION_ATTRIBUTES# id="#REGION_STATIC_ID#">',
'  <div class="wizardRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716676747173817184)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716677498440817185)
,p_layout=>'TABLE'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(3482816826549973)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(119835024987557728)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(170283117853932398)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(187647214478984350)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(208592324393539718)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(388254947243942451)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(388255255364942452)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li data-id="#A01#" data-disabled="#A02#" data-hide="#A03#" data-shortcut="#A05#" data-icon="#IMAGE#"><a href="#LINK#" title="#A04#">#TEXT_ESC_SC#</a></li>',
''))
,p_list_template_noncurrent=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716622637646805405)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716623225818805411)
,p_list_template_current=>'<li class="a-LinksList-item is-current #A03#"><a href="#LINK#" class="a-LinksList-link" #A02#><span class="a-LinksList-icon"><span class="t-Icon #IMAGE#"></span></span><span class="a-LinksList-label">#TEXT#</span><span class="a-LinksList-badge">#A01#'
||'</span></a></li>'
,p_list_template_noncurrent=>'<li class="a-LinksList-item #A03#"><a href="#LINK#" class="a-LinksList-link" #A02#><span class="a-LinksList-icon"><span class="t-Icon #IMAGE#"></span></span><span class="a-LinksList-label">#TEXT#</span><span class="a-LinksList-badge">#A01#</span></a>'
||'</li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716627442136805429)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716634611298805444)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716635374633805444)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10583525904875984)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24534016112516813)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(716680169562820879)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(716689315506820891)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(716690084418820892)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(716692596502820893)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(103909823939152778)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(103910729134154335)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716619724928799710)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716619812724799715)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716619902812799716)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716620098616799716)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716620116614799716)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716620262276799717)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(6680621597641306)
,p_name=>'breadcrumbs'
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(388324150680174551)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(14450905155573152)
,p_page_name=>'winlov'
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(75127506785034882)
,p_theme_id=>3
,p_theme_name=>'APEX 4.0'
,p_theme_internal_name=>'APEX_4.0'
,p_ui_type_name=>'DESKTOP'
,p_navigation_type=>'T'
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(3485606247566446)
,p_default_dialog_template=>wwv_flow_api.id(716604580917788355)
,p_error_template=>wwv_flow_api.id(716609648731788373)
,p_printer_friendly_template=>wwv_flow_api.id(9113661096283)
,p_default_button_template=>wwv_flow_api.id(716616681872794730)
,p_default_region_template=>wwv_flow_api.id(388246039131933975)
,p_default_report_template=>wwv_flow_api.id(716692596502820893)
,p_default_label_template=>wwv_flow_api.id(716619902812799716)
,p_default_menu_template=>wwv_flow_api.id(6680621597641306)
,p_default_list_template=>wwv_flow_api.id(716623225818805411)
,p_default_nav_list_template=>wwv_flow_api.id(388254947243942451)
,p_default_top_nav_list_temp=>wwv_flow_api.id(388254947243942451)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(204023628129766298)
,p_theme_id=>3
,p_name=>'Standard'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(689614385032993955)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(689615352683993957)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(689616067927993957)
,p_theme_id=>3
,p_name=>'REGION_STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(689617971149993958)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(697050181422402965)
,p_theme_id=>3
,p_name=>'REGION_TITLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(697237270343708853)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716627933163805437)
,p_theme_id=>3
,p_name=>'LAYOUT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716651026369817167)
,p_theme_id=>3
,p_name=>'DISPLAY'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716680568033820885)
,p_theme_id=>3
,p_name=>'BADGE_LAYOUT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716683010367820887)
,p_theme_id=>3
,p_name=>'BADGE_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716693030768820894)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716693772056820894)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716694490428820895)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716695780930820895)
,p_theme_id=>3
,p_name=>'REPORT_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746384980429369270)
,p_theme_id=>3
,p_name=>'HEIGHT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746386277848369272)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746386590179369273)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746386837091369273)
,p_theme_id=>3
,p_name=>'BUTTON_SET'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746387914400369273)
,p_theme_id=>3
,p_name=>'LABEL_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746388241346369273)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746388584487369274)
,p_theme_id=>3
,p_name=>'BUTTON_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746388817603369274)
,p_theme_id=>3
,p_name=>'SPACING_LEFT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746389125810369274)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746389680630369274)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746389981180369274)
,p_theme_id=>3
,p_name=>'BUTTON_TYPE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716631528909805442)
,p_theme_id=>3
,p_name=>'2COLUMNGRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(716627442136805429)
,p_css_classes=>'a-MediaList--cols a-MediaList--2cols'
,p_group_id=>wwv_flow_api.id(716627933163805437)
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716631802430805442)
,p_theme_id=>3
,p_name=>'3COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716632125006805443)
,p_theme_id=>3
,p_name=>'4COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716632489831805443)
,p_theme_id=>3
,p_name=>'5COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716632734421805443)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716633065178805443)
,p_theme_id=>3
,p_name=>'HIDEBADGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716633316484805443)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716633627405805444)
,p_theme_id=>3
,p_name=>'HIDETITLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716633983927805444)
,p_theme_id=>3
,p_name=>'HIDEICONS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716634227760805444)
,p_theme_id=>3
,p_name=>'SLIMLIST'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716646319427817163)
,p_theme_id=>3
,p_name=>'REGIONCONTAINSITEMSTEXT'
,p_display_name=>'Region Contains Items / Text'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716646619661817164)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716646910119817164)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716647269701817164)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716647553597817164)
,p_theme_id=>3
,p_name=>'NOPADDING'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716647865815817165)
,p_theme_id=>3
,p_name=>'WIZARDDIALOG'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716648106429817165)
,p_theme_id=>3
,p_name=>'VISIBLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716648424698817165)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716685439520820889)
,p_theme_id=>3
,p_name=>'FLOATITEMS'
,p_display_name=>'Float Items'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(716680169562820879)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716685743417820889)
,p_theme_id=>3
,p_name=>'FIXED'
,p_display_name=>'Span Horizontally'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716686060431820889)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716686384136820889)
,p_theme_id=>3
,p_name=>'SMALL'
,p_display_name=>'32px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716686665684820889)
,p_theme_id=>3
,p_name=>'MEDIUM'
,p_display_name=>'48px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716686908265820889)
,p_theme_id=>3
,p_name=>'LARGE'
,p_display_name=>'64px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716687260952820889)
,p_theme_id=>3
,p_name=>'XLARGE'
,p_display_name=>'96px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716687559988820890)
,p_theme_id=>3
,p_name=>'XXLARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716687806578820890)
,p_theme_id=>3
,p_name=>'2COLUMNNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716688135348820890)
,p_theme_id=>3
,p_name=>'3COLUMNGRID'
,p_display_name=>'3 Column Grid'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716688413599820890)
,p_theme_id=>3
,p_name=>'4COLUMNGRID'
,p_display_name=>'4 Column Grid'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716688770385820890)
,p_theme_id=>3
,p_name=>'5COLUMNGRID'
,p_display_name=>'5 Column Grid'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716689011646820890)
,p_theme_id=>3
,p_name=>'FLEXIBLEBOX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385021702369271)
,p_theme_id=>3
,p_name=>'180PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385273484369271)
,p_theme_id=>3
,p_name=>'240PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385423121369271)
,p_theme_id=>3
,p_name=>'320PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385659686369271)
,p_theme_id=>3
,p_name=>'480PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385813465369271)
,p_theme_id=>3
,p_name=>'540PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746386068179369271)
,p_theme_id=>3
,p_name=>'640PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746386322011369272)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746386638275369273)
,p_theme_id=>3
,p_name=>'AUTOWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746386963177369273)
,p_theme_id=>3
,p_name=>'FIRSTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746387177619369273)
,p_theme_id=>3
,p_name=>'FIXEDLARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746387398521369273)
,p_theme_id=>3
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746387523132369273)
,p_theme_id=>3
,p_name=>'FIXEDWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746387785673369273)
,p_theme_id=>3
,p_name=>'INNERBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746388036191369273)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746388367616369273)
,p_theme_id=>3
,p_name=>'LABELSABOVE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746388624176369274)
,p_theme_id=>3
,p_name=>'LARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746388983120369274)
,p_theme_id=>3
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746389216430369274)
,p_theme_id=>3
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746389467393369274)
,p_theme_id=>3
,p_name=>'LASTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746389708684369274)
,p_theme_id=>3
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390046020369274)
,p_theme_id=>3
,p_name=>'PRIMARY'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390150868369274)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390397268369274)
,p_theme_id=>3
,p_name=>'SMALL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390512332369275)
,p_theme_id=>3
,p_name=>'SMALLLEFT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390767691369275)
,p_theme_id=>3
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390882019369275)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390917880369275)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787136680200949751)
,p_theme_id=>3
,p_name=>'DISABLE'
,p_display_name=>'Disable'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(716692596502820893)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787136832495949751)
,p_theme_id=>3
,p_name=>'ENABLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137078732949751)
,p_theme_id=>3
,p_name=>'NOBORDERS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137218251949751)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137405724949751)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137521807949751)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137715876949751)
,p_theme_id=>3
,p_name=>'STRETCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(926398873781707530)
,p_theme_id=>3
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(388255255364942452)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(926398916414707530)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(940695494482341567)
,p_theme_id=>3
,p_name=>'SLIMPROGRESSLIST'
,p_display_name=>'Slim Progress List'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(716635374633805444)
,p_css_classes=>'a-WizardSteps--slim'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1199563165206032440)
,p_theme_id=>3
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(716616877554794734)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_api.id(746389680630369274)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654306702182071)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(3482816826549973)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654416732182071)
,p_theme_id=>3
,p_name=>'SHOWBADGES'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654507461182071)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654689857182071)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654825674182071)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525655034537182071)
,p_theme_id=>3
,p_name=>'FORALLITEMS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659340255182097)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(716623225818805411)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659441811182097)
,p_theme_id=>3
,p_name=>'SHOWBADGES'
,p_display_name=>'Show Badges'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659560470182097)
,p_theme_id=>3
,p_name=>'SHOWRIGHTARROW'
,p_display_name=>'Show Right Arrow'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659675457182098)
,p_theme_id=>3
,p_name=>'USEBRIGHTHOVERS'
,p_display_name=>'Use Bright Hovers'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659887066182098)
,p_theme_id=>3
,p_name=>'FORTOPLEVELONLY'
,p_display_name=>'For top level only'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525660099207182098)
,p_theme_id=>3
,p_name=>'FORALLITEMS'
,p_display_name=>'For all items'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1544820405774478040)
,p_theme_id=>3
,p_name=>'SHOWRIGHTARROW'
,p_display_name=>'Show Right Arrow'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(716690084418820892)
,p_css_classes=>'a-LinksList--showArrow'
,p_template_types=>'REPORT'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1544820596794478040)
,p_theme_id=>3
,p_name=>'USEBRIGHTHOVERS'
,p_display_name=>'Use Bright Hovers'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1544820636742478040)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554801274622408333)
,p_theme_id=>3
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(388246039131933975)
,p_css_classes=>'a-Region--hideHeader'
,p_group_id=>wwv_flow_api.id(697050181422402965)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554801401450408333)
,p_theme_id=>3
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554801638095408334)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554801888000408334)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802037921408334)
,p_theme_id=>3
,p_name=>'SIDEBAR'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802202518408334)
,p_theme_id=>3
,p_name=>'BORDERLESS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802406950408334)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802636388408334)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802870646408334)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802972049408334)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554803157047408334)
,p_theme_id=>3
,p_name=>'SIMPLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554834649462526824)
,p_theme_id=>3
,p_name=>'RESPONSIVEICONCOLUMNS'
,p_display_name=>'Responsive Icon Columns'
,p_display_sequence=>2
,p_region_template_id=>wwv_flow_api.id(716658831322817171)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554834759654526824)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554834865767526824)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554854985135542298)
,p_theme_id=>3
,p_name=>'FLUSHREGION'
,p_display_name=>'Flush Region'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(716648790045817165)
,p_css_classes=>'a-Region--flush'
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855096554542298)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855290375542298)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855436301542298)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855609961542299)
,p_theme_id=>3
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855863802542299)
,p_theme_id=>3
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554856018683542299)
,p_theme_id=>3
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554856254808542299)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554856471559542299)
,p_theme_id=>3
,p_name=>'EXPANDED'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554856619328542299)
,p_theme_id=>3
,p_name=>'COLLAPSED'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554872845517550829)
,p_theme_id=>3
,p_name=>'REMOVE_TOP_BORDER'
,p_display_name=>'Remove Top Border'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(716662948592817174)
,p_css_classes=>'a-Region--noTopBorder'
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873082445550829)
,p_theme_id=>3
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873264879550829)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873467120550829)
,p_theme_id=>3
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873649715550830)
,p_theme_id=>3
,p_name=>'DEFAULTPADDING'
,p_display_name=>'Default Padding'
,p_display_sequence=>30
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873866842550830)
,p_theme_id=>3
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554874039691550830)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554874220093550830)
,p_theme_id=>3
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554874432919550830)
,p_theme_id=>3
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554874697518550830)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(641944455949362581)
,p_build_option_name=>'Do not Include in EA1'
,p_build_option_status=>'EXCLUDE'
,p_on_upgrade_keep_status=>true
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(693448447977546491)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72243813763976153)
,p_translation_flow_id=>4301
,p_translation_flow_language_cd=>'es'
,p_translation_comments=>'Data Workshop - Spanish'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72243915090976153)
,p_translation_flow_id=>4302
,p_translation_flow_language_cd=>'fr'
,p_translation_comments=>'Data Workshop - French'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72244025474976153)
,p_translation_flow_id=>4303
,p_translation_flow_language_cd=>'de'
,p_translation_comments=>'Data Workshop - German'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72244122176976154)
,p_translation_flow_id=>4304
,p_translation_flow_language_cd=>'it'
,p_translation_comments=>'Data Workshop - Italian'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72244222520976154)
,p_translation_flow_id=>4305
,p_translation_flow_language_cd=>'pt-br'
,p_translation_comments=>'Data Workshop - Brazilian Portuguese'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72244303839976154)
,p_translation_flow_id=>4306
,p_translation_flow_language_cd=>'zh-cn'
,p_translation_comments=>'Data Workshop - Simplified Chinese'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72244408258976154)
,p_translation_flow_id=>4307
,p_translation_flow_language_cd=>'zh-tw'
,p_translation_comments=>'Data Workshop - Traditional Chinese'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72244524247976154)
,p_translation_flow_id=>4308
,p_translation_flow_language_cd=>'ko'
,p_translation_comments=>'Data Workshop - Korean'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72244612522976154)
,p_translation_flow_id=>4309
,p_translation_flow_language_cd=>'ja'
,p_translation_comments=>'Data Workshop - Japanese'
,p_direction_right_to_left=>'N'
);
end;
/
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(180670925407283078)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(539653303570634151)
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(12521612942512635)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(786884209949512865)
,p_plugin_id=>wwv_flow_api.id(12521612942512635)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786884688713512865)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
,p_display_sequence=>10
,p_display_value=>'ADMIN: Ability to manage flow developer privileges'
,p_return_value=>'ADMIN'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786885196596512865)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786885697196512866)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786886117257512866)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786886644701512867)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786887107848512867)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786887665109512867)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786888174226512867)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786888638439512867)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786889193469512869)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786889603854512869)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786890183499512869)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865)
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(113746414043665431)
,p_plugin_type=>'AUTHENTICATION TYPE'
,p_name=>'COM.ORACLE.APEX.AUTHN.INTERNAL.APEX'
,p_display_name=>'Apex Authentication'
,p_supported_ui_types=>'DESKTOP'
,p_supported_component_types=>'APEX_APPLICATION_PAGE_ITEMS'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356673526869447685)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356676122950447689)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356696623544447717)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356696828873447717)
,p_plugin_id=>wwv_flow_api.id(356696623544447717)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356697211514447717)
,p_plugin_id=>wwv_flow_api.id(356696623544447717)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356697625048447717)
,p_plugin_attribute_id=>wwv_flow_api.id(356697211514447717)
,p_display_sequence=>10
,p_display_value=>'Redirect to Built-In URL'
,p_return_value=>'BUILTIN_URL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356698106182447717)
,p_plugin_attribute_id=>wwv_flow_api.id(356697211514447717)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356698627598447717)
,p_plugin_attribute_id=>wwv_flow_api.id(356697211514447717)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356699113011447718)
,p_plugin_id=>wwv_flow_api.id(356696623544447717)
,p_attribute_scope=>'COMPONENT'
...
,p_display_length=>60
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(356697211514447717)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356699514966447718)
,p_plugin_id=>wwv_flow_api.id(356696623544447717)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356699902995447718)
,p_plugin_id=>wwv_flow_api.id(356696623544447717)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356700320876447718)
,p_plugin_attribute_id=>wwv_flow_api.id(356699902995447718)
,p_display_sequence=>10
,p_display_value=>'Each Request'
,p_return_value=>'ALWAYS'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356700819744447719)
,p_plugin_attribute_id=>wwv_flow_api.id(356699902995447718)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356701330878447719)
,p_plugin_id=>wwv_flow_api.id(356696623544447717)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356765414638447769)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356765732481447771)
,p_plugin_id=>wwv_flow_api.id(356765414638447769)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356766124243447771)
,p_plugin_id=>wwv_flow_api.id(356765414638447769)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356766526635447771)
,p_plugin_id=>wwv_flow_api.id(356765414638447769)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356766900119447771)
,p_plugin_attribute_id=>wwv_flow_api.id(356766526635447771)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356767428334447772)
,p_plugin_attribute_id=>wwv_flow_api.id(356766526635447771)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356767916882447772)
,p_plugin_attribute_id=>wwv_flow_api.id(356766526635447771)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356768406566447772)
,p_plugin_id=>wwv_flow_api.id(356765414638447769)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356768825861447772)
,p_plugin_id=>wwv_flow_api.id(356765414638447769)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356769223844447773)
,p_plugin_id=>wwv_flow_api.id(356765414638447769)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(356768825861447772)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356769612451447773)
,p_plugin_id=>wwv_flow_api.id(356765414638447769)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356770002974447773)
,p_plugin_id=>wwv_flow_api.id(356765414638447769)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356770430789447773)
,p_plugin_attribute_id=>wwv_flow_api.id(356770002974447773)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356770908739447773)
,p_plugin_attribute_id=>wwv_flow_api.id(356770002974447773)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356771418301447773)
,p_plugin_attribute_id=>wwv_flow_api.id(356770002974447773)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356820112047447809)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(4969527595302343)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Page Zero'
...
,p_nav_list_template_options=>'#DEFAULT#'
,p_last_upd_yyyymmddhh24miss=>'20180118121556'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236187524918490)
,p_plug_name=>'APEX 5 - Header'
,p_region_css_classes=>'a-Header apex-sql-workshop'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388251521427936641)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236352716918490)
,p_plug_name=>'APEX 5 - Header Left'
,p_parent_plug_id=>wwv_flow_api.id(388236187524918490)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1456614651025020)
,p_plug_name=>'Application Tabs'
,p_region_name=>'a_Header_menu'
,p_parent_plug_id=>wwv_flow_api.id(388236352716918490)
...
,p_list_id=>wwv_flow_api.id(718988657702143721)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(388254947243942451)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236512184918491)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236787857918491)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237172510918491)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237328927918491)
,p_plug_name=>'APEX 5 - Search'
,p_parent_plug_id=>wwv_flow_api.id(388237172510918491)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237583055918491)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388296571194069434)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388344712770271079)
,p_plug_name=>'APEX 5 - Administration Menu'
,p_region_name=>'adminMenu'
,p_parent_plug_id=>wwv_flow_api.id(388296571194069434)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388251521427936641)
,p_plug_display_sequence=>60
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(697382068928001818)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(388255255364942452)
,p_translate_title=>'N'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(486771776816301727)
...
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(697413399059052182)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(388255255364942452)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236965230918491)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237715059918492)
,p_plug_name=>'APEX 5 - Control Bar Left'
,p_parent_plug_id=>wwv_flow_api.id(388236965230918491)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388323355246153942)
,p_plug_name=>'APEX 5 - Breadcrumb'
,p_parent_plug_id=>wwv_flow_api.id(388237715059918492)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388251521427936641)
,p_plug_display_sequence=>1
,p_plug_display_point=>'BODY'
,p_menu_id=>wwv_flow_api.id(6678815232629976)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(388324150680174551)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237918952918492)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3773582205956301545)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(388296571194069434)
,p_button_name=>'SPOTLIGHT'
,p_button_static_id=>'header-spotlightSearch'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(388298732478079235)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(384688985396932804)
...
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(388298521291079233)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(384689065888932805)
...
,p_grid_new_grid=>false
,p_required_patch=>wwv_flow_api.id(693448447977546491)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(384689133506932806)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(388350254436282356)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(388236787857918491)
,p_button_name=>'HOME'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(388298732478079235)
...
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_api.id(216950505720834051)
,p_step_template=>wwv_flow_api.id(716607252394788370)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'AEUTL/sql_utl_exprt_imprt.htm'
,p_last_upd_yyyymmddhh24miss=>'20170602110201'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2209528931524495)
...
,p_plug_template=>wwv_flow_api.id(716662948592817174)
,p_plug_display_sequence=>30
,p_plug_new_grid_row=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(2202106852499122)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716623225818805411)
,p_plug_column_width=>'apex-col--bottomBorder'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(170288209634031042)
...
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(74707671328250039)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716623225818805411)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(170288516691042569)
...
,p_plug_new_grid_row=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(75585889878824332)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716623225818805411)
,p_plug_column_width=>'apex-col--rightBorder apex-col--bottomBorder'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(171170229200569353)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(945660876947384278)
,p_name=>'RENDERING: Page - Dialog Closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(170288209634031042)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(945661141312384282)
,p_event_id=>wwv_flow_api.id(945660876947384278)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(236908207860041215)
,p_plug_name=>'Spreadsheet Load'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(104263607591363808)
,p_plug_display_sequence=>50
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p>This page displays information about the Spreadsheet import. If any rows failed while importing, this page displays an error message.</p>'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(236908624285041216)
,p_name=>'Failed Rows'
,p_template=>wwv_flow_api.id(716648790045817165)
,p_display_sequence=>30
...
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(716692596502820893)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236909010953041218)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236909111520041218)
,p_query_column_id=>2
,p_column_alias=>'DATA'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(236909231803041218)
,p_plug_name=>'button bar'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_translate_title=>'N'
,p_attribute_01=>'N'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(236910023245041222)
,p_name=>'Import Detail'
,p_template=>wwv_flow_api.id(388246039131933975)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910621733041225)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910704793041225)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910825625041225)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910911224041225)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910405016041225)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910524132041225)
,p_query_column_id=>6
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(236911018188041226)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(236909231803041218)
,p_button_name=>'BACK'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(236912309292041255)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(236911408920041236)
,p_name=>'P2_LOAD_ID'
,p_item_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3913203962745120)
,p_plug_name=>'button bar'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(55112340569377996)
,p_name=>'Failed Rows'
,p_template=>wwv_flow_api.id(716648790045817165)
,p_display_sequence=>30
,p_region_template_options=>'#DEFAULT#:is-expanded'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(26396310164851868)
,p_query_column_id=>1
,p_column_alias=>'ERROR'
,p_column_display_sequence=>1
,p_column_heading=>'Error'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(26396413604851868)
,p_query_column_id=>2
,p_column_alias=>'DATA'
,p_column_display_sequence=>2
,p_column_heading=>'Data'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(234740508574260035)
,p_name=>'Import Detail'
,p_template=>wwv_flow_api.id(388246039131933975)
,p_display_sequence=>25
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741120589260051)
,p_query_column_id=>1
,p_column_alias=>'LOAD_DATE'
,p_column_display_sequence=>1
,p_column_heading=>'Import Date'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741209381260051)
,p_query_column_id=>2
,p_column_alias=>'LOADED_BY'
,p_column_display_sequence=>2
,p_column_heading=>'Imported By'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741308348260051)
,p_query_column_id=>3
,p_column_alias=>'SCHEMA2'
,p_column_display_sequence=>3
,p_column_heading=>'Schema'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741425535260051)
,p_query_column_id=>4
,p_column_alias=>'TABLE2'
,p_column_display_sequence=>4
,p_column_heading=>'Table'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741507868260052)
,p_query_column_id=>5
,p_column_alias=>'ROWS_LOADED'
,p_column_display_sequence=>5
,p_column_heading=>'Rows Imported'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741628809260052)
,p_query_column_id=>6
,p_column_alias=>'ROWS_FAILED'
,p_column_display_sequence=>6
,p_column_heading=>'Rows Failed'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(192104604688817535)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3913203962745120)
,p_button_name=>'BACK'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(234998201152447134)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(27172013799279694)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(234980910062392922)
,p_name=>'P7_PREV_PAGE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(3913203962745120)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
end;
...
,p_last_upd_yyyymmddhh24miss=>'20171009062348'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3921012881766600)
,p_plug_name=>'Button Bar'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(220725321769721592)
,p_plug_name=>'Repository'
,p_region_template_options=>'#DEFAULT#:a-Region--slimPadding:a-Region--sideRegion'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388246039131933975)
,p_plug_display_sequence=>60
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>This page displays the status of loaded Text data.</p> ',
'<p>To access the loaded file, select the file name.</p> ',
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(220741417024852608)
,p_plug_name=>'Tasks'
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(3648913903408259)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(3482816826549973)
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(234960616202337996)
,p_name=>'Repository'
,p_template=>wwv_flow_api.id(388251521427936641)
,p_display_sequence=>40
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-Report--stretch'
,p_new_grid_column=>false
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961216430338008)
,p_query_column_id=>1
,p_column_alias=>'CB'
,p_column_display_sequence=>1
,p_column_heading=>'&nbsp;'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(937850430942294704)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961308847338008)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961403149338008)
,p_query_column_id=>4
,p_column_alias=>'File'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961531529338008)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961610894338008)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961731890338010)
,p_query_column_id=>7
,p_column_alias=>'Type'
,p_column_display_sequence=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961804936338010)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961924524338011)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234962026814338011)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234962102068338011)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234962213306338011)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174139107561146972)
,p_query_column_id=>13
,p_column_alias=>'TO_BE_DELETED'
,p_column_display_sequence=>12
,p_column_heading=>'To Be Deleted'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(51804488943808398)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(3921012881766600)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(130487609243007078)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3921012881766600)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(130488219172007162)
,p_branch_action=>'8'
,p_branch_point=>'AFTER_PROCESSING'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(51821394189864043)
,p_name=>'F4300_P8_RESTRICT_BY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3921012881766600)
,p_prompt=>'Show'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'RESTRICT.LOAD.FILES'
,p_lov=>'.'||wwv_flow_api.id(87918702852509211)||'.'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(716619902812799716)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'NO_SPECIAL_CHAR_NL'
,p_help_text=>'Specify to show your files or all files'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(165133620695131261)
...
,p_when_button_pressed=>wwv_flow_api.id(130487609243007078)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(51823819555198806)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(130807727310131197)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(130487609243007078)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3655019491438205)
,p_plug_name=>'Tasks'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388246039131933975)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3925626518780012)
,p_plug_name=>'button bar'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(114705422835023938)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>This page displays the status of imported Spreadsheet data.</p> ',
'<p>To remove a status entry, select it and click <b>Delete Checked</b>.</p>'))
,p_plug_column_width=>'valign="top"'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(234717428566209000)
,p_name=>'Loads'
,p_template=>wwv_flow_api.id(388251521427936641)
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_no_data_found=>'No Spreadsheet Imports found.'
,p_query_num_rows_type=>'ROW_RANGES'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718032272209012)
,p_query_column_id=>1
,p_column_alias=>'CB'
,p_column_display_sequence=>1
,p_column_heading=>'&nbsp;'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(937952072556533758)
,p_query_column_id=>2
,p_column_alias=>'DETAILS_LINK'
,p_column_display_sequence=>12
,p_hidden_column=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718112718209012)
,p_query_column_id=>3
,p_column_alias=>'Details'
,p_column_display_sequence=>2
,p_column_heading=>'Details'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718206872209012)
,p_query_column_id=>4
,p_column_alias=>'Created By'
,p_column_display_sequence=>3
,p_column_heading=>'Imported By'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718310926209013)
,p_query_column_id=>5
,p_column_alias=>'Created on'
,p_column_display_sequence=>4
,p_column_heading=>'Imported On'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718429023209013)
,p_query_column_id=>6
,p_column_alias=>'Type'
,p_column_display_sequence=>5
,p_column_heading=>'Type'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718526244209013)
,p_query_column_id=>7
,p_column_alias=>'Schema'
,p_column_display_sequence=>6
,p_column_heading=>'Schema'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718631100209013)
,p_query_column_id=>8
,p_column_alias=>'TABLE'
,p_column_display_sequence=>7
,p_column_heading=>'Table'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718712148209013)
,p_query_column_id=>9
,p_column_alias=>'Succeeded'
,p_column_display_sequence=>8
,p_column_heading=>'Succeeded'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718804458209013)
,p_query_column_id=>10
,p_column_alias=>'Failed'
,p_column_display_sequence=>9
,p_column_heading=>'Failed'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(268495509916252852)
,p_query_column_id=>11
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(268502322084284781)
,p_query_column_id=>12
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(114704228365023929)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(3925626518780012)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(192155317097767347)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3925626518780012)
,p_button_name=>'DELETE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(114703320184023921)
,p_branch_action=>'11'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(114704528502023930)
,p_name=>'F4300_P11_RESTRICT_BY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3925626518780012)
,p_prompt=>'Show'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'RESTRICT.LOAD.FILES'
,p_lov=>'.'||wwv_flow_api.id(87918702852509211)||'.'
...
,p_help_text=>'Specify to show your Spreadsheet import or all Spreadsheet imports.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(165128603595116797)
,p_validation_name=>'SelectAtLeastOne'
,p_validation_sequence=>10
,p_validation=>'wwv_flow.g_f01.count > 0'
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Must select at least one file to delete.'
,p_when_button_pressed=>wwv_flow_api.id(192155317097767347)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(192159607728774014)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(192155317097767347)
,p_process_success_message=>'Spreadsheet data load detail(s) deleted.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(114704811615023932)
...
,p_step_template=>wwv_flow_api.id(716613771837788376)
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(184012414812654843)
,p_plug_name=>'Load XML Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(208585513765537107)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>'<p>Select the database schema and name of the table you would like load data into, and locate the XML document to be uploaded.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(341792317669297384)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937839991596088902)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(341792317669297384)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(184013029848654860)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(341792317669297384)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(184013614902654876)
,p_name=>'F4300_P14_TARGET_SCHEMA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(184012414812654843)
,p_prompt=>'Schema'
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(716620116614799716)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Select the database schema that owns the table you would like load data into.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(238567106303255599)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Select the database table you would like load data into. By default, all table names are converted to upper case. Select <span class="fielddatabold">Preserve Case</span> override this default behavior.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(239230403195330418)
...
,p_help_text=>'Click <span class="fielddatabold">Browse</span> to locate the XML file you wish to upload.'
,p_attribute_01=>'WWV_FLOW_FILES'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(184014831290654966)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(238757828944271610)
,p_validation_name=>'Schema Must Be Selected'
,p_validation_sequence=>20
,p_validation=>'F4300_P14_TARGET_SCHEMA'
,p_validation_type=>'ITEM_NOT_NULL_OR_ZERO'
,p_error_message=>'#LABEL# must be selected.'
,p_validation_condition=>'F4300_P14_TARGET_SCHEMA'
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_when_button_pressed=>wwv_flow_api.id(184013029848654860)
,p_associated_item=>wwv_flow_api.id(184013614902654876)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(238842116261277415)
...
,p_when_button_pressed=>wwv_flow_api.id(184013029848654860)
,p_associated_item=>wwv_flow_api.id(238567106303255599)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(239260717048334408)
...
,p_when_button_pressed=>wwv_flow_api.id(184013029848654860)
,p_associated_item=>wwv_flow_api.id(239230403195330418)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(239275721203335597)
...
,p_error_message=>'The file does not have any content.'
,p_validation_condition=>'F4300_P17_FILE'
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_when_button_pressed=>wwv_flow_api.id(184013029848654860)
,p_associated_item=>wwv_flow_api.id(239230403195330418)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937840169136091731)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937839991596088902)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937840425239091732)
,p_event_id=>wwv_flow_api.id(937840169136091731)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(238937010159285027)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(184013029848654860)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(239245612546333116)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584609866530529)
...
wwv_flow_api.create_page(
 p_id=>18
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Data - File Details'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Data - File Details'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2157120477803132)
...
'The file to be uploaded must be text-based.  To upload a .XLS file, first save it as CSV. <p />',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3939910944851245)
...
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(3931814922814551)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21283612328451431)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208596429152553286)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937785833006812802)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208596429152553286)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2158311458803135)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208596429152553286)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2158218927803135)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208596429152553286)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2586909632661028)
,p_branch_action=>'18'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2159723337803140)
,p_branch_action=>'19'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2158311458803135)
,p_branch_sequence=>20
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2159221254803139)
,p_branch_action=>'230'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2158218927803135)
,p_branch_sequence=>30
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2157814244803134)
,p_name=>'F4300_P13_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2157120477803132)
,p_prompt=>'Text File'
,p_display_as=>'NATIVE_FILE'
,p_cSize=>30
,p_cMaxlength=>2000
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'N'
,p_help_text=>'Click <span class="fielddatabold">Browse</span> to locate the file to be uploaded.'
,p_attribute_01=>'WWV_FLOW_FILES'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2243727316068250)
,p_name=>'F4300_P13_IS_COLUMN_NAME'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(2157120477803132)
,p_item_default=>'Y'
,p_prompt=>'First row contains column names'
,p_display_as=>'NATIVE_CHECKBOX'
,p_named_lov=>'ISCOLUMN.NAME.TEXT'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select ''<span class="instructiontext">''||',
'wwv_flow_lang.system_message(''F4300_INSTRUCT_TEXT'')||''</span>'' d, ''Y'' r from dual'))
,p_field_template=>wwv_flow_api.id(716619812724799715)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Select this box if your data contains column names in the first row.</p>',
'',
'',
'',
'<pre>',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2329615063755442)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2583912702633467)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2586326817656557)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Specify to reupload the file '
,p_attribute_01=>'SUBMIT'
,p_attribute_03=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2764003228797653)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Enter a delimiter character. You can use this character to delineate the starting and ending boundary of a data value. If you specify a delimiter character, Data Workshop ignores whitespace occurring before the starting a'
||'nd ending boundary of a data value. You can also use this option to enclose a data value with the specified delimiter character.</div>',
'<div class="htmldbInfoBodyP">If the first row contains column names, select <span class="fielddatabold">First row contains column names.</span></div>',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21284319254453394)
,p_name=>'P18_CURRENCY'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(21283612328451431)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>If your data contains international currency symbol, enter it here.</p>',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21931121693474165)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21932028965476228)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(143068503644769301)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Choose the character set in which the text file is encoded'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(514941714951998813)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49531609285689625)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(2601228838903096)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2959116096955698)
,p_validation_name=>'file name not null'
,p_validation_sequence=>10
,p_validation=>'F4300_P13_FILE'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'File must be selected to upload.'
,p_when_button_pressed=>wwv_flow_api.id(2158311458803135)
,p_associated_item=>wwv_flow_api.id(2157814244803134)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(165112819562074156)
...
,p_when_button_pressed=>wwv_flow_api.id(2158311458803135)
,p_associated_item=>wwv_flow_api.id(2329615063755442)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52214713959981319)
,p_validation_name=>'file not 0 byte'
,p_validation_sequence=>30
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'for c1 in (select id                     ',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(245259621035850537)
...
,p_when_button_pressed=>wwv_flow_api.id(2158311458803135)
,p_associated_item=>wwv_flow_api.id(2583912702633467)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937786060661818197)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937785833006812802)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937786365024818199)
,p_event_id=>wwv_flow_api.id(937786060661818197)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514941847752998814)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942000924998816)
,p_event_id=>wwv_flow_api.id(514941847752998814)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942141088998817)
,p_event_id=>wwv_flow_api.id(514941847752998814)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514941963015998815)
,p_event_id=>wwv_flow_api.id(514941847752998814)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514942269010998818)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942346333998819)
,p_event_id=>wwv_flow_api.id(514942269010998818)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514942483195998820)
,p_name=>'Disable it'
,p_event_sequence=>40
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942501168998821)
,p_event_id=>wwv_flow_api.id(514942483195998820)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2324003064685753)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(2158311458803135)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23875226415655164)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page(
 p_id=>19
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Data - Table Properties'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Data - Table Properties'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2160319726803142)
,p_plug_name=>'Load Data'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2252818489103487)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3940715792852571)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208599127898562379)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(221480323469295765)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p>This page previews how your new table will look.  Enter a table name, change column names or data types, and specify which columns to include.</p>'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937784823962801386)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208599127898562379)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2161511969803145)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208599127898562379)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2161401612803145)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208599127898562379)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2162930496803151)
,p_branch_action=>'21'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2161511969803145)
,p_branch_sequence=>20
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2162430587803150)
,p_branch_action=>'18'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2161401612803145)
,p_branch_sequence=>10
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2161012050803145)
,p_name=>'F4300_P13_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2160319726803142)
,p_prompt=>'Schema'
,p_source=>'wwv_flow_user_api.get_default_schema'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_SELECT_LIST'
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Choose the database schema you would like to create and load data into.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2267110534176923)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'Identify the table name you would like to create. By default, all table names are converted to upper case. Select <span class="fielddatabold">Preserve Case</span> override this default behavior.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2269730619182732)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(77772602360009347)
,p_name=>'P19_PRESERVE_CASE'
,p_item_sequence=>25
,p_item_plug_id=>wwv_flow_api.id(2160319726803142)
,p_prompt=>'Preserve Case'
,p_display_as=>'NATIVE_CHECKBOX'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(77778717729023209)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(2611527265139214)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2615902509169951)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2617025019176456)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_api.id(2267110534176923)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2617811990182089)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2618831730187776)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2620211429191428)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2622018486202935)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(290889128494860177)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(291061510906810726)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(25617203076189584)
,p_validation_name=>'F4300_P13_OWNER'
,p_validation_sequence=>100
,p_validation=>'F4300_P13_OWNER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Schema must be specified.'
,p_when_button_pressed=>wwv_flow_api.id(2161511969803145)
,p_associated_item=>wwv_flow_api.id(2161012050803145)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937785042471804309)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937784823962801386)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937785344680804311)
,p_event_id=>wwv_flow_api.id(937785042471804309)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432754819513077103)
,p_process_sequence=>10
...
wwv_flow_api.create_page(
 p_id=>21
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Data - Primary Key'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Data - Primary Key'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2163507507803153)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>'<p>Use this page to identify the primary key of the table. If no single column in your data set is appropriate as a primary key then identify a new column as the primary key. A primary key is used to uniquely identify a row in a table.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_plug_comment=>'Region generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3941420987854137)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208600405997574943)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937792840943888300)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208600405997574943)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2164724759803154)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208600405997574943)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2164626737803154)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208600405997574943)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(29899701983651170)
,p_branch_action=>'21'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>20
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(52491202943423441)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2165605436803157)
,p_branch_action=>'19'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2164626737803154)
,p_branch_sequence=>40
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2164212316803154)
,p_name=>'F4300_P21_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2163507507803153)
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Schema that owns the table you would like to load data into.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2290019463274070)
...
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_help_text=>'Name of the table to load data into'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29865802488537862)
,p_name=>'P13_PK1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(2163507507803153)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Specify which column is the primary key of your table.  A primary key is a column which uniquely identifies a row.  Oracle does not require that your table have a primary key, however this wizard requires you identify a primary key.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29868930193545840)
,p_name=>'P13_PK1_NAME'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(2163507507803153)
...
,p_field_template=>wwv_flow_api.id(716620116614799716)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Name the primary key constraint name.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29871919935552356)
,p_name=>'P13_PK_TYPE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(2163507507803153)
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'Choose how you would like to have your primary key computed.  Or; choose to not have your primary key''s value set.'
,p_attribute_01=>'1'
,p_attribute_02=>'SUBMIT'
,p_attribute_03=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29874226299563636)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Identify the name of an existing database sequence which will be used to populate the primary key value.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29876013271569281)
...
,p_field_template=>wwv_flow_api.id(716620116614799716)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Identify the name of new database sequence which will be created for the purpose of populating this new tables primary key.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(52479416748399039)
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'You can either select existing column or add new column as primary key.'
,p_attribute_01=>'1'
,p_attribute_02=>'SUBMIT'
,p_attribute_03=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(52483906836405605)
,p_name=>'P13_PK1_2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(2163507507803153)
,p_item_default=>'ID'
...
,p_field_template=>wwv_flow_api.id(716620116614799716)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Enter the name of new primary key column.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29883807645586566)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(48784624982313991)
,p_computation_sequence=>20
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29887722321600349)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29885422537590887)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29890322799609950)
...
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154)
,p_associated_item=>wwv_flow_api.id(29874226299563636)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29894220852618813)
...
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154)
,p_associated_item=>wwv_flow_api.id(29868930193545840)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29895317520627355)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154)
,p_associated_item=>wwv_flow_api.id(29865802488537862)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52517420651456956)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154)
,p_associated_item=>wwv_flow_api.id(52483906836405605)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52521315588464886)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52522413641473849)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154)
,p_associated_item=>wwv_flow_api.id(29871919935552356)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29896704837633092)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29898416743646038)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154)
,p_associated_item=>wwv_flow_api.id(29876013271569281)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(48786206675337067)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937793190642890959)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937792840943888300)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937793478434890959)
,p_event_id=>wwv_flow_api.id(937793190642890959)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2632715940268420)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'  ); ',
'end;'))
,p_process_when_button_id=>wwv_flow_api.id(2164724759803154)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2634021612279507)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698583885660530521)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(69940020626931717)
,p_process_sequence=>30
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(122951803454637884)
...
wwv_flow_api.create_page(
 p_id=>22
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Data - Table Owner and Name'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Data - Table Owner and Name'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'AEUTL/sql_utl_imprt.htm'
,p_last_upd_yyyymmddhh24miss=>'20171009062345'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2166903406803173)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>'<p>Select the database schema and name of the table you would like load data into.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_plug_comment=>'Region generated 20-SEP-2002 14:00:18'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3942229644856578)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(3934205141830584)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444)
,p_translate_title=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208603801195601913)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937794354347915984)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208603801195601913)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2167814861803176)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208603801195601913)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4117018823640385)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208603801195601913)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2169404691803182)
,p_branch_action=>'24'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2167814861803176)
,p_branch_sequence=>10
,p_branch_comment=>'Generated 20-SEP-2002 14:00:18'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4117328710640389)
,p_branch_action=>'230'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(4117018823640385)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2167519385803175)
,p_name=>'F4300_P22_TABLE_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2166903406803173)
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'<p>Select the database schema that owns the table you would like load data into.</p>'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:18'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(236284414381765839)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'<p>Select the database table you would like to load data into.</p>'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3375200229249004)
,p_validation_name=>'F4300_P22_TABLE_OWNER Not Null'
,p_validation_sequence=>10
,p_validation=>'F4300_P22_TABLE_OWNER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Schema must be specified.'
,p_associated_item=>wwv_flow_api.id(2167519385803175)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 25-SEP-2002 14:41'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(236299719922767422)
...
,p_validation_condition_type=>'ITEM_IS_NULL'
,p_when_button_pressed=>wwv_flow_api.id(2167814861803176)
,p_associated_item=>wwv_flow_api.id(236284414381765839)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 25-SEP-2002 14:40'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937794586888918217)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937794354347915984)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937794833959918218)
,p_event_id=>wwv_flow_api.id(937794586888918217)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(236513721363871972)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'Invalid Schema'
,p_process_when_button_id=>wwv_flow_api.id(2167814861803176)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>24
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Data - Files Details'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Data - Files Details'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3829922094433887)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_column_width=>'valign="top"'
,p_plug_header=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<label for="file-upload" class="hideMe508">File Upload</label><p>Use this page to locate the file to be uploaded. If the first row contains columns names, select <b>First row contains column names.</b></p>',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_plug_comment=>'Region generated 20-SEP-2002 14:00:17'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3943707265859631)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21249425216360552)
,p_plug_name=>'Globalization'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676055535817183)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208605727861609658)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937795591496921755)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208605727861609658)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3830706637433895)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208605727861609658)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3830402542433895)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208605727861609658)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3834709806433923)
,p_branch_action=>'24'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3834410468433923)
,p_branch_action=>'25'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(3830706637433895)
,p_branch_sequence=>20
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3834101310433921)
,p_branch_action=>'22'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(3830402542433895)
,p_branch_sequence=>30
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3831104189433900)
,p_name=>'F4300_P24_REUPLOAD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(3829922094433887)
,p_use_cache_before_default=>'NO'
,p_item_default=>'N'
,p_prompt=>'Reupload File'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3831424650433904)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3832007249433909)
...
,p_field_template=>wwv_flow_api.id(716620116614799716)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>Click <strong>Browse</strong> to locate the file to be uploaded.</p>'
,p_attribute_01=>'WWV_FLOW_FILES'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3832316073433910)
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Select this option if your data contains column names in the first row. Consider the following example:</p>',
'<pre>',
'Name     Salary     Commission',
'Clark    1000       10',
'Scott    2000       20',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3832614597433912)
...
,p_field_template=>wwv_flow_api.id(716620116614799716)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>Identify a column separator character. Use <strong>\t</strong> for tab separators.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3832902320433912)
...
,p_field_template=>wwv_flow_api.id(716619902812799716)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>Identify optional enclosed by character.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21250401452363148)
,p_name=>'P24_CURRENCY'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(21249425216360552)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_return_val varchar2(30) := ''$'';',
'begin',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21979404565582755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21983213138604079)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(143065000827740153)
...
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Choose the characterset in which the text file is encoded.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(514942629282998822)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(3835011019433929)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49535021883702753)
,p_computation_sequence=>20
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(3835314069433929)
,p_computation_sequence=>30
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3835908087433932)
,p_validation_name=>'file name not null'
,p_validation_sequence=>10
,p_validation=>'F4300_P22_FILE'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'File must be specified.'
,p_when_button_pressed=>wwv_flow_api.id(3830706637433895)
,p_associated_item=>wwv_flow_api.id(3832007249433909)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937795797046923768)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937795591496921755)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937796033082923768)
,p_event_id=>wwv_flow_api.id(937795797046923768)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514942747761998823)
,p_name=>'get Preview'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942957612998825)
,p_event_id=>wwv_flow_api.id(514942747761998823)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514943056692998826)
,p_event_id=>wwv_flow_api.id(514942747761998823)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942843162998824)
,p_event_id=>wwv_flow_api.id(514942747761998823)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514943111796998827)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514943293338998828)
,p_event_id=>wwv_flow_api.id(514943111796998827)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_DISABLE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514943352636998829)
,p_name=>'Refresh Preview'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514943486298998830)
,p_event_id=>wwv_flow_api.id(514943352636998829)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3836525951433937)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'create table info collection'
...
'end;'))
,p_process_error_message=>'Error creating collection using loaded data.'
,p_process_when_button_id=>wwv_flow_api.id(3830706637433895)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>25
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Data - Column Mapping'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Data - Column Mapping'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3379027934257020)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>This page previews how your data will be loaded. Match the database column names with columns in the data. To upload columns, select <b>Yes</b> or <b>No</b>. An asterisk (*) indicates a required column. To upload data to the selected table, click '
||'<b>Load Data</b>.</p> ',
'<!--',
'<p>Use SQL Workshop to modify table attributes such as changing the column length, making not null columns, or changing the column type.</p> ',
'-->',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3382431874267620)
...
'    );'))
,p_plug_source_type=>'NATIVE_PLSQL'
,p_plug_query_row_template=>wwv_flow_api.id(7082409118250737)
,p_plug_query_num_rows=>15
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3944611767860950)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208608528123628623)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937797370499933217)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208608528123628623)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3749803794082687)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208608528123628623)
,p_button_name=>'FINISH'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3748622363078595)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208608528123628623)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3748901903078596)
,p_branch_action=>'24'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(3748622363078595)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3753406349092940)
,p_name=>'F4300_P25_TABLE_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3379027934257020)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Schema:'
...
,p_escape_on_http_output=>'N'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Schema that owns the table to load the data into.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3754218816096550)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3872807706566435)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(3874326752571910)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3758426912108293)
...
,p_when_button_pressed=>wwv_flow_api.id(3749803794082687)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3759521849116267)
,p_validation_name=>'at least one upload selected'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3762021418135076)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3804414642293989)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937797560733935376)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937797370499933217)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937797853562935376)
,p_event_id=>wwv_flow_api.id(937797560733935376)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3813707079395907)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insert data'
...
,p_process_when_button_id=>wwv_flow_api.id(3749803794082687)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584313626530526)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432755516873085837)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(122950027302616323)
,p_process_sequence=>30
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'security check'
...
wwv_flow_api.create_page(
 p_id=>90
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Unload to XML - Columns'
,p_page_mode=>'MODAL'
,p_step_title=>'Unload to XML - Columns'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(242928263721)
...
,p_plug_header=>'<p>You can export the contents of a table to an XML document. Select the database schema, table and associated columns that you would like export to an XML document.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(341984427776830221)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(944846820724951476)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(341984427776830221)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(242954438477)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(341984427776830221)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(242922263709)
,p_branch_name=>'Go To Page 90'
,p_branch_action=>'f?p=&APP_ID.:90:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(242954438477)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(242926263712)
,p_name=>'F4300_P90_XML_EXPORT_COLUMNS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(242928263721)
,p_prompt=>'Columns'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Select the database object columns you would like to export to an XML document.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73486104619415064)
,p_name=>'P90_FILE_EXPORT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(242928263721)
,p_item_default=>'Y'
,p_prompt=>'Export as file'
,p_display_as=>'NATIVE_CHECKBOX'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(196680604705342464)
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Enter SQL WHERE clause to limit the rows that are selected.  For example:',
'<pre>',
'DEPTNO = 10',
'</pre>'))
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(254954327846848756)
...
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Select the database schema that owns the object you would like to export.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(254973402004850698)
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Select the database object name you would like to export to an XML file format.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(241192503550535804)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(255090131917868798)
...
,p_validation_condition_type=>'ITEM_IS_NULL_OR_ZERO'
,p_when_button_pressed=>wwv_flow_api.id(242954438477)
,p_associated_item=>wwv_flow_api.id(254973402004850698)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(61180608448820628)
...
,p_when_button_pressed=>wwv_flow_api.id(242954438477)
,p_associated_item=>wwv_flow_api.id(242926263712)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(99812303853555653)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(255075127415867567)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(944847063502954022)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(944846820724951476)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(944847397350954024)
,p_event_id=>wwv_flow_api.id(944847063502954022)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(242990422910)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
''))
,p_process_when_button_id=>wwv_flow_api.id(242954438477)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584852702530531)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432755700382090489)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432755918043095637)
,p_process_sequence=>30
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page(
 p_id=>100
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Select Sample Dataset'
,p_step_title=>'Select Sample Dataset'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(716607780903788372)
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180813094541'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330053465240161850)
,p_plug_name=>'About Sample Datasets'
,p_region_template_options=>'#DEFAULT#:a-Region--slimPadding:a-Region--sideRegion'
,p_plug_template=>wwv_flow_api.id(388246039131933975)
,p_plug_display_sequence=>60
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>Sample datasets enable you to easily build sample applications. Each dataset includes sufficient data to build pages with various different components.</p>',
'<p>Install, refresh, or replace sample datasets within one of the schemas associated with your workspace. The database objects can also be easily removed.</p>',
'<p>Each dataset includes various database objects and sample data. The sample data is available in one or more languages. </p>',
'<p><em><strong>Note:</strong> Only a single language can be loaded into the sample database objects. If you select a different language the currently loaded data will be replaced.</em>'))
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_column_width=>'valign="top"'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(3778470772251502290)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165285158264988786)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_hidden_column=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165287955834988791)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165285524623988787)
,p_query_column_id=>3
,p_column_alias=>'NAME'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165285973857988788)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(641957658752558630)
,p_query_column_id=>5
,p_column_alias=>'LANGUAGES'
,p_column_display_sequence=>4
,p_column_heading=>'Languages'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165287145567988790)
,p_query_column_id=>6
,p_column_alias=>'SCHEMA'
,p_column_display_sequence=>6
,p_column_heading=>'Schema'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165286394141988788)
,p_query_column_id=>7
,p_column_alias=>'LAST_UPDATED'
,p_column_display_sequence=>7
,p_column_heading=>'Date Installed'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(164835701829930737)
,p_query_column_id=>8
,p_column_alias=>'REFRESH_AVAILABLE'
,p_column_display_sequence=>8
,p_column_heading=>'Refresh Available'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164832857367930708)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164832997966930709)
,p_event_id=>wwv_flow_api.id(164832857367930708)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164833090606930710)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164833102194930711)
,p_event_id=>wwv_flow_api.id(164833090606930710)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164834970156930729)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164835041955930730)
,p_event_id=>wwv_flow_api.id(164834970156930729)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164833255037930712)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164833301631930713)
,p_event_id=>wwv_flow_api.id(164833255037930712)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164833425409930714)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164833531975930715)
,p_event_id=>wwv_flow_api.id(164833425409930714)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164835187682930731)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164835243210930732)
,p_event_id=>wwv_flow_api.id(164835187682930731)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164835865574930738)
,p_name=>'Close Dialog'
,p_event_sequence=>70
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(3778470772251502290)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164835904250930739)
,p_event_id=>wwv_flow_api.id(164835865574930738)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(3778470772251502290)
,p_stop_execution_on_error=>'Y'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>110
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Manage Sample Dataset'
,p_page_mode=>'MODAL'
,p_step_title=>'Manage Sample Dataset'
,p_step_sub_title=>'Manage Sample Dataset'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180813093355'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330021358989147650)
,p_plug_name=>'Currently Installed'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330022012396147656)
,p_plug_name=>'Install Dataset'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding:a-Form--fixedLabels'
,p_plug_template=>wwv_flow_api.id(388246039131933975)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(494815871075820816)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
,p_plug_display_sequence=>40
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3778445591701489866)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165267847428976362)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(494815871075820816)
,p_button_name=>'Cancel'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165268233939976362)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(494815871075820816)
,p_button_name=>'Next'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165267451506976361)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(494815871075820816)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
,p_button_image_alt=>'Remove Dataset'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(165276015613976370)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165259372494976347)
,p_name=>'P110_WWV_SAMPLE_DATASET_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3778445591701489866)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165259735050976348)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165260108947976348)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165260576622976348)
,p_name=>'P110_SCHEMA'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(3778445591701489866)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165260905911976349)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165261302805976349)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165261787301976351)
,p_name=>'P110_CHANGE_HISTORY'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(3778445591701489866)
,p_prompt=>'Change History'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165262159006976351)
,p_name=>'P110_LAST_UPDATED'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(3778445591701489866)
,p_prompt=>'Dataset Last Updated'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(716619902812799716)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165262515243976351)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165263205345976352)
,p_name=>'P110_INSTALL_LANGUAGE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(330022012396147656)
,p_prompt=>'Language'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165263690720976357)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165264335101976358)
,p_name=>'P110_CURRENT_LANGUAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(330021358989147650)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165264703771976358)
,p_name=>'P110_CURRENT_LANGUAGE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(330021358989147650)
,p_prompt=>'Current Language'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(716619902812799716)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165265534088976359)
,p_name=>'P110_NEW_LANGUAGE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(330021358989147650)
,p_prompt=>'New Language'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'order by l.display_seq'))
,p_lov_display_null=>'YES'
,p_lov_null_text=>'- Select New Language -'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165265928698976360)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165266396519976360)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165266788350976360)
...
'order by 1'))
,p_lov_display_null=>'YES'
,p_lov_null_text=>'- Select New Schema -'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_display_when=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select ''x''',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165270521898976364)
,p_name=>'Set Language (Install)'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165271086377976366)
,p_event_id=>wwv_flow_api.id(165270521898976364)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165271422717976366)
,p_name=>'Set Language (New)'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165271921726976367)
,p_event_id=>wwv_flow_api.id(165271422717976366)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165274107396976368)
,p_name=>'Set Language (New) To Null'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P110_NEW_LANGUAGE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165274652074976368)
,p_event_id=>wwv_flow_api.id(165274107396976368)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165272323947976367)
,p_name=>'Set Schema (Install)'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165272816965976367)
,p_event_id=>wwv_flow_api.id(165272323947976367)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165273218983976368)
,p_name=>'Set Schema (New)'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165273756466976368)
,p_event_id=>wwv_flow_api.id(165273218983976368)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165275094457976369)
,p_name=>'Set Schema (New) to Null'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P110_NEW_SCHEMA'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165275579663976369)
,p_event_id=>wwv_flow_api.id(165275094457976369)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(688504349584608701)
,p_name=>'Close Dialog'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(165267847428976362)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(688504404058608702)
,p_event_id=>wwv_flow_api.id(688504349584608701)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165268929551976363)
,p_process_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165269327216976364)
,p_process_sequence=>20
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165269742263976364)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'                         );'))
,p_process_error_message=>'Error removing dataset'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(165267451506976361)
,p_process_success_message=>'Dataset removed.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165270191879976364)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
...
wwv_flow_api.create_page(
 p_id=>120
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Sample Dataset'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Sample Dataset'
,p_step_sub_title=>'Load Sample Dataset'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180813092354'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330011953426141488)
,p_plug_name=>'Dataset Database Objects'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330012048288141489)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330012499418141494)
,p_plug_name=>'Dataset'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165249902570970173)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(330012048288141489)
,p_button_name=>'Install'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Install Dataset'
,p_button_position=>'REGION_TEMPLATE_CREATE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165250361689970173)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(330012048288141489)
...
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Refresh Existing Dataset'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_condition=>'P120_ACTION'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165250702403970174)
...
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Replace Language and Schema'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_condition=>'P120_ACTION'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165251165088970174)
...
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Replace Schema'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_condition=>'P120_ACTION'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165251539054970174)
...
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Replace Language'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_condition=>'P120_ACTION'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165249149475970172)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(330012048288141489)
,p_button_name=>'Previous'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165249541794970173)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(330012048288141489)
,p_button_name=>'Cancel'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(165257051790970189)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100577660782284434)
,p_name=>'P120_WWV_SAMPLE_JSON_ID'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(330012499418141494)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165252242208970175)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165252654670970178)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165253069432970179)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165253486682970179)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165253804915970179)
,p_name=>'P120_ACTION'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(330012499418141494)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165254296586970179)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165254618700970180)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165255026129970182)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165255412190970183)
,p_name=>'P120_SCHEMA'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(330012499418141494)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(688504543571608703)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(165249541794970173)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(688504660736608704)
,p_event_id=>wwv_flow_api.id(688504543571608703)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CLOSE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165256108353970184)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165256583211970188)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page(
 p_id=>130
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Sample Dataset - Results'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Sample Dataset - Results'
,p_step_sub_title=>'Load Sample Dataset - Results'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_upd_yyyymmddhh24miss=>'20180829091942'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330008940251134479)
,p_plug_name=>'Success'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(330077439097893864)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165244053073963194)
,p_query_column_id=>1
,p_column_alias=>'NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165244494381963196)
,p_query_column_id=>2
,p_column_alias=>'SQL_ERROR'
,p_column_display_sequence=>2
,p_column_heading=>'Sql error'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(494820662196439205)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165245577956963204)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(494820662196439205)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(57831151733033944)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(494820662196439205)
,p_button_name=>'FINISH'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(57831237009033945)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(57831151733033944)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(57831397741033946)
,p_event_id=>wwv_flow_api.id(57831237009033945)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CLOSE'
...
wwv_flow_api.create_page(
 p_id=>150
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Unload to Text - Columns'
,p_page_mode=>'MODAL'
,p_step_title=>'Unload to Text - Columns'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(27155313458825518)
...
,p_plug_query_number_formats=>'::::::'
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'<p>You can unload the contents of a table to a structured text file.  For example you can export an entire table to a comma delimited file (.CSV). Select the database schema that owns the table you would like unload to Text.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(27155716362825519)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(104358211508848205)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444)
,p_translate_title=>'N'
,p_plug_query_num_rows_type=>'ROWS_X_TO_Y_OF_Z'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208611722282655337)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(250661318515297280)
,p_name=>'Columns Unable to Unload'
,p_template=>wwv_flow_api.id(716676747173817184)
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_display_point=>'BODY'
...
,p_display_condition_type=>'EXISTS'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(10583525904875984)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(250661515424297282)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(250661627810297284)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(250661730665297284)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(250661827095297284)
,p_query_column_id=>4
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(940815743000894347)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208611722282655337)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(27154700232825500)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208611722282655337)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(27154924917825505)
,p_branch_action=>'180'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(27154700232825500)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(27155123411825508)
,p_name=>'F4300_P150_SCHEMA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(27155313458825518)
,p_prompt=>'Schema'
,p_source=>'wwv_flow_user_api.get_default_schema'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(249987629719234198)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Select the database table you would like export to a plain text format.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(250371231151263023)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Select the columns you would like to be part of this plain text file. Only Oracle built in data types except BLOB and BFILE are supported to unload.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(250444929550272065)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(250598322886289033)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(65600608761173558)
,p_validation_name=>'schema not null'
,p_validation_sequence=>10
,p_validation=>'F4300_P150_SCHEMA'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Schema must be specified.'
,p_when_button_pressed=>wwv_flow_api.id(27154700232825500)
,p_associated_item=>wwv_flow_api.id(27155123411825508)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(250138105739246184)
...
,p_validation_condition_type=>'ITEM_IS_NULL_OR_ZERO'
,p_when_button_pressed=>wwv_flow_api.id(27154700232825500)
,p_associated_item=>wwv_flow_api.id(249987629719234198)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(250624431197291449)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(940816209580897014)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(940815743000894347)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(940816584358897016)
,p_event_id=>wwv_flow_api.id(940816209580897014)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432756705015101278)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432756921291105974)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page(
 p_id=>180
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Unload to Text - Options'
,p_page_mode=>'MODAL'
,p_step_title=>'Unload to Text - Options'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'AEUTL/sql_utl_exprt.htm'
,p_last_upd_yyyymmddhh24miss=>'20171009062346'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(27163003595914791)
,p_plug_name=>'Unload to Text'
,p_region_template_options=>'#DEFAULT#:a-Form--fixedLabels'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_query_number_formats=>'::::::'
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'<p>Specify the type of separator to be used to separate column values on each line and how to identify text strings in a column.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(27163907693981199)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208613222760664930)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(941533206074201078)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208613222760664930)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(27163504640971637)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(208613222760664930)
,p_button_name=>'EXPORTDATA'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(27164230828990784)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208613222760664930)
,p_button_name=>'previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(151088609408189516)
,p_branch_action=>'f?p=&APP_ID.:180:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(27163504640971637)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(27164522069990788)
,p_branch_action=>'150'
,p_branch_point=>'BEFORE_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(27164230828990784)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5580720856115889)
,p_name=>'F4300_P180_INC_COLUMN_NAME'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(27163003595914791)
,p_prompt=>'Include column names'
,p_display_as=>'NATIVE_CHECKBOX'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'If you wish to export the data with column names, check mark this item.'
,p_attribute_01=>'1'
,p_attribute_02=>'VERTICAL'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(27163402948965482)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Specify the type of separator used to separate the column values on each line.</div> ',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(142827824937224518)
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Select the character set to encode the export file.',
''))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(143184623384792499)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Choose DOS to have the lines in the resulting file terminated by carriage returns and line feeds.  Choose UNIX to have the lines in the resulting file contain terminated by line feeds.  '
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(162884825010392552)
...
,p_field_template=>wwv_flow_api.id(716619902812799716)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Use this option to specify how to identify text strings in a column. You can specify single or double quotation marks.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(196667304565257203)
,p_name=>'P180_TABLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(27163003595914791)
,p_use_cache_before_default=>'NO'
...
,p_field_template=>wwv_flow_api.id(716619902812799716)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Identifies selected table.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(941533402851204296)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(941533206074201078)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(941533765949204298)
,p_event_id=>wwv_flow_api.id(941533402851204296)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1155235261732489540)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1155235386805489541)
,p_event_id=>wwv_flow_api.id(1155235261732489540)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DISABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(27163504640971637)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(27164904458230351)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(27163504640971637)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584798226530530)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(196670309198268035)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(196684208130390717)
,p_process_sequence=>30
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page(
 p_id=>200
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Data - Data'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Data - Data'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21272823578416828)
,p_plug_name=>'Globalization'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676055535817183)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112725909100220750)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(208585513765537107)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>'<p>Copy the data you want to load from a spreadsheet program, such as Microsoft Excel, and paste it into the Data field.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112730325478228304)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(112716503290208213)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444)
,p_translate_title=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208614921852674151)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937840947040120496)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208614921852674151)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(112736203452235067)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208614921852674151)
,p_button_name=>'NEXT'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204374305269310796)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208614921852674151)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(51886005938559488)
,p_branch_action=>'210'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(112736203452235067)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204374726822310798)
,p_branch_action=>'230'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(204374305269310796)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4208210436082721)
,p_name=>'F4300_P200_SEPARATOR'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(112725909100220750)
,p_item_default=>'\t'
,p_prompt=>'Separator'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>2
...
,p_field_template=>wwv_flow_api.id(716620116614799716)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>Identify a column separator character. Use <strong>\t</strong> for tab separators and <strong>,</strong> for comma separators.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4209527059087470)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21275331197419000)
,p_name=>'P200_CURRENCY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(21272823578416828)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_return_val varchar2(30) := ''$'';',
'begin',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21710714544355494)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21713607056362785)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112740117271247331)
...
,p_field_template=>wwv_flow_api.id(716620262276799717)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>'Copy and paste the data you want to load from a spreadsheet program.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112749902593269315)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49528010062670927)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(118390630315447740)
...
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_api.id(112740117271247331)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4210720957095218)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(112736203452235067)
,p_associated_item=>wwv_flow_api.id(4208210436082721)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(1856338767985918224)
...
,p_error_message=>'Data pasted is too large.  Please save the file in a comma delimited (csv) or tab delimited format. Then upload the file to load the data.'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937841145052122532)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937840947040120496)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937841453405122532)
,p_event_id=>wwv_flow_api.id(937841145052122532)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(117624930761654964)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(112736203452235067)
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112768526710303685)
,p_plug_name=>'Set Table Properties'
,p_region_name=>'dataload_properties'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112771111398310853)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112785418706337777)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#:a-Form--fixedLabels'
,p_component_template_options=>'#DEFAULT#'
...
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>'<p>This page previews how your table will be defined. Enter a table name, and then review the column names, data types, and column lengths. To upload columns, select <b>Yes</b> or <b>No</b>.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208626820868128034)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937846775380244224)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208626820868128034)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(116940415820894908)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208626820868128034)
,p_button_name=>'Next'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(112777203593320251)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208626820868128034)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(116940829853894912)
,p_branch_action=>'220'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(116940415820894908)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(112777626990320254)
,p_branch_name=>'Go To Page 200'
,p_branch_action=>'f?p=&APP_ID.:200:&SESSION.::&DEBUG.:RP,CLOB_CONTENT::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(112777203593320251)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(77784300806046762)
,p_name=>'P210_PRESERVE_CASE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(112785418706337777)
,p_prompt=>'Preserve case'
,p_display_as=>'NATIVE_CHECKBOX'
,p_named_lov=>'PRESERVE.CASE.Y'
,p_lov=>'.'||wwv_flow_api.id(87931511182663028)||'.'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100051613844477110)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112792123870350640)
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Select the database schema you would like to create and load data into.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112794014812354843)
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'<div class="htmldbInfoBodyP">Identify the table name you would like to create. By default, all table names are converted to upper case. Select <span class="fielddatabold">Preserve Case</span> override this default behavior.</div>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(77787115351050931)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(100053005864480800)
,p_computation_sequence=>20
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(114893927053188792)
,p_validation_name=>'column name not null, not > 30 (11g) or > 128 (12.2)'
,p_validation_sequence=>10
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(118154731285520466)
,p_validation_name=>'table name not > 30 (11g) or > 128 (12.2)'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_api.id(112794014812354843)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(91385502544995259)
,p_validation_name=>'column length not zero or null'
,p_validation_sequence=>30
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(114895819289192431)
,p_validation_name=>'table name not null'
,p_validation_sequence=>40
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(115047225043539180)
,p_validation_name=>'cannot have same table name'
,p_validation_sequence=>50
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'if wwv_flow_load_excel_data.table_exists(',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(117872306579291939)
,p_validation_name=>'at least one upload selected'
,p_validation_sequence=>70
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(289728718255300356)
,p_validation_name=>'reserved name'
,p_validation_sequence=>80
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(291055332677788667)
,p_validation_name=>'column name reserved word'
,p_validation_sequence=>90
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(25730909453566476)
,p_validation_name=>'F4300_P200_OWNER'
,p_validation_sequence=>100
,p_validation=>'F4300_P200_OWNER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Schema must be specified.'
,p_when_button_pressed=>wwv_flow_api.id(116940415820894908)
,p_associated_item=>wwv_flow_api.id(112792123870350640)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(460448021945064666)
...
'return TRUE;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'There are one or more duplicate column names.'
,p_when_button_pressed=>wwv_flow_api.id(116940415820894908)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937847166341246211)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937846775380244224)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937847496378246211)
,p_event_id=>wwv_flow_api.id(937847166341246211)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432757616574114106)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(117056604391055559)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(117059228102059736)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208627826540139171)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937848432173255988)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208627826540139171)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(117073012899083351)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208627826540139171)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(117070800779079776)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208627826540139171)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(117073412886083354)
,p_branch_action=>'11'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(117073012899083351)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(29278228032445971)
,p_branch_action=>'220'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>20
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(52010014229160977)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(117071203531079778)
,p_branch_action=>'210'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(117070800779079776)
,p_branch_sequence=>40
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29225226404227933)
,p_name=>'P200_PK1_NAME'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(117056604391055559)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29231303248249589)
,p_name=>'P200_PK_TYPE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(117056604391055559)
,p_item_default=>'NEW_SEQUENCE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29236325197265446)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29241232039286358)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(52007705655139616)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(52012902417204955)
,p_name=>'P200_PK1_2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(117056604391055559)
,p_item_default=>'ID'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Enter the name of the new column to identify the row in the table'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(117095028927104885)
,p_name=>'P220_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(117056604391055559)
,p_use_cache_before_default=>'NO'
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Schema that owns the table.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(117097720517108862)
...
,p_escape_on_http_output=>'N'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Name of the table to load the data into'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(117102827837120664)
,p_name=>'P200_PK1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(117056604391055559)
,p_prompt=>'Primary Key'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(13590021101989074)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29253014255347439)
,p_computation_sequence=>20
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29250213170318666)
,p_computation_sequence=>30
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29248007498307620)
,p_computation_sequence=>40
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29254418196358029)
...
,p_validation_condition2=>'EXISTING_SEQUENCE'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351)
,p_associated_item=>wwv_flow_api.id(29236325197265446)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29266319281386761)
,p_validation_name=>'PK_NAME available'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'Error.'
,p_associated_item=>wwv_flow_api.id(29225226404227933)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52417430985005732)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351)
,p_associated_item=>wwv_flow_api.id(117102827837120664)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52419018303011469)
,p_validation_name=>'PK not null'
,p_validation_sequence=>40
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351)
,p_associated_item=>wwv_flow_api.id(52012902417204955)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52420808391018166)
,p_validation_name=>'PK not > 30 chars'
,p_validation_sequence=>50
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52424804066054749)
,p_validation_name=>'PK gen option needs to be auto'
,p_validation_sequence=>60
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351)
,p_associated_item=>wwv_flow_api.id(29231303248249589)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29270400759419169)
,p_validation_name=>'PK_NAME not null'
,p_validation_sequence=>70
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29274101928429039)
,p_validation_name=>'SEQ_NAME available'
,p_validation_sequence=>80
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351)
,p_associated_item=>wwv_flow_api.id(29241232039286358)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(48704226490898036)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937848654142258327)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937848432173255988)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937848917746258327)
,p_event_id=>wwv_flow_api.id(937848654142258327)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(117113015507171948)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(117073012899083351)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(117884026167328458)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insert data'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584506824530528)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432758606662120691)
,p_process_sequence=>30
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page(
 p_id=>230
,p_user_interface_id=>wwv_flow_api.id(4969527595302343)
,p_name=>'Load Data - Target and Method'
,p_page_mode=>'MODAL'
,p_step_title=>'Load Data - Target and Method'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
,p_help_text=>'AEUTL/sql_utl_imprt.htm'
,p_last_upd_yyyymmddhh24miss=>'20161018094805'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23238502857624260)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204342305194256542)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208631500137150436)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(755293959966836805)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208631500137150436)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204360203968291570)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(208631500137150436)
,p_button_name=>'Next'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4107407002608653)
,p_branch_action=>'f?p=&APP_ID.:18:&SESSION.::&DEBUG.:18,19,21::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(204360203968291570)
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(101365129882269401)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(7218508617368954)
,p_branch_name=>'Go To Page 200'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(7222330435375211)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4077631590265585)
,p_name=>'F4300_P230_LOAD_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(204342305194256542)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4085714930308101)
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Choose what you want to load your data into.  If your database table exists choose "existing table".  If you would like to have a new table created choose "new table".'
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4087612637316960)
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Specify if the data is to be uploaded from a file to copy and pasted from a spreadsheet'
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(144922211438995306)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(755294096977836806)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(755293959966836805)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(755294125459836807)
,p_event_id=>wwv_flow_api.id(755294096977836806)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_api.id(215729525348581243)
,p_step_template=>wwv_flow_api.id(716604580917788355)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_attributes=>'resizable:true,minWidth:500,minHeight:400'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'AEUTL/sql_utl_imprt.htm'
,p_last_upd_yyyymmddhh24miss=>'20161028080528'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204401222157339825)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204716203535971465)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(204693724897946351)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444)
,p_translate_title=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208632630958159342)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937854111825355772)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208632630958159342)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204420610772359727)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208632630958159342)
,p_button_name=>'Next'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204423219430362194)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208632630958159342)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204421016156359729)
,p_branch_name=>'Go To Page 270'
,p_branch_action=>'f?p=&APP_ID.:270:&SESSION.::&DEBUG.:RP,CLOB_CONTENT::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(204420610772359727)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204423618157362195)
,p_branch_action=>'230'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(204423219430362194)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204430218669387043)
,p_name=>'F4300_P240_TABLE_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(204401222157339825)
,p_prompt=>'Table Owner'
,p_source=>'wwv_flow_user_api.get_default_schema'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_SELECT_LIST'
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Choose the database schema that owns the table you would like load Excel data into.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(246102019809840383)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Choose the database table you would like load data into. By default, all table names are converted to upper case. Select <span class="fielddatabold">Preserve Case</span> override this default behavior.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(204445117363402835)
...
,p_associated_item=>wwv_flow_api.id(204430218669387043)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 16-APR-2002 11:44'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(249092017542126655)
,p_validation_name=>'Table Name Must Be Selected'
,p_validation_sequence=>20
...
,p_validation_condition_type=>'ITEM_IS_NULL_OR_ZERO'
,p_when_button_pressed=>wwv_flow_api.id(204420610772359727)
,p_associated_item=>wwv_flow_api.id(246102019809840383)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937854390691357948)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937854111825355772)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937854626445357948)
,p_event_id=>wwv_flow_api.id(937854390691357948)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204491026143474742)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#:a-Form--fixedLabels'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_display_point=>'BODY'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>'<p>This page previews how your data will be loaded. Match the database column names with columns in the data. To upload columns, select <b>Yes</b> or <b>No</b>. An asterisk (*) indicates a required column. To upload data to the selected table, click '
||'<b>Load Data</b>.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204502624837490516)
,p_plug_name=>'Define Column Mapping'
,p_region_name=>'dataload_properties'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204723028108975231)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208634426933167651)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937859839834424223)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208634426933167651)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204499923557486442)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208634426933167651)
,p_button_name=>'LOAD_SPREADSHEET'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204496812129483108)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208634426933167651)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204500300920486444)
,p_branch_name=>'Go To Page 11'
,p_branch_action=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:RP:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(204499923557486442)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204497212696483110)
,p_branch_name=>'Go To Page 270'
,p_branch_action=>'f?p=&APP_ID.:270:&SESSION.::&DEBUG.:RP,CLOB_CONTENT::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(204496812129483108)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3876124806580817)
,p_name=>'F4300_P260_DUMMY'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(204491026143474742)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204576022341643606)
...
,p_escape_on_http_output=>'N'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Name of the owner of the table'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204580511127648778)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(3877004851584509)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(1970910321700429)
,p_validation_name=>'column name not null'
,p_validation_sequence=>10
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(1976413962729112)
,p_validation_name=>'at least one upload selected'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2246727491917184)
,p_validation_name=>'not null columns must be loaded'
,p_validation_sequence=>30
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2416102541642929)
,p_validation_name=>'duplicate column names'
,p_validation_sequence=>40
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937860168589426014)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937859839834424223)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937860430093426015)
,p_event_id=>wwv_flow_api.id(937860168589426014)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1998328769813398)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insert data'
...
'end;'))
,p_process_error_message=>'Error inserting data.'
,p_process_when_button_id=>wwv_flow_api.id(204499923557486442)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584417528530527)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432759525709126193)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21176307696090495)
,p_plug_name=>'Globalization'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676055535817183)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204523926135583458)
,p_plug_name=>'Load Data'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
,p_plug_display_point=>'BODY'
,p_plug_column_width=>'valign="top"'
,p_plug_header=>'<p>Copy the data you want to import from a spreadsheet program, such as Microsoft Excel, and paste it into the Data field.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204526605078583471)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208636709187181466)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937854870258362997)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208636709187181466)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204524413345583460)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208636709187181466)
,p_button_name=>'NEXT'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204524712263583462)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208636709187181466)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204526930972583473)
,p_branch_action=>'260'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204527202242583475)
,p_branch_action=>'240'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(204524712263583462)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4182706815845162)
,p_name=>'F4300_P270_SEPARATOR'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(204523926135583458)
,p_item_default=>','
,p_prompt=>'Separator'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>2
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4184502444853276)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21177230552097084)
,p_name=>'P270_CURRENCY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(21176307696090495)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_return_val varchar2(30) := ''$'';',
'begin',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21863704163128428)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21865509835139517)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204525129697583464)
...
,p_field_template=>wwv_flow_api.id(716620262276799717)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>'You can paste up to 30KB of data into this field.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204525430553583465)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49537626170713419)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4186717812867171)
,p_validation_name=>'separator not null'
,p_validation_sequence=>10
...
,p_validation_condition2=>'CSV'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(4182706815845162)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(83593200492080009)
,p_validation_name=>'clob collection exists'
,p_validation_sequence=>20
,p_validation=>'select null from apex_collections where collection_name=''CLOB_CONTENT'';'
,p_validation_type=>'EXISTS'
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_when_button_pressed=>wwv_flow_api.id(204524413345583460)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(204527804107583477)
,p_validation_name=>'data not null'
,p_validation_sequence=>30
,p_validation=>'F4300_P270_EXCEL_DATA'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Data must be specified.'
,p_associated_item=>wwv_flow_api.id(204525129697583464)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937856058957374906)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937854870258362997)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937856350408374907)
,p_event_id=>wwv_flow_api.id(937856058957374906)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(204528110232583479)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'read collection and get table info'
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(693161896808233268)
);
end;
/
