...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,4700)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'NEW_SERVICE')
...
,p_authentication_id=>wwv_flow_api.id(108165525079033088)
,p_populate_roles=>'A'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(4762183464)
,p_name=>'ProvisionNewService'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(60577706518684017)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4770195076)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4836827003)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(25699022299795195)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(109218886058)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(80382420312008140)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4764187459)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1790487565405202)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14848914952940932)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(91995779189572410)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1082460202795623111)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1765072946679712055)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1831722819976993878)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1917634925946939898)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(510672326686703270)
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25713507070566709)
,p_name=>'A1'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25715301313574483)
,p_name=>'A10'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25713709840567432)
,p_name=>'A2'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25713912264568155)
,p_name=>'A3'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25714115727569121)
,p_name=>'A4'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25714319190570197)
,p_name=>'A5'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25714521961570954)
,p_name=>'A6'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25714725078571880)
,p_name=>'A7'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25714927155572445)
,p_name=>'A8'
,p_protection_level=>'N'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25715129580573146)
,p_name=>'A9'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(144047527689955702)
,p_name=>'AGREEMENT_ACCEPTED'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(103247625354177724)
,p_name=>'F4700_REQ_NEW_SCHEMA'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(318946157429)
,p_name=>'HELP_PAGE'
,p_item_comment=>'flow page that you would like help for.'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(8584002656832123)
,p_name=>'LOGIN_MESSAGE'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25782509996254728)
,p_name=>'LOV_1'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25794005175480492)
,p_name=>'LOV_10'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25792324437476584)
,p_name=>'LOV_2'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25792625823477001)
,p_name=>'LOV_3'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25792827554477507)
,p_name=>'LOV_4'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25793029286478012)
,p_name=>'LOV_5'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25793231017478467)
,p_name=>'LOV_6'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25793400327479065)
,p_name=>'LOV_7'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25793602058479541)
,p_name=>'LOV_8'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25793803790480026)
,p_name=>'LOV_9'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(8632704676428693)
,p_name=>'PAGES_VISITED'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(63599167129385025)
,p_name=>'PKG_APPS_ONLY_ALLOWED'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25700525687890714)
,p_name=>'Q1'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25702323047899430)
,p_name=>'Q10'
,p_protection_level=>'N'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25700729496891839)
,p_name=>'Q2'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25700931920892551)
,p_name=>'Q3'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25701102269893436)
,p_name=>'Q4'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25701305386894398)
,p_name=>'Q5'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25701515775897352)
,p_name=>'Q6'
,p_protection_level=>'N'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25701717506897886)
,p_name=>'Q7'
,p_protection_level=>'N'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25701919238898391)
,p_name=>'Q8'
,p_protection_level=>'N'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25702120970898892)
,p_name=>'Q9'
,p_protection_level=>'N'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(70976882659217226)
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(8650202046513064)
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(63599572392390653)
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(70977000257223302)
,p_computation_sequence=>10
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(103248202067189926)
,p_computation_sequence=>10
...
wwv_flow_api.create_toplevel_tab(
 p_id=>wwv_flow_api.id(11450003334894502)
,p_tab_set=>'TOP'
,p_tab_sequence=>20
,p_tab_name=>'T_TOP'
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(80457122175018113)
,p_lov_name=>'ACCEPT TERMS'
,p_lov_query=>'.'||wwv_flow_api.id(80457122175018113)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(80457326295018115)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(728312584834618523)
,p_lov_name=>'WORKSPACE_TYPE'
,p_lov_query=>'.'||wwv_flow_api.id(728312584834618523)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(728312822592618530)
,p_lov_disp_sequence=>1
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(728313109611618535)
,p_lov_disp_sequence=>2
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4674102852)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18107622439281852)
,p_theme_id=>3
,p_name=>'[EBA] Wizard'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(728298792391563586)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(728299018883563592)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(728303139008563600)
,p_theme_id=>3
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18109103748352135)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18109222795357646)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18109301108360805)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18109418424365879)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(481975242743888810)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(481975658518888812)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(481975923749888812)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(481976264382888813)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(516411350946385636)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18108515260336521)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18113207959457422)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29133613931545850)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(481965601614717220)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(481969298650741033)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(481970015003751305)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(728272729796557092)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(728279364278557123)
,p_layout=>'TABLE'
,p_template=>'<div id="#REGION_STATIC_ID#" class="#REGION_CSS_CLASSES#" #REGION_ATTRIBUTES#>#PREVIOUS##BODY##NEXT#</div>'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(728280005939557124)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(728292067255557137)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(728292709128557138)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(728293431473557139)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(728294112567557139)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(860617531457119334)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4794278052)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18108230235321990)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(481972912021825750)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18117622573511758)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18117725602511758)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18341322111783282)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(481972669929805619)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(481972771960821314)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(516405744549268368)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(516405998930268369)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(805564588331659193)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(14663214008465131)
,p_page_name=>'winlov'
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(75131326757053015)
,p_theme_id=>3
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(18107622439281852)
,p_error_template=>wwv_flow_api.id(728299018883563592)
,p_printer_friendly_template=>wwv_flow_api.id(4674102852)
,p_default_button_template=>wwv_flow_api.id(18109103748352135)
,p_default_region_template=>wwv_flow_api.id(18113207959457422)
,p_default_label_template=>wwv_flow_api.id(18117622573511758)
,p_default_list_template=>wwv_flow_api.id(4794278052)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(204024310335769388)
,p_theme_id=>3
,p_name=>'Standard'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(728273198308557106)
,p_theme_id=>3
,p_name=>'REGION_TITLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(728273812208557117)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(728274811074557119)
,p_theme_id=>3
,p_name=>'REGION_STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(728281789702557125)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(728282779546557126)
,p_theme_id=>3
,p_name=>'DISPLAY'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(728284958660557127)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746434995533421149)
,p_theme_id=>3
,p_name=>'HEIGHT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746436279201421149)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746436594439421149)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746436840999421149)
,p_theme_id=>3
,p_name=>'BUTTON_SET'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746437988722421151)
,p_theme_id=>3
,p_name=>'LABEL_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746438219342421151)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746438589659421151)
,p_theme_id=>3
,p_name=>'BUTTON_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746438816241421151)
,p_theme_id=>3
,p_name=>'SPACING_LEFT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746439137924421151)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746439645845421152)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746439918130421152)
,p_theme_id=>3
,p_name=>'BUTTON_TYPE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(728276986572557122)
,p_theme_id=>3
,p_name=>'REGIONCONTAINSITEMSTEXT'
,p_display_name=>'Region Contains Items / Text'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(728272729796557092)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(728277248569557122)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(728277525479557122)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(728277818941557122)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(728278146450557122)
,p_theme_id=>3
,p_name=>'NOPADDING'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(728278498295557123)
,p_theme_id=>3
,p_name=>'WIZARDDIALOG'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(728278798769557123)
,p_theme_id=>3
,p_name=>'VISIBLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(728279089427557123)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746435033845421149)
,p_theme_id=>3
,p_name=>'180PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746435216989421149)
,p_theme_id=>3
,p_name=>'240PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746435405988421149)
,p_theme_id=>3
,p_name=>'320PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746435656825421149)
,p_theme_id=>3
,p_name=>'480PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746435848002421149)
,p_theme_id=>3
,p_name=>'540PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746436091506421149)
,p_theme_id=>3
,p_name=>'640PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746436368676421149)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746436678574421149)
,p_theme_id=>3
,p_name=>'AUTOWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746436965719421149)
,p_theme_id=>3
,p_name=>'FIRSTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746437112234421149)
,p_theme_id=>3
,p_name=>'FIXEDLARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746437368469421149)
,p_theme_id=>3
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746437581881421150)
,p_theme_id=>3
,p_name=>'FIXEDWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746437748876421150)
,p_theme_id=>3
,p_name=>'INNERBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746438058857421151)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746438384706421151)
,p_theme_id=>3
,p_name=>'LABELSABOVE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746438655416421151)
,p_theme_id=>3
,p_name=>'LARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746438901201421151)
,p_theme_id=>3
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746439281590421151)
,p_theme_id=>3
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746439479283421151)
,p_theme_id=>3
,p_name=>'LASTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746439725429421152)
,p_theme_id=>3
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746440034159421152)
,p_theme_id=>3
,p_name=>'PRIMARY'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746440162594421152)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746440362741421152)
,p_theme_id=>3
,p_name=>'SMALL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746440520463421152)
,p_theme_id=>3
,p_name=>'SMALLLEFT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746440758010421152)
,p_theme_id=>3
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746440822788421152)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746440925815421152)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1199561525047032426)
,p_theme_id=>3
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(481975658518888812)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_api.id(746439645845421152)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554852920727542292)
,p_theme_id=>3
,p_name=>'FLUSHREGION'
,p_display_name=>'Flush Region'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(728280005939557124)
,p_css_classes=>'a-Region--flush'
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554853081668542293)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554853269909542294)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554853498802542294)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554853672639542294)
,p_theme_id=>3
,p_name=>'SIDEBAR'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554853833133542294)
,p_theme_id=>3
,p_name=>'BORDERLESS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554854022496542294)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554854201680542294)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554854474957542294)
,p_theme_id=>3
,p_name=>'EXPANDED'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554854632648542294)
,p_theme_id=>3
,p_name=>'COLLAPSED'
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(46948758488708852)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72249221944976158)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72249331462976158)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72249422093976158)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72249524286976158)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72249616486976158)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72249708847976158)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72249804429976158)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72249911966976158)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72250029723976159)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(187203309767569784)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(108165525079033088)
,p_name=>'Database'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(766219159606055235)
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(766196516105997136)
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(766196759876997170)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(766197021878997171)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766197365447997172)
,p_plugin_id=>wwv_flow_api.id(766197021878997171)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766197796115997175)
,p_plugin_id=>wwv_flow_api.id(766197021878997171)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766198136805997175)
,p_plugin_attribute_id=>wwv_flow_api.id(766197796115997175)
,p_display_sequence=>10
,p_display_value=>'Redirect to Built-In URL'
,p_return_value=>'BUILTIN_URL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766198607775997179)
,p_plugin_attribute_id=>wwv_flow_api.id(766197796115997175)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766199141822997179)
,p_plugin_attribute_id=>wwv_flow_api.id(766197796115997175)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766199679513997179)
,p_plugin_id=>wwv_flow_api.id(766197021878997171)
,p_attribute_scope=>'COMPONENT'
...
,p_display_length=>60
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(766197796115997175)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766200078701997180)
,p_plugin_id=>wwv_flow_api.id(766197021878997171)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766200401895997180)
,p_plugin_id=>wwv_flow_api.id(766197021878997171)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766200885924997181)
,p_plugin_attribute_id=>wwv_flow_api.id(766200401895997180)
,p_display_sequence=>10
,p_display_value=>'Each Request'
,p_return_value=>'ALWAYS'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766201379201997181)
,p_plugin_attribute_id=>wwv_flow_api.id(766200401895997180)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766201894583997182)
,p_plugin_id=>wwv_flow_api.id(766197021878997171)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(766203167836997187)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766203355186997187)
,p_plugin_id=>wwv_flow_api.id(766203167836997187)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766203742780997187)
,p_plugin_id=>wwv_flow_api.id(766203167836997187)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766204192689997188)
,p_plugin_id=>wwv_flow_api.id(766203167836997187)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766204501729997188)
,p_plugin_attribute_id=>wwv_flow_api.id(766204192689997188)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766205090281997190)
,p_plugin_attribute_id=>wwv_flow_api.id(766204192689997188)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766205526368997190)
,p_plugin_attribute_id=>wwv_flow_api.id(766204192689997188)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766206087018997190)
,p_plugin_id=>wwv_flow_api.id(766203167836997187)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766206425955997191)
,p_plugin_id=>wwv_flow_api.id(766203167836997187)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766206835038997191)
,p_plugin_id=>wwv_flow_api.id(766203167836997187)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(766206425955997191)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766207286081997191)
,p_plugin_id=>wwv_flow_api.id(766203167836997187)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(766207666923997191)
,p_plugin_id=>wwv_flow_api.id(766203167836997187)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766208002519997192)
,p_plugin_attribute_id=>wwv_flow_api.id(766207666923997191)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766208532334997192)
,p_plugin_attribute_id=>wwv_flow_api.id(766207666923997191)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(766209088734997192)
,p_plugin_attribute_id=>wwv_flow_api.id(766207666923997191)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(766209839828997194)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(766210172744997195)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(805561388021651744)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(805561682413651902)
,p_plugin_id=>wwv_flow_api.id(805561388021651744)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Icon Size'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(805562091226651903)
,p_plugin_attribute_id=>wwv_flow_api.id(805561682413651902)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'S'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(805562552885651903)
,p_plugin_attribute_id=>wwv_flow_api.id(805561682413651902)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(805563001543651903)
,p_plugin_attribute_id=>wwv_flow_api.id(805561682413651902)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(805563507507651905)
,p_plugin_id=>wwv_flow_api.id(805561388021651744)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(845155894988834530)
,p_plugin_id=>wwv_flow_api.id(805561388021651744)
,p_name=>'LOV'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(4970202676302344)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(4970202676302344)
,p_name=>'0'
,p_step_title=>'0'
...
,p_step_template=>wwv_flow_api.id(728298792391563586)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_last_upd_yyyymmddhh24miss=>'20150213105017'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(384692482059932839)
,p_plug_name=>'APEX 5 - Header'
,p_region_css_classes=>'a-Header'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481965601614717220)
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(4970202676302344)
,p_name=>'Request Workspace'
,p_step_title=>'Request a Workspace - Oracle &PRODUCT_NAME.'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122228'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(384691444752932829)
,p_plug_name=>'Request a Workspace'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(481970015003751305)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(384691527009932830)
,p_plug_name=>'Wizard Progress Bar'
,p_parent_plug_id=>wwv_flow_api.id(384691444752932829)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481969298650741033)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(384692102633932836)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_api.id(384691527009932830)
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(4762183464)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(481972912021825750)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(384691677393932831)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_api.id(384691444752932829)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(728293431473557139)
...
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>'<p class="a-Wizard-subHeading">What type of workspace would you like to request?</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(384692253736932837)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(384692330805932838)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(384692253736932837)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(384692558261932840)
...
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975242743888810)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(741644129987187002)
,p_branch_name=>'Redirect to Login Page'
,p_branch_action=>'f?p=4550:1'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(384692558261932840)
,p_branch_sequence=>1
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(66683221933097168)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(63400724500961703)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(692815844776250920)
,p_name=>'WORKSPACE_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(384691677393932831)
...
,p_field_template=>wwv_flow_api.id(805564588331659193)
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122248'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(624348233786280075)
,p_plug_name=>'Request a Workspace'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(624348462275280075)
,p_plug_name=>'Wizard Progress Bar'
,p_parent_plug_id=>wwv_flow_api.id(624348233786280075)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481969298650741033)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(624348630378280075)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_api.id(624348462275280075)
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(4762183464)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(624348871164280076)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_api.id(624348233786280075)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(624350429513280083)
,p_plug_name=>'Wizard Buttons'
,p_parent_plug_id=>wwv_flow_api.id(624348233786280075)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(624350696578280086)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(624350429513280083)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(624391705621329097)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(624350429513280083)
...
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481976264382888813)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(624350869612280090)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(624350429513280083)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(624352524796280096)
,p_branch_name=>'Go To Page 25'
,p_branch_action=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(624350696578280086)
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(74099388176078401)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(711861644632245744)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(711861279470245740)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(624392091754336529)
,p_branch_name=>'Go to Page 1'
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(624391705621329097)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(741644387803197176)
,p_branch_name=>'Redirect to Login Page'
,p_branch_action=>'f?p=4550:1'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(624350869612280090)
,p_branch_sequence=>30
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(624349012704280076)
,p_name=>'ADMIN_FIRST_NAME'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(624348871164280076)
,p_prompt=>'First Name'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(481972771960821314)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(624349255885280079)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(624349478067280079)
,p_name=>'ADMIN_EMAIL'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(624348871164280076)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(624349967806280083)
,p_name=>'COMPANY_NAME'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(624348871164280076)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(624351113308280091)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(711861350344245741)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(711861471568245742)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(711861526274245743)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(624351739240280095)
,p_validation_name=>'ADMIN_FIRST_NAME not null'
,p_validation_sequence=>10
,p_validation=>'ADMIN_FIRST_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Required'
,p_associated_item=>wwv_flow_api.id(624349012704280076)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(624351943922280095)
,p_validation_name=>'ADMIN_LAST_NAME not null'
,p_validation_sequence=>20
,p_validation=>'ADMIN_LAST_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Required'
,p_associated_item=>wwv_flow_api.id(624349255885280079)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(624352137233280095)
,p_validation_name=>'ADMIN_EMAIL not null'
,p_validation_sequence=>30
,p_validation=>'ADMIN_EMAIL'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Required'
,p_associated_item=>wwv_flow_api.id(624349478067280079)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(624352336404280096)
...
,p_when_button_pressed=>wwv_flow_api.id(624350696578280086)
,p_associated_item=>wwv_flow_api.id(624349478067280079)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(624351399015280093)
...
,p_when_button_pressed=>wwv_flow_api.id(624350696578280086)
,p_associated_item=>wwv_flow_api.id(624349967806280083)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(624351561451280095)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2039742467923109427)
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122255'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(26270707309302905)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516145500301081707)
,p_plug_name=>'Wizard Body'
,p_parent_plug_id=>wwv_flow_api.id(26270707309302905)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(235693425700565320)
,p_name=>'P3_COMPANY_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(26270707309302905)
,p_display_as=>'NATIVE_HIDDEN'
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(235693721602567173)
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122301'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(25696603898761468)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(18108515260336521)
,p_plug_display_sequence=>10
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516394643687212836)
,p_plug_name=>'Request a Workspace'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516394851182212837)
,p_plug_name=>'Wizard Progress Bar'
,p_parent_plug_id=>wwv_flow_api.id(516394643687212836)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481969298650741033)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516145498582081706)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_api.id(516394851182212837)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516395010313212838)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_api.id(516394643687212836)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(25696432164760206)
,p_plug_name=>'&PRODUCT_NAME. Registration'
,p_parent_plug_id=>wwv_flow_api.id(516395010313212838)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(26648304716757938)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(26648804847767366)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516395225562212838)
,p_plug_name=>'Wizard Buttons'
,p_parent_plug_id=>wwv_flow_api.id(516394643687212836)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(25697412694761472)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(516395225562212838)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(25697023233761471)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(516395225562212838)
,p_button_name=>'BACK'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(64572886936929402)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(516395225562212838)
,p_button_name=>'BACK2'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(25696820320761471)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517470693841985745)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25699805554856566)
,p_name=>'P24_Q1'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
,p_prompt=>'&Q1.'
...
,p_field_template=>wwv_flow_api.id(516405998930268369)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25702726426919309)
,p_name=>'P24_Q2'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25703326211928720)
,p_name=>'P24_Q3'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25703724011994311)
,p_name=>'P24_Q4'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25777606991111943)
,p_name=>'P24_Q5'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25778026731117668)
,p_name=>'P24_Q6'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25778229501118422)
,p_name=>'P24_Q7'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25778431925119147)
,p_name=>'P24_Q8'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25778601582119878)
,p_name=>'P24_Q9'
,p_is_required=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25778810239122410)
,p_name=>'P24_Q10'
,p_is_required=>true
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(25696432164760206)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517957195019106801)
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_when_button_pressed=>wwv_flow_api.id(25697412694761472)
,p_associated_item=>wwv_flow_api.id(25699805554856566)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517957657444109073)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517958236752112011)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517958400795112554)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517958664493113319)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517958828394113925)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517959294776114427)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517959538183114913)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517959792447115409)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(517959974835115917)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(25700112527886954)
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122309'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4863831037)
,p_plug_name=>'Request a Workspace'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(29261829463725446)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_api.id(4863831037)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481969298650741033)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516145120027081703)
,p_plug_name=>'Wizard Progress Bar'
,p_parent_plug_id=>wwv_flow_api.id(4863831037)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516145206173081704)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_api.id(516145120027081703)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516145337648081705)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_api.id(4863831037)
,p_region_css_classes=>'a-Wizard-body a-Form a-Form--large'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18350230104012648)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4841831018)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(29261829463725446)
,p_button_name=>'Proceed'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975658518888812)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4893430263)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(29261829463725446)
,p_button_name=>'Back'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4839831015)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(29261829463725446)
,p_button_name=>'Cancel'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(177096326383922599)
,p_branch_action=>'f?p=&APP_ID.:26:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(4841831018)
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(25800727750666745)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(66700008567178536)
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>30
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(881357448284941741)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517333648995125819)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1617426846755257730)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4849831028)
,p_name=>'DATABASE_SIZE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(516145337648081705)
...
,p_field_template=>wwv_flow_api.id(481972669929805619)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(320269887457)
,p_name=>'SCHEMA_NAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(516145337648081705)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(11472001772984287)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36459510251028490)
,p_name=>'NEW_SCHEMA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(516145337648081705)
,p_item_default=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(172217307242398784)
...
,p_display_when2=>'YES'
,p_display_when_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_field_template=>wwv_flow_api.id(18341322111783282)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(172222728497414363)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(177097216171957551)
,p_name=>'P25_SCHEMA'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(18350230104012648)
,p_display_as=>'NATIVE_HIDDEN'
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WEB_SAFE'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(177098721282977925)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(241344206807542545)
,p_computation_sequence=>20
,p_computation_item=>'NEW_SCHEMA'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'FUNCTION_BODY'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(4348304649326378516)
,p_computation_sequence=>30
,p_computation_item=>'DATABASE_SIZE'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'FUNCTION_BODY'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(174995802627402506)
...
,p_associated_item=>wwv_flow_api.id(320269887457)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(174996724098408796)
...
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(11472001772984287)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(16910421773188557)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(31864751459513493)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(31865013913542993)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(47216914721574906)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(47217711926597880)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(59988904879054677)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(175009024256995482)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(426906789735388104)
...
,p_associated_item=>wwv_flow_api.id(4849831028)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13059725120036431)
,p_process_sequence=>10
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122317'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(177082418885844385)
,p_plug_name=>'Warning'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(18113207959457422)
,p_plug_display_sequence=>10
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_plug_display_column=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(195695513611201651)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517949648797931799)
,p_plug_name=>'Request a Workspace'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517949851182931801)
,p_plug_name=>'Wizard Progress Bar'
,p_parent_plug_id=>wwv_flow_api.id(517949648797931799)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481969298650741033)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517950053089931801)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_api.id(517949851182931801)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517950234959931802)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_api.id(517949648797931799)
,p_region_css_classes=>'a-Wizard-body a-Form'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517952931820969756)
,p_plug_name=>'Shared Schema Warning'
,p_parent_plug_id=>wwv_flow_api.id(517950234959931802)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517953857557021232)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517950490437931802)
,p_plug_name=>'Wizard Buttons'
,p_parent_plug_id=>wwv_flow_api.id(517949648797931799)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(752122034442695897)
,p_plug_name=>'Request Workspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'DEFAULT'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(728294112567557139)
,p_plug_display_sequence=>10
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(177082802719844403)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(517950490437931802)
,p_button_name=>'Proceed'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975658518888812)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(177083008639844403)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(517950490437931802)
,p_button_name=>'Back'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(177082609759844393)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(517950490437931802)
,p_button_name=>'Cancel'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(66706514632218067)
,p_branch_action=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(177082802719844403)
,p_branch_sequence=>10
,p_branch_condition_type=>'EXISTS'
,p_branch_condition=>'select 1 from WWV_FLOW_PROV_SIGNUP_Q where SURVEY_ENABLED_YN = ''Y'''
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(25801706888679653)
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(177082802719844403)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517472394235011586)
,p_branch_action=>'f?p=&APP_ID.:28:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(177082802719844403)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517472886591015296)
,p_branch_action=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(177082802719844403)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(177084702792844420)
,p_name=>'P26_RESTRICTED_SCHEMA_WARNING'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(517950234959931802)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(177095520711911576)
,p_name=>'P26_SCHEMA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(517950234959931802)
,p_display_as=>'NATIVE_HIDDEN'
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122323'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516408864658385622)
,p_plug_name=>'Request a Workspace'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516409065144385626)
,p_plug_name=>'Wizard Progress Bar'
,p_parent_plug_id=>wwv_flow_api.id(516408864658385622)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481969298650741033)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516409204387385627)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_api.id(516409065144385626)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516409441539385628)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_api.id(516408864658385622)
,p_region_css_classes=>'a-Wizard-body a-Form a-Form--large'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516411073780385633)
,p_plug_name=>'Wizard Buttons'
,p_parent_plug_id=>wwv_flow_api.id(516408864658385622)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(516411245858385636)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(516411073780385633)
,p_button_name=>'Proceed'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975658518888812)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(109157847214)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(516411073780385633)
,p_button_name=>'Back'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(516411647143385640)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(516411073780385633)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(516362650992934299)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(66702007660187721)
,p_branch_action=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(516411245858385636)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(25802015676691687)
,p_branch_action=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(109157847214)
,p_branch_sequence=>20
,p_branch_condition_type=>'EXISTS'
,p_branch_condition=>'select 1 from WWV_FLOW_PROV_SIGNUP_Q where SURVEY_ENABLED_YN = ''Y'''
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(25802200570696805)
,p_branch_action=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(109157847214)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109173847225)
,p_name=>'PROJECT_DESCRIPTION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(516409441539385628)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109175847225)
...
,p_field_template=>wwv_flow_api.id(516405744549268368)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_escape_on_http_input=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(177451430104093580)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(177458508913257768)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(109236958762)
...
,p_associated_item=>wwv_flow_api.id(109173847225)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122329'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(80230402173993477)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18108515260336521)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517967421599265744)
,p_plug_name=>'Request a Workspace'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517967654884265745)
,p_plug_name=>'Wizard Progress Bar'
,p_parent_plug_id=>wwv_flow_api.id(517967421599265744)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481969298650741033)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517967892852265745)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_api.id(517967654884265745)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517968022564265746)
,p_plug_name=>'Wizard Form'
,p_parent_plug_id=>wwv_flow_api.id(517967421599265744)
,p_region_css_classes=>'a-Wizard-body a-Form'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(80170923513990161)
,p_plug_name=>'Agreement'
,p_parent_plug_id=>wwv_flow_api.id(517968022564265746)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(81409728268284890)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(517968214545265746)
,p_plug_name=>'Wizard Buttons'
,p_parent_plug_id=>wwv_flow_api.id(517967421599265744)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(80231020051993478)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(517968214545265746)
,p_button_name=>'Proceed'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975658518888812)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(80230815227993478)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(517968214545265746)
,p_button_name=>'Back'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(80230614027993477)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(517968214545265746)
,p_button_name=>'Cancel'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(80315521913999183)
,p_branch_action=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(80231020051993478)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517475649795114509)
,p_branch_action=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(80230815227993478)
,p_branch_sequence=>30
,p_branch_condition_type=>'EXISTS'
,p_branch_condition=>'select 1 from WWV_FLOW_PROV_SIGNUP_Q where nvl(SURVEY_ENABLED_YN,''N'') = ''Y'''
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517475870611116622)
,p_branch_name=>'Go To Page 25'
,p_branch_action=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(64572937523929403)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517475139255103367)
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(80230815227993478)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(80434718366017037)
,p_name=>'P28_ACCEPT_TERMS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(81409728268284890)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Accept Terms'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(144094305310958675)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(247493906498726082)
...
,p_when_button_pressed=>wwv_flow_api.id(80231020051993478)
,p_associated_item=>wwv_flow_api.id(80434718366017037)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
end;
/
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122336'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516416294096463438)
,p_plug_name=>'Request a Workspace'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(94840826419648214)
,p_plug_name=>'Wizard Body'
,p_parent_plug_id=>wwv_flow_api.id(516416294096463438)
,p_region_css_classes=>'a-Wizard-body a-Form a-Form--large'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481965601614717220)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(26272310950341776)
,p_plug_name=>'Verification Code'
,p_parent_plug_id=>wwv_flow_api.id(94840826419648214)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516416468522463439)
,p_plug_name=>'Wizard Progress Bar'
,p_parent_plug_id=>wwv_flow_api.id(516416294096463438)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516416609246463439)
,p_plug_name=>'Wizard Progress List'
,p_parent_plug_id=>wwv_flow_api.id(516416468522463439)
,p_region_sub_css_classes=>'a-WizardSteps--displayCurrentLabelOnly'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(516418271756463442)
,p_plug_name=>'Wizard Buttons'
,p_parent_plug_id=>wwv_flow_api.id(516416294096463438)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(318141939408)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(516418271756463442)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(318938118262)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(516418271756463442)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(516418625242463444)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(516418271756463442)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(60145132142214439)
,p_branch_action=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(318141939408)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517468015163944139)
,p_branch_action=>'f?p=&APP_ID.:28:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(318938118262)
,p_branch_sequence=>15
,p_branch_condition_type=>'EXISTS'
,p_branch_condition=>'select 1 from WWV_FLOW_PROV_SIGNUP_Q where nvl(AGREEMENT_ENABLED_YN,''N'') = ''Y'''
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(388346306877278713)
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(318938118262)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517414131433361542)
,p_branch_action=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(318938118262)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(517415202755367631)
,p_branch_action=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(318938118262)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26273021255363662)
,p_name=>'P30_WORKSPACE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(94840826419648214)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26401719484160967)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26402116498169624)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26402322731171379)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26402504854175640)
,p_name=>'P30_ADMIN_EMAIL'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(94840826419648214)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Administrator Email'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26402731520183408)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26403006848195226)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26403223124199902)
,p_name=>'P30_DB_SIZE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(94840826419648214)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29906703634753342)
,p_name=>'P30_VERIFICATION_CODE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(26272310950341776)
,p_use_cache_before_default=>'NO'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'You are required to enter the verification code you see in the box.',
'Please be careful while entering the letters as they are <b>case sensitive</b>.'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29962128538283685)
...
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_when_button_pressed=>wwv_flow_api.id(318141939408)
,p_associated_item=>wwv_flow_api.id(29906703634753342)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(143943821324944409)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(247624218797767424)
,p_validation_name=>'terms accepted'
,p_validation_sequence=>30
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2184197002254427848)
,p_validation_name=>'new schema name not null'
,p_validation_sequence=>40
,p_validation=>'SCHEMA_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2184242065158429229)
,p_validation_name=>'existing schema name not null'
,p_validation_sequence=>50
,p_validation=>'EXISTING_SCHEMA_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2184242341374430656)
,p_validation_name=>'schema exists'
,p_validation_sequence=>60
,p_validation=>'wwv_flow_security.exists_db_user(upper(:EXISTING_SCHEMA_NAME))'
,p_validation_type=>'PLSQL_EXPRESSION'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2184242602392431985)
,p_validation_name=>'new schema does not exist'
,p_validation_sequence=>70
,p_validation=>'wwv_flow_security.get_db_user_or_role(upper(:SCHEMA_NAME)) is null'
,p_validation_type=>'PLSQL_EXPRESSION'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2184247877095437803)
,p_validation_name=>'no spaces in name'
,p_validation_sequence=>80
,p_validation=>'SCHEMA_NAME'
,p_validation_type=>'ITEM_CONTAINS_NO_SPACES'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2184248749119438943)
,p_validation_name=>'schema name cant contain quotes'
,p_validation_sequence=>90
,p_validation=>'instr(:SCHEMA_NAME,'''''''')+instr(:SCHEMA_NAME,''"'') = 0'
,p_validation_type=>'PLSQL_EXPRESSION'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2184249045719440018)
,p_validation_name=>'cannot be an oracle reserved word'
,p_validation_sequence=>100
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'wwv_flow_provision.schema_name_valid(',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2184249340031441378)
,p_validation_name=>'schema name is valid'
,p_validation_sequence=>110
,p_validation=>'wwv_flow_utilities.is_valid_identifier(:SCHEMA_NAME)'
,p_validation_type=>'PLSQL_EXPRESSION'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2184249626926442496)
,p_validation_name=>'new schema not used in existing workspace'
,p_validation_sequence=>120
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select null',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16952718581632268)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(318141939408)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(235706412746607558)
...
,p_step_title=>'Creating Workspace - Oracle &PRODUCT_NAME.'
,p_allow_duplicate_submissions=>'N'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
...
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180719122350'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(698805774605413350)
,p_plug_name=>'Request a Workspace'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481970015003751305)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(785007512742389611)
,p_plug_name=>'Ticker Event'
,p_parent_plug_id=>wwv_flow_api.id(698805774605413350)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481965601614717220)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(785007731946389617)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(785007904613389618)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(416033801984152703)
,p_plug_name=>'Workspace Creation Disabled'
,p_parent_plug_id=>wwv_flow_api.id(785007904613389618)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(825233966004277601)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(861065721162173096)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_api.id(698805774605413350)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(861008913543170914)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(861065721162173096)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(785009012421389623)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(416033622824152701)
,p_name=>'P73_WS_PROV_DISABLED'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(698805774605413350)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(416033983865152704)
,p_name=>'P73_STATUS_1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(416033801984152703)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'I'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(785008112786389619)
,p_name=>'P73_STATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(825233966004277601)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'I'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(785603515624489906)
,p_name=>'PROVISION_ID'
,p_item_sequence=>35
,p_item_plug_id=>wwv_flow_api.id(785007904613389618)
,p_display_as=>'NATIVE_HIDDEN'
,p_restricted_characters=>'WEB_SAFE'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2210612504487687901)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(416033728614152702)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(785008723931389621)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(517949557977923765)
);
end;
/
