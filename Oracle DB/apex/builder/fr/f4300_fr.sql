...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,4302)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A285099237201210560')
...
,p_authentication_id=>wwv_flow_api.id(539653303570634151.4302)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20180830080155'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(2202106852499122.4302)
,p_name=>'Data Workshop Home Page Icons'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(260022612007597680.4302)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>unistr('R\00E9f\00E9rentiel d''import')
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(260023118587599550.4302)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Imports de feuille de calcul'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2206807807518397.4302)
,p_list_item_display_sequence=>80
,p_list_item_link_text=>unistr('R\00E9f\00E9rentiel')
,p_list_item_link_target=>'f?p=&APP_ID.:8:&SESSION.::&DEBUG.:RP:::'
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3648913903408259.4302)
,p_name=>'data import'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3653931134432189.4302)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>unistr('R\00E9f\00E9rentiel d''import de donn\00E9es textuelles')
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(220739912737841935.4302)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>unistr('R\00E9f\00E9rentiel d''import de feuilles de calcul')
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3931814922814551.4302)
,p_name=>'Plain Text Data Import'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3932708473822070.4302)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('D\00E9tails de fichier')
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3933320594825587.4302)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>unistr('Propri\00E9t\00E9s de table')
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'18,19,21'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3933729944828323.4302)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>unistr('Cl\00E9 primaire')
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'18,19,21'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(3934205141830584.4302)
,p_name=>'Plain Text Data Import2'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3935014837833421.4302)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('Nom et propri\00E9taire de table')
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'22'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3935628343837346.4302)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>unistr('D\00E9tails de fichier')
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(3935901116838942.4302)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Mapping de colonne'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(74707671328250039.4302)
,p_name=>'Data Loading'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2638109323313851.4302)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>unistr('Donn\00E9es textuelles')
,p_list_item_link_target=>'f?p=&APP_ID.:230:&SESSION.::&DEBUG.:18,19,21,22,24,25:F4300_P230_LOAD_FROM:UPLOAD:'
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>unistr('Chargez des donn\00E9es \00E0 partir de fichiers plats structur\00E9s, tels que des fichiers contenant des donn\00E9es s\00E9par\00E9es par des virgules (csv) ou des donn\00E9es s\00E9par\00E9es par des tabulations.')
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(74710220544263433.4302)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('Donn\00E9es XML')
,p_list_item_link_target=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:14:::'
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>unistr('Chargez des donn\00E9es \00E0 partir de XML au format canonique.')
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(171168300110560910.4302)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>unistr('Donn\00E9es de feuille de calcul')
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(75585889878824332.4302)
,p_name=>'Data Unloading'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(75614520977877818.4302)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('vers donn\00E9es textuelles')
,p_list_item_link_target=>'f?p=&APP_ID.:150:&SESSION.::&DEBUG.:150,180:::'
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>unistr('Exportez les donn\00E9es de la base de donn\00E9es vers un fichier plat.')
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(75616418561883144.4302)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>unistr('vers donn\00E9es XML')
,p_list_item_link_target=>'f?p=&APP_ID.:90:&SESSION.::&DEBUG.:90:::'
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>unistr('Exportez les donn\00E9es de la base de donn\00E9es vers un document XML.')
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
end;
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(104358211508848205.4302)
,p_name=>'Plain Text Data Export'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(104369115334180721.4302)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(104371204982185568.4302)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(112716503290208213.4302)
,p_name=>'Excel Data Import'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204680314570920715.4302)
,p_list_item_display_sequence=>5
,p_list_item_link_text=>unistr('Cible et m\00E9thode')
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'230'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(112719626353212694.4302)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>unistr('Donn\00E9es')
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(112720322256214662.4302)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('Propri\00E9t\00E9s de table')
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'200,210,220,230'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(117063907614069206.4302)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>unistr('Cl\00E9 primaire')
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'200,210,220,230'
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(204693724897946351.4302)
,p_name=>'Excel Data Import2'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204695520153948493.4302)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>unistr('Type et m\00E9thode')
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'230'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204698011742952420.4302)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('Nom et propri\00E9taire de table')
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204702125748961090.4302)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>unistr('Donn\00E9es')
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'240,260,270'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(204711009357968724.4302)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Mapping de colonne'
,p_list_item_disp_cond_type=>'CURRENT_PAGE_IN_CONDITION'
,p_list_item_disp_condition=>'240,260,270'
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(697382068928001818.4302)
,p_name=>'APEX 5 - Administration (Header)'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697382206098001819.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697382502013001824.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697382891464001824.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697383150352001827.4302)
,p_list_item_display_sequence=>210
,p_list_item_link_text=>unistr('G\00E9rer le service')
,p_list_item_link_target=>'f?p=4350:21:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(697382891464001824.4302)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697383440829001827.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697383714500001828.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697384038930001828.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697384322750001828.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697384679765001828.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697384955467001832.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697385224525001832.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697385572574001832.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(1250636556640192780.4302)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(697413399059052182.4302)
,p_name=>'APEX 5 - Help'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697413586319052182.4302)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2105952923293025164.4302)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2185440800402478745.4302)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697414494575052183.4302)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'---'
,p_list_item_link_target=>'separator'
,p_list_item_current_type=>'TARGET_PAGE'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(697414778925052183.4302)
,p_list_item_display_sequence=>50
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(718988657702143721.4302)
,p_name=>'APEX 5 - Tabs'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718988842906143722.4302)
,p_list_item_display_sequence=>100
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718989111037143726.4302)
...
,p_parent_list_item_id=>wwv_flow_api.id(718988842906143722.4302)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718989405911143726.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718989747866143727.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718990080119143727.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718990361569143729.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718990613085143729.4302)
,p_list_item_display_sequence=>150
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718990955731143729.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718991291702143729.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718991584443143730.4302)
...
,p_parent_list_item_id=>wwv_flow_api.id(718991291702143729.4302)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718991801399143730.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718992140150143730.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718992741957143730.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718993081390143731.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718993347641143731.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718993626969143731.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718993986713143731.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718994253577143731.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718994566071143731.4302)
,p_list_item_display_sequence=>200
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718994850225143732.4302)
,p_list_item_display_sequence=>210
,p_list_item_link_text=>'Navigateur d''objet'
,p_list_item_link_target=>'f?p=4500:1001:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(718994566071143731.4302)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718995124049143732.4302)
,p_list_item_display_sequence=>220
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718995499947143732.4302)
,p_list_item_display_sequence=>230
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718995706005143732.4302)
,p_list_item_display_sequence=>240
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718996015547143732.4302)
,p_list_item_display_sequence=>241
,p_list_item_link_text=>'Tous les utilitaires'
,p_list_item_link_target=>'f?p=4500:1005:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(718995706005143732.4302)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718996329468143733.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718996661572143733.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718996948262143733.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(31857489782444317.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(670885068143927641.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718997212313143733.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718997530238143733.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718999007388143734.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(670884758845925653.4302)
,p_list_item_display_sequence=>250
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718999349755143734.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718998433413143734.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718998124709143734.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718998775140143734.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718999661410143734.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718999920942143734.4302)
,p_list_item_display_sequence=>300
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719000200495143734.4302)
,p_list_item_display_sequence=>310
,p_list_item_link_text=>'Jalons'
,p_list_item_link_target=>'f?p=4800:6006:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(718999920942143734.4302)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719000507420143734.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719000816388143735.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719001169653143735.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719001409743143735.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719001716284143735.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719002021894143735.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719002368925143735.4302)
,p_list_item_display_sequence=>361
,p_list_item_link_text=>'Tous les utilitaires'
,p_list_item_link_target=>'f?p=4800:2:&SESSION.:'
,p_parent_list_item_id=>wwv_flow_api.id(719002021894143735.4302)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719002662619143736.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719002979626143737.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719003213232143737.4302)
,p_list_item_display_sequence=>364
,p_list_item_link_text=>unistr('R\00E9capitulatif des versions')
,p_list_item_link_target=>'f?p=4800:4050:&SESSION.:'
,p_parent_list_item_id=>wwv_flow_api.id(719002021894143735.4302)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719003537077143737.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719003866862143737.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719004113111143737.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719004487421143737.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719004793890143738.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719005043331143738.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719005393350143738.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719005649685143739.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719005956050143739.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719006217814143739.4302)
,p_list_item_display_sequence=>400
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719006508197143740.4302)
...
,p_parent_list_item_id=>wwv_flow_api.id(719006217814143739.4302)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719006810190143740.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(780156297074326443.4302)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719007190968143740.4302)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1930451852408035.4302)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14848517159940928.4302)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(91973940177572341.4302)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1082459947139623110.4302)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1765072320094712054.4302)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1831722549104993877.4302)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1917670476828940076.4302)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(10763432184894214.4302)
...
,p_reference_id=>786936829326142579.4302
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(10766802982027753.4302)
,p_name=>'Flow: EDIT'
...
,p_reference_id=>12480509677812756.4302
,p_caching=>'BY_USER_BY_SESSION'
);
end;
/
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(10767409693039076.4302)
...
,p_reference_id=>786516861027697723.4302
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(10770526811204883.4302)
...
,p_reference_id=>786519856057734816.4302
,p_caching=>'BY_USER_BY_SESSION'
);
end;
/
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(12527124696576833.4302)
...
,p_reference_id=>786941042784190072.4302
,p_caching=>'BY_USER_BY_SESSION'
);
end;
/
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(517058043352714021.4302)
...
,p_reference_id=>6738410669854771.4302
,p_caching=>'BY_USER_BY_SESSION'
);
end;
/
...
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(786533090058102287.4302)
,p_name=>'APEX 5.0 App Builder Enabled'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'EDIT'
,p_error_message=>unistr('Vous n''\00EAtes pas autoris\00E9 \00E0 effectuer cette op\00E9ration')
,p_reference_id=>786516029127697713.4302
,p_caching=>'BY_USER_BY_SESSION'
);
end;
/
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(1364313342198532.4302)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(39955524108615064.4302)
,p_icon_sequence=>20
...
wwv_flow_api.create_flow_process(
 p_id=>wwv_flow_api.id(49906314503034042.4302)
...
begin
wwv_flow_api.create_flow_process(
 p_id=>wwv_flow_api.id(234080556000997661.4302)
,p_process_sequence=>1
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(5126097226.4302)
,p_name=>'COMPANY'
,p_scope=>'GLOBAL'
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(25339931440732484.4302)
,p_name=>'F4300_IMEX_BATCH_ID'
,p_data_type=>'NUMBER'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(48603115971458169.4302)
,p_name=>'F4300_LAST_VIEW'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(242549145362.4302)
,p_name=>'F4300_LOAD_JOB'
,p_data_type=>'NUMBER'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(147029609296398557.4302)
,p_name=>'FSP_AFTER_LOGIN_URL'
,p_item_comment=>'Used by Custom2 authentication for deep linking support'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(63051450385643584.4302)
,p_name=>'G_USER_DEFAULT_DATE_FORMAT'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(48610196642071039.4302)
,p_name=>'LAST_VIEW'
);
end;
/
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(5128100953.4302)
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(63051862410648965.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87923517360560740.4302)
,p_lov_name=>'CASE.SENSITIVE.Y'
,p_lov_query=>'.'||wwv_flow_api.id(87923517360560740)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87923721904560740.4302)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Distinction maj/min'
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(23546816846659473.4302)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87944005995777613.4302)
,p_lov_name=>'EXPORT.AS.FILE.Y'
,p_lov_query=>'.'||wwv_flow_api.id(87944005995777613)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87944229029777613.4302)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Exporter en tant que fichier'
,p_lov_return_value=>'Y'
);
end;
/
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(143183002952786622.4302)
,p_lov_name=>'EXPORT.FILE_FORMAT'
,p_lov_query=>'.'||wwv_flow_api.id(143183002952786622)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(143183319798786629.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'UNIX'
,p_lov_return_value=>'UNIX'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(143183511674786632.4302)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(135399325911344822.4302)
,p_lov_name=>'I18N_IANA_CHARSET'
,p_reference_id=>144796827445692396.4302
,p_lov_query=>'.'||wwv_flow_api.id(135399325911344822)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9210119015925448.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Arabe - ISO-8859-6'
,p_lov_return_value=>'iso-8859-6'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9210315200925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Arabe - Windows 1256'
,p_lov_return_value=>'windows-1256'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9210506914925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Chinois - Big5'
,p_lov_return_value=>'big5'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9210710375925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Chinois - GBK'
,p_lov_return_value=>'gbk'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9210911324925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Cyrillique - ISO-8859-5'
,p_lov_return_value=>'iso-8859-5'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9211132764925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Cyrillique - KOI8-R'
,p_lov_return_value=>'koi8-r'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9211319597925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Cyrillique - KOI8-U'
,p_lov_return_value=>'koi8-u'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9211519694925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Cyrillique - Windows 1251'
,p_lov_return_value=>'windows-1251'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9211710593925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Europe de l''Est - ISO-8859-2'
,p_lov_return_value=>'iso-8859-2'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9211916251925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Europe de l''Est - Windows 1250'
,p_lov_return_value=>'windows-1250'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9212127400925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Grec - ISO-8859-7'
,p_lov_return_value=>'iso-8859-7'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9212326492925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Grec - Windows 1253'
,p_lov_return_value=>'windows-1253'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9212524385925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>unistr('H\00E9breu - ISO-8859-8-i')
,p_lov_return_value=>'iso-8859-8-i'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9212723211925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>unistr('H\00E9breu - Windows 1255')
,p_lov_return_value=>'windows-1255'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9212909639925449.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Japonais - EUC'
,p_lov_return_value=>'euc-jp'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9213115890925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Japonais - Shift JIS'
,p_lov_return_value=>'shift_jis'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9213332197925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>unistr('Cor\00E9en - EUC')
,p_lov_return_value=>'euc-kr'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9213521447925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Europe du Nord - ISO-8859-4'
,p_lov_return_value=>'iso-8859-4'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9213724764925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Europe du Nord - Windows 1257'
,p_lov_return_value=>'windows-1257'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9213919798925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Europe du Sud - ISO-8859-3'
,p_lov_return_value=>'iso-8859-3'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9214102242925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>unistr('Tha\00EF - TIS-620')
,p_lov_return_value=>'tis-620'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9214302164925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Turc - ISO-8859-9'
,p_lov_return_value=>'iso-8859-9'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9214532482925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Turc - Windows 1254'
,p_lov_return_value=>'windows-1254'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9214722219925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Unicode - UTF-8'
,p_lov_return_value=>'utf-8'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9214919398925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Unicode - UTF-16 Big Endian'
,p_lov_return_value=>'utf-16be'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9215121243925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Unicode - UTF-16 Little Endian'
,p_lov_return_value=>'utf-16le'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9215302670925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'US-ASCII'
,p_lov_return_value=>'us-ascii'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9215523599925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Vietnamien - Windows 1258'
,p_lov_return_value=>'windows-1258'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9215727684925450.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Europe de l''Ouest - ISO-8859-1'
,p_lov_return_value=>'iso-8859-1'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9215928361925451.4302)
,p_lov_disp_sequence=>1
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87945815476789819.4302)
,p_lov_name=>'INCLUDE.COL.NAMES.Y'
,p_lov_query=>'.'||wwv_flow_api.id(87945815476789819)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87946002718789820.4302)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Inclure les noms de colonne'
,p_lov_return_value=>'Y'
);
end;
/
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87953325959849588.4302)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(182776719411.4302)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87921416882551159.4302)
,p_lov_name=>'LOAD.OPTION'
,p_lov_query=>'.'||wwv_flow_api.id(87921416882551159)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87921609839551159.4302)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>unistr('T\00E9l\00E9charger un fichier (d\00E9limitation par des virgules ou des tabulations)')
,p_lov_return_value=>'UPLOAD'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87921801389551160.4302)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'Copier/coller'
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(162716910286446218.4302)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(236956028332134846.4302)
,p_lov_name=>'P2_LOAD'
,p_lov_query=>'.'||wwv_flow_api.id(236956028332134846)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(236956315568134853.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Mon import'
,p_lov_return_value=>'MY'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(236956532195134859.4302)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Tous les imports'
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(29232624018252340.4302)
,p_lov_name=>'PK_TYPES'
,p_reference_id=>20561306137429854.4302
,p_lov_query=>'.'||wwv_flow_api.id(29232624018252340)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(51627621271152564.4302)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>unistr('G\00E9n\00E9r\00E9 \00E0 partir d''une nouvelle s\00E9quence')
,p_lov_return_value=>'NEW_SEQUENCE'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(51627831065152564.4302)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>unistr('G\00E9n\00E9r\00E9 \00E0 partir d''une s\00E9quence existante')
,p_lov_return_value=>'EXISTING_SEQUENCE'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(51628012394152565.4302)
,p_lov_disp_sequence=>5
,p_lov_disp_value=>unistr('Non g\00E9n\00E9r\00E9')
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87931511182663028.4302)
,p_lov_name=>'PRESERVE.CASE.Y'
,p_lov_query=>'.'||wwv_flow_api.id(87931511182663028)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87931730659663028.4302)
,p_lov_disp_sequence=>10
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87918702852509211.4302)
,p_lov_name=>'RESTRICT.LOAD.FILES'
,p_lov_query=>'.'||wwv_flow_api.id(87918702852509211)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87918901897509212.4302)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Mes fichiers d''import'
,p_lov_return_value=>'MY'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87919109206509212.4302)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'Tous les fichiers d''import'
,p_lov_return_value=>'ALL'
);
end;
/
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87922429003554589.4302)
,p_lov_name=>'TABLE.OPTION'
,p_lov_query=>'.'||wwv_flow_api.id(87922429003554589)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87922602291554590.4302)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Table existante'
,p_lov_return_value=>'EXIST'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87922820756554590.4302)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'Nouvelle table'
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87933423434676001.4302)
,p_lov_name=>'USE.EXISTING.COL'
,p_lov_query=>'.'||wwv_flow_api.id(87933423434676001)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87933602623676001.4302)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Utiliser une colonne existante'
,p_lov_return_value=>'EXISTING_KEY'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87933822194676002.4302)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>unistr('Cr\00E9er une nouvelle colonne')
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(87930425596657700.4302)
,p_lov_name=>'YES.NO.RETURNS_Y_OR_N'
,p_lov_query=>'.'||wwv_flow_api.id(87930425596657700)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87930802381657701.4302)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Oui'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87930609321657701.4302)
,p_lov_disp_sequence=>20
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(182782926995.4302)
,p_lov_name=>'YES_NO'
,p_lov_query=>'.'||wwv_flow_api.id(182782926995)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(182785927024.4302)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Oui'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(182787927024.4302)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Non'
,p_lov_return_value=>'N'
);
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(6678815232629976.4302)
,p_name=>'dataworkshop.menu'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2211613627528920.4302)
,p_parent_id=>wwv_flow_api.id(174561719510562263.4302)
,p_short_name=>unistr('Atelier de donn\00E9es')
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6682115379645994.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
,p_link=>'f?p=&APP_ID.:230:&SESSION.::&DEBUG.:::'
,p_page_id=>230
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6686911916662790.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es XML')
,p_link=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:::'
,p_page_id=>14
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6690530882669221.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6692619668674394.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6694113198677405.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6695107375680103.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6828030820688031.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6829415292695176.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6830608822698182.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6837120647738320.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('R\00E9f\00E9rentiel de chargement de donn\00E9es textuelles')
,p_link=>'f?p=&APP_ID.:8:&SESSION.::&DEBUG.:::'
,p_page_id=>8
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6844627307765634.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6848706388775367.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('D\00E9charger au format texte')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(7700814894541393.4302)
,p_parent_id=>wwv_flow_api.id(.4302)
,p_short_name=>'Page d''accueil'
,p_link=>'f?p=4500:1000:&SESSION.'
,p_page_id=>99999
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(9390600588273869.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('R\00E9f\00E9rentiel de feuilles de calcul')
,p_link=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:::'
,p_page_id=>11
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23356717195631333.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23359105981636561.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23360528181641436.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23362831810685340.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23364720380690653.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23366014557693362.4302)
,p_parent_id=>wwv_flow_api.id(2211613627528920.4302)
,p_short_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(28488306101493931.4302)
,p_parent_id=>wwv_flow_api.id(.4302)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(75399131516711549.4302)
,p_parent_id=>wwv_flow_api.id(6837120647738320.4302)
,p_short_name=>unistr('D\00E9tails de chargement de donn\00E9es textuelles')
,p_link=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.:::'
,p_page_id=>7
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(164746407711995921.4302)
,p_parent_id=>wwv_flow_api.id(174561719510562263.4302)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(165246328822963208.4302)
,p_parent_id=>wwv_flow_api.id(164746407711995921.4302)
,p_short_name=>unistr('Charger l''ensemble de donn\00E9es \00E9chantillon - R\00E9sultats')
,p_link=>'f?p=&APP_ID.:130:&SESSION.::&DEBUG.:::'
,p_page_id=>130
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(165255972610970183.4302)
,p_parent_id=>wwv_flow_api.id(164746407711995921.4302)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(165268766487976362.4302)
,p_parent_id=>wwv_flow_api.id(164746407711995921.4302)
,p_short_name=>unistr('G\00E9rer l''ensemble de donn\00E9es \00E9chantillon')
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(174561719510562263.4302)
,p_parent_id=>wwv_flow_api.id(28488306101493931.4302)
,p_short_name=>'Utilitaires'
,p_link=>'f?p=4500:1005:&SESSION.'
,p_page_id=>8888
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(236917018865057364.4302)
,p_parent_id=>wwv_flow_api.id(9390600588273869.4302)
,p_short_name=>unistr('D\00E9tails de chargement de feuilles de calcul')
,p_link=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.:::'
,p_page_id=>2
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(388323657510153942.4302)
,p_parent_id=>wwv_flow_api.id(.4302)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9113661096283.4302)
,p_theme_id=>3
...
,p_reference_id=>80874804748045950.4302
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(3485606247566446.4302)
,p_theme_id=>3
,p_name=>'Green Look (Left And Right SideBars) From 4999.fr'
...
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>18525205721780073.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7505408382227958.4302)
,p_theme_id=>3
,p_name=>'Green Look (Right SideBar) From 4999.fr'
...
,p_grid_emit_empty_trail_cols=>false
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>18525411970780075.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(208580315559534207.4302)
,p_theme_id=>3
,p_name=>'APEX 4.2 - Wizard .fr'
...
,p_grid_emit_empty_trail_cols=>false
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>42231511193339128.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(471759212441917909.4302)
,p_theme_id=>3
,p_name=>'APEX 4.2 - No SideBar.fr'
...
,p_grid_emit_empty_trail_cols=>false
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>187453329378870285.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716604580917788355.4302)
,p_theme_id=>3
...
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>120828417372192930.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716604939833788366.4302)
,p_theme_id=>3
...
,p_dialog_js_cancel_code=>'apex.navigation.dialog.cancel(#IS_MODAL#);'
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>689595297061847770.4302
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159369298995512189.4302)
,p_page_template_id=>wwv_flow_api.id(716604939833788366.4302)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159369780341512189.4302)
,p_page_template_id=>wwv_flow_api.id(716604939833788366.4302)
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716607252394788370.4302)
,p_theme_id=>3
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>637437892049443496.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716607780903788372.4302)
,p_theme_id=>3
...
,p_dialog_js_cancel_code=>'apex.navigation.dialog.cancel(#IS_MODAL#);'
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>386895861966224222.4302
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159361976488512183.4302)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4302)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159362487492512183.4302)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4302)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159362919641512183.4302)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4302)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159363478975512184.4302)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4302)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159363931520512184.4302)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4302)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159364483913512184.4302)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4302)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(159364908413512185.4302)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4302)
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716609164058788372.4302)
,p_theme_id=>3
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>702692008314080052.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716609648731788373.4302)
,p_theme_id=>3
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>702684260095026477.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(716613771837788376.4302)
,p_theme_id=>3
...
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>689061037088924910.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1184364303968453797.4302)
,p_theme_id=>3
,p_name=>'APEX 4.1 - Optional Right Sidebar (Table).fr'
...
,p_grid_emit_empty_trail_cols=>false
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>450655205700156564.4302
,p_translate_this_template=>'N'
);
end;
/
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(388298521291079233.4302)
...
,p_reference_id=>3705338883615.4302
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_theme_id=>3
);
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(388298732478079235.4302)
...
,p_reference_id=>353820721334283301.4302
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_theme_id=>3
);
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(716616681872794730.4302)
,p_template_name=>'APEX 5.0 - Button'
,p_internal_name=>'APEX_5.0_BUTTON'
,p_template=>'<button onclick="#JAVASCRIPT#" class="a-Button #BUTTON_CSS_CLASSES#" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">#LABEL!HTML#</button>'
,p_hot_template=>'<button onclick="#JAVASCRIPT#" class="a-Button a-Button--hot #BUTTON_CSS_CLASSES#" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">#LABEL!HTML#</button>'
,p_reference_id=>174750904387485475.4302
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_theme_id=>3
);
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(716617173062794734.4302)
...
,p_reference_id=>631020282344854024.4302
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_theme_id=>3
);
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(716617477116794735.4302)
...
,p_reference_id=>631020159860848910.4302
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_theme_id=>3
);
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9113673096289.4302)
,p_layout=>'TABLE'
...
,p_reference_id=>17353903289599940.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(101735615849237059.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_reference_id=>17354512447599941.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(104263607591363808.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_field_alignment=>'LEFT'
,p_form_table_attr=>' '
,p_reference_id=>17355419405599943.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170264105041113342.4302)
,p_layout=>'TABLE'
...
,p_default_field_alignment=>'LEFT'
,p_form_table_attr=>'class="htmldbInstruct"'
,p_reference_id=>35964702876463547.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170268110269113348.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_field_alignment=>'LEFT'
,p_form_table_attr=>'class="htmldbInstruct"'
,p_reference_id=>32612420016685806.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170269127235113349.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aRegion sideRegion #REGION_CSS_CLASSES#" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="aRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170270131526113350.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>17357218626599946.4302
,p_translate_this_template=>'N'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(208585513765537107.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>42209615589242480.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(208585923103537108.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>42209811475242480.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(208586424307537108.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aWizardRegion dividerTop" #REGION_ATTRIBUTES# id="#REGION_STATIC_ID#">',
'  <div class="wizardRegionHeading">',
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>42210116661242480.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(208586913756537109.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>42210411889242480.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(279748823389483962.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>236935712467247464.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(388246039131933975.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>174748721787471587.4302
,p_translate_this_template=>'N'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(388246630957934005.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="a-Region #REGION_CSS_CLASSES#" #REGION_ATTRIBUTES# id="#REGION_STATIC_ID#">',
'  <div class="a-Region-header">',
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>174747104640428780.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(388251521427936641.4302)
,p_layout=>'TABLE'
...
,p_default_field_alignment=>'LEFT'
,p_form_table_attr=>'class="htmldbInstruct"'
,p_reference_id=>716895227337398760.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716642617570817147.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>174746301430371105.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716643236475817156.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>687153470345619376.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716648790045817165.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>689955986849128825.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716658831322817171.4302)
,p_layout=>'TABLE'
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>678354360586321695.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716660784129817173.4302)
,p_layout=>'TABLE'
...
,p_default_field_alignment=>'LEFT'
,p_form_table_attr=>' '
,p_reference_id=>17354206769599941.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716661407318817173.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>174613223222362440.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716662167050817173.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>174630015632506596.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716662948592817174.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>698829239393878937.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716673270402817181.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>183211208341566300.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716673932750817181.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>174613705533399534.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716674688097817182.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>174628415239478085.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716675364323817183.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>174629130392501406.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716676055535817183.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aWizardRegion" #REGION_ATTRIBUTES# id="#REGION_STATIC_ID#">',
'  <div class="wizardRegionHeading">',
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>399850559367741099.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716676747173817184.4302)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>702777601713950915.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(716677498440817185.4302)
,p_layout=>'TABLE'
...
,p_default_field_alignment=>'LEFT'
,p_form_table_attr=>'class="htmldbInstruct"'
,p_reference_id=>703469000349150769.4302
,p_translate_this_template=>'N'
);
end;
/
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(3482816826549973.4302)
...
||'</li>'
,p_reference_id=>60219508156141083.4302
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(119835024987557728.4302)
...
,p_reference_id=>17385324891888482.4302
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(170283117853932398.4302)
...
,p_list_template_after_rows=>'</ul>'
,p_reference_id=>32421627622986728.4302
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(187647214478984350.4302)
...
||'li>'
,p_reference_id=>9651611091899590.4302
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(208592324393539718.4302)
...
'</ul>',
'</div>'))
,p_reference_id=>42216127932260877.4302
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(388254947243942451.4302)
...
'<li data-id="#A01#" data-disabled="#A02#" data-hide="#A03#" data-shortcut="#A05#" data-icon="#IMAGE#"><a href="#LINK#" title="#A04#">#TEXT_ESC_SC#</a>',
''))
,p_reference_id=>573607518145151423.4302
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(388255255364942452.4302)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li data-id="#A01#" data-disabled="#A02#" data-hide="#A03#" data-shortcut="#A05#" data-icon="#IMAGE#"><a href="#LINK#" title="#A04#">#TEXT_ESC_SC#</a></li>',
''))
,p_list_template_noncurrent=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_reference_id=>747588010155545129.4302
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716622637646805405.4302)
...
,p_list_template_after_rows=>'</ul>'
,p_reference_id=>481290423891543508.4302
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716623225818805411.4302)
,p_list_template_current=>'<li class="a-LinksList-item is-current #A03#"><a href="#LINK#" class="a-LinksList-link" #A02#><span class="a-LinksList-icon"><span class="t-Icon #IMAGE#"></span></span><span class="a-LinksList-label">#TEXT#</span><span class="a-LinksList-badge">#A01#'
||'</span></a></li>'
,p_list_template_noncurrent=>'<li class="a-LinksList-item #A03#"><a href="#LINK#" class="a-LinksList-link" #A02#><span class="a-LinksList-icon"><span class="t-Icon #IMAGE#"></span></span><span class="a-LinksList-label">#TEXT#</span><span class="a-LinksList-badge">#A01#</span></a>'
||'</li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716627442136805429.4302)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_list_template_after_rows=>'</ul>'
,p_reference_id=>692720897220784060.4302
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716634611298805444.4302)
...
,p_list_template_after_rows=>'</ul></div>'
,p_reference_id=>168708522102193705.4302
,p_list_template_comment=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(716635374633805444.4302)
...
,p_list_template_after_rows=>'</ul>'
,p_reference_id=>687902065557685310.4302
);
end;
/
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10583525904875984.4302)
...
,p_theme_id=>3
,p_theme_class_id=>7
,p_reference_id=>6574616710304003.4302
,p_translate_this_template=>'N'
);
begin
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24534016112516813.4302)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(716680169562820879.4302)
...
,p_reference_id=>488487951233692049.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(716689315506820891.4302)
...
,p_theme_id=>3
,p_theme_class_id=>6
,p_reference_id=>689060248369886348.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(716690084418820892.4302)
...
,p_reference_id=>17383712077884846.4302
,p_translate_this_template=>'N'
);
begin
wwv_flow_api.create_row_template_patch(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(716692596502820893.4302)
...
,p_theme_id=>3
,p_theme_class_id=>7
,p_reference_id=>123725814882271159.4302
,p_translate_this_template=>'N'
);
begin
wwv_flow_api.create_row_template_patch(
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(103909823939152778.4302)
...
,p_theme_id=>3
,p_theme_class_id=>1
,p_reference_id=>17388415351892041.4302
,p_translate_this_template=>'N'
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(103910729134154335.4302)
...
,p_theme_id=>3
,p_theme_class_id=>2
,p_reference_id=>17388508175892042.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716619724928799710.4302)
...
,p_theme_id=>3
,p_theme_class_id=>1
,p_reference_id=>692681574974429799.4302
,p_translate_this_template=>'N'
,p_template_comment=>'<label for="#CURRENT_ITEM_NAME#"><a class="htmldbLabelOptional" href="javascript:popupFieldHelp(''#CURRENT_ITEM_ID#'',''&SESSION.'',''&CLOSE.'')" tabindex="999">'
);
end;
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716619812724799715.4302)
...
,p_theme_id=>3
,p_theme_class_id=>4
,p_reference_id=>687907221148719616.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716619902812799716.4302)
...
,p_theme_id=>3
,p_theme_class_id=>4
,p_reference_id=>487444299516703815.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716620098616799716.4302)
...
,p_theme_id=>3
,p_theme_class_id=>4
,p_reference_id=>492676964457041934.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716620116614799716.4302)
...
,p_theme_id=>3
,p_theme_class_id=>4
,p_reference_id=>487443659585685414.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(716620262276799717.4302)
...
,p_theme_id=>3
,p_theme_class_id=>4
,p_reference_id=>492677038682043223.4302
,p_translate_this_template=>'N'
);
end;
/
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(6680621597641306.4302)
,p_name=>'breadcrumbs'
...
,p_theme_id=>3
,p_theme_class_id=>1
,p_reference_id=>60115300853820165.4302
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(388324150680174551.4302)
...
,p_theme_id=>3
,p_theme_class_id=>1
,p_reference_id=>689285808648404711.4302
,p_translate_this_template=>'N'
);
end;
/
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(14450905155573152.4302)
,p_page_name=>'winlov'
...
,p_theme_id=>3
,p_theme_class_id=>1
,p_reference_id=>17343114994581872.4302
,p_translate_this_template=>'N'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(204023628129766298.4302)
,p_theme_id=>3
,p_name=>'Standard'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(689614385032993955.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(689615352683993957.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(689616067927993957.4302)
,p_theme_id=>3
,p_name=>'REGION_STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(689617971149993958.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(697050181422402965.4302)
,p_theme_id=>3
,p_name=>'REGION_TITLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(697237270343708853.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716627933163805437.4302)
,p_theme_id=>3
,p_name=>'LAYOUT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716651026369817167.4302)
,p_theme_id=>3
,p_name=>'DISPLAY'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716680568033820885.4302)
,p_theme_id=>3
,p_name=>'BADGE_LAYOUT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716683010367820887.4302)
,p_theme_id=>3
,p_name=>'BADGE_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716693030768820894.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716693772056820894.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716694490428820895.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(716695780930820895.4302)
,p_theme_id=>3
,p_name=>'REPORT_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746384980429369270.4302)
,p_theme_id=>3
,p_name=>'HEIGHT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746386277848369272.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746386590179369273.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746386837091369273.4302)
,p_theme_id=>3
,p_name=>'BUTTON_SET'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746387914400369273.4302)
,p_theme_id=>3
,p_name=>'LABEL_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746388241346369273.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746388584487369274.4302)
,p_theme_id=>3
,p_name=>'BUTTON_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746388817603369274.4302)
,p_theme_id=>3
,p_name=>'SPACING_LEFT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746389125810369274.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746389680630369274.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746389981180369274.4302)
,p_theme_id=>3
,p_name=>'BUTTON_TYPE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716631528909805442.4302)
,p_theme_id=>3
,p_name=>'2COLUMNGRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(716627442136805429.4302)
,p_css_classes=>'a-MediaList--cols a-MediaList--2cols'
,p_group_id=>wwv_flow_api.id(716627933163805437)
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716631802430805442.4302)
,p_theme_id=>3
,p_name=>'3COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716632125006805443.4302)
,p_theme_id=>3
,p_name=>'4COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716632489831805443.4302)
,p_theme_id=>3
,p_name=>'5COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716632734421805443.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716633065178805443.4302)
,p_theme_id=>3
,p_name=>'HIDEBADGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716633316484805443.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716633627405805444.4302)
,p_theme_id=>3
,p_name=>'HIDETITLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716633983927805444.4302)
,p_theme_id=>3
,p_name=>'HIDEICONS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716634227760805444.4302)
,p_theme_id=>3
,p_name=>'SLIMLIST'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716646319427817163.4302)
,p_theme_id=>3
,p_name=>'REGIONCONTAINSITEMSTEXT'
,p_display_name=>'Region Contains Items / Text'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716646619661817164.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716646910119817164.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716647269701817164.4302)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716647553597817164.4302)
,p_theme_id=>3
,p_name=>'NOPADDING'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716647865815817165.4302)
,p_theme_id=>3
,p_name=>'WIZARDDIALOG'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716648106429817165.4302)
,p_theme_id=>3
,p_name=>'VISIBLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716648424698817165.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716685439520820889.4302)
,p_theme_id=>3
,p_name=>'FLOATITEMS'
,p_display_name=>'Float Items'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(716680169562820879.4302)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716685743417820889.4302)
,p_theme_id=>3
,p_name=>'FIXED'
,p_display_name=>'Span Horizontally'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716686060431820889.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716686384136820889.4302)
,p_theme_id=>3
,p_name=>'SMALL'
,p_display_name=>'32px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716686665684820889.4302)
,p_theme_id=>3
,p_name=>'MEDIUM'
,p_display_name=>'48px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716686908265820889.4302)
,p_theme_id=>3
,p_name=>'LARGE'
,p_display_name=>'64px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716687260952820889.4302)
,p_theme_id=>3
,p_name=>'XLARGE'
,p_display_name=>'96px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716687559988820890.4302)
,p_theme_id=>3
,p_name=>'XXLARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716687806578820890.4302)
,p_theme_id=>3
,p_name=>'2COLUMNNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716688135348820890.4302)
,p_theme_id=>3
,p_name=>'3COLUMNGRID'
,p_display_name=>'3 Column Grid'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716688413599820890.4302)
,p_theme_id=>3
,p_name=>'4COLUMNGRID'
,p_display_name=>'4 Column Grid'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716688770385820890.4302)
,p_theme_id=>3
,p_name=>'5COLUMNGRID'
,p_display_name=>'5 Column Grid'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(716689011646820890.4302)
,p_theme_id=>3
,p_name=>'FLEXIBLEBOX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385021702369271.4302)
,p_theme_id=>3
,p_name=>'180PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385273484369271.4302)
,p_theme_id=>3
,p_name=>'240PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385423121369271.4302)
,p_theme_id=>3
,p_name=>'320PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385659686369271.4302)
,p_theme_id=>3
,p_name=>'480PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746385813465369271.4302)
,p_theme_id=>3
,p_name=>'540PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746386068179369271.4302)
,p_theme_id=>3
,p_name=>'640PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746386322011369272.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746386638275369273.4302)
,p_theme_id=>3
,p_name=>'AUTOWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746386963177369273.4302)
,p_theme_id=>3
,p_name=>'FIRSTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746387177619369273.4302)
,p_theme_id=>3
,p_name=>'FIXEDLARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746387398521369273.4302)
,p_theme_id=>3
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746387523132369273.4302)
,p_theme_id=>3
,p_name=>'FIXEDWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746387785673369273.4302)
,p_theme_id=>3
,p_name=>'INNERBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746388036191369273.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746388367616369273.4302)
,p_theme_id=>3
,p_name=>'LABELSABOVE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746388624176369274.4302)
,p_theme_id=>3
,p_name=>'LARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746388983120369274.4302)
,p_theme_id=>3
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746389216430369274.4302)
,p_theme_id=>3
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746389467393369274.4302)
,p_theme_id=>3
,p_name=>'LASTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746389708684369274.4302)
,p_theme_id=>3
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390046020369274.4302)
,p_theme_id=>3
,p_name=>'PRIMARY'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390150868369274.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390397268369274.4302)
,p_theme_id=>3
,p_name=>'SMALL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390512332369275.4302)
,p_theme_id=>3
,p_name=>'SMALLLEFT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390767691369275.4302)
,p_theme_id=>3
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390882019369275.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746390917880369275.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787136680200949751.4302)
,p_theme_id=>3
,p_name=>'DISABLE'
,p_display_name=>'Disable'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(716692596502820893.4302)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787136832495949751.4302)
,p_theme_id=>3
,p_name=>'ENABLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137078732949751.4302)
,p_theme_id=>3
,p_name=>'NOBORDERS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137218251949751.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137405724949751.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137521807949751.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(787137715876949751.4302)
,p_theme_id=>3
,p_name=>'STRETCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(926398873781707530.4302)
,p_theme_id=>3
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(388255255364942452.4302)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(926398916414707530.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(940695494482341567.4302)
,p_theme_id=>3
,p_name=>'SLIMPROGRESSLIST'
,p_display_name=>'Slim Progress List'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(716635374633805444.4302)
,p_css_classes=>'a-WizardSteps--slim'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1199563165206032440.4302)
,p_theme_id=>3
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(716616877554794734.4302)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_api.id(746389680630369274)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654306702182071.4302)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(3482816826549973.4302)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654416732182071.4302)
,p_theme_id=>3
,p_name=>'SHOWBADGES'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654507461182071.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654689857182071.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525654825674182071.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525655034537182071.4302)
,p_theme_id=>3
,p_name=>'FORALLITEMS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659340255182097.4302)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(716623225818805411.4302)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659441811182097.4302)
,p_theme_id=>3
,p_name=>'SHOWBADGES'
,p_display_name=>'Show Badges'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659560470182097.4302)
,p_theme_id=>3
,p_name=>'SHOWRIGHTARROW'
,p_display_name=>'Show Right Arrow'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659675457182098.4302)
,p_theme_id=>3
,p_name=>'USEBRIGHTHOVERS'
,p_display_name=>'Use Bright Hovers'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525659887066182098.4302)
,p_theme_id=>3
,p_name=>'FORTOPLEVELONLY'
,p_display_name=>'For top level only'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525660099207182098.4302)
,p_theme_id=>3
,p_name=>'FORALLITEMS'
,p_display_name=>'For all items'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1544820405774478040.4302)
,p_theme_id=>3
,p_name=>'SHOWRIGHTARROW'
,p_display_name=>'Show Right Arrow'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(716690084418820892.4302)
,p_css_classes=>'a-LinksList--showArrow'
,p_template_types=>'REPORT'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1544820596794478040.4302)
,p_theme_id=>3
,p_name=>'USEBRIGHTHOVERS'
,p_display_name=>'Use Bright Hovers'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1544820636742478040.4302)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554801274622408333.4302)
,p_theme_id=>3
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(388246039131933975.4302)
,p_css_classes=>'a-Region--hideHeader'
,p_group_id=>wwv_flow_api.id(697050181422402965)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554801401450408333.4302)
,p_theme_id=>3
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554801638095408334.4302)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554801888000408334.4302)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802037921408334.4302)
,p_theme_id=>3
,p_name=>'SIDEBAR'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802202518408334.4302)
,p_theme_id=>3
,p_name=>'BORDERLESS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802406950408334.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802636388408334.4302)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802870646408334.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554802972049408334.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554803157047408334.4302)
,p_theme_id=>3
,p_name=>'SIMPLE'
...
begin
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554834649462526824.4302)
,p_theme_id=>3
,p_name=>'RESPONSIVEICONCOLUMNS'
,p_display_name=>'Responsive Icon Columns'
,p_display_sequence=>2
,p_region_template_id=>wwv_flow_api.id(716658831322817171.4302)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554834759654526824.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554834865767526824.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554854985135542298.4302)
,p_theme_id=>3
,p_name=>'FLUSHREGION'
,p_display_name=>'Flush Region'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(716648790045817165.4302)
,p_css_classes=>'a-Region--flush'
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855096554542298.4302)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855290375542298.4302)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855436301542298.4302)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855609961542299.4302)
,p_theme_id=>3
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554855863802542299.4302)
,p_theme_id=>3
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554856018683542299.4302)
,p_theme_id=>3
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554856254808542299.4302)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554856471559542299.4302)
,p_theme_id=>3
,p_name=>'EXPANDED'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554856619328542299.4302)
,p_theme_id=>3
,p_name=>'COLLAPSED'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554872845517550829.4302)
,p_theme_id=>3
,p_name=>'REMOVE_TOP_BORDER'
,p_display_name=>'Remove Top Border'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(716662948592817174.4302)
,p_css_classes=>'a-Region--noTopBorder'
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873082445550829.4302)
,p_theme_id=>3
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873264879550829.4302)
,p_theme_id=>3
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873467120550829.4302)
,p_theme_id=>3
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873649715550830.4302)
,p_theme_id=>3
,p_name=>'DEFAULTPADDING'
,p_display_name=>'Default Padding'
,p_display_sequence=>30
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554873866842550830.4302)
,p_theme_id=>3
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554874039691550830.4302)
,p_theme_id=>3
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554874220093550830.4302)
,p_theme_id=>3
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554874432919550830.4302)
,p_theme_id=>3
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1554874697518550830.4302)
,p_theme_id=>3
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(641944455949362581.4302)
,p_build_option_name=>'Do not Include in EA1'
,p_build_option_status=>'EXCLUDE'
,p_on_upgrade_keep_status=>true
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(693448447977546491.4302)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(180670925407283078.4302)
,p_shortcut_name=>'ITEM_HELP'
,p_shortcut_type=>'HTML_TEXT'
,p_error_text=>'Impossible d''afficher l''aide.'
,p_reference_id=>24184979678.4302
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(539653303570634151.4302)
...
,p_ras_mode=>0
,p_reference_id=>540226219724705040.4302
);
end;
/
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(12521612942512635.4302)
...
,p_reference_id=>12457518297512494.4302
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(786884209949512865.4302)
,p_plugin_id=>wwv_flow_api.id(12521612942512635.4302)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786884688713512865.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
,p_display_sequence=>10
,p_display_value=>'ADMIN: Ability to manage flow developer privileges'
,p_return_value=>'ADMIN'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786885196596512865.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786885697196512866.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786886117257512866.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786886644701512867.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786887107848512867.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786887665109512867.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786888174226512867.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786888638439512867.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786889193469512869.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786889603854512869.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(786890183499512869.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(786884209949512865.4302)
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(113746414043665431.4302)
,p_plugin_type=>'AUTHENTICATION TYPE'
,p_name=>'COM.ORACLE.APEX.AUTHN.INTERNAL.APEX'
,p_display_name=>'Authentification Apex'
,p_supported_ui_types=>'DESKTOP'
,p_supported_component_types=>'APEX_APPLICATION_PAGE_ITEMS'
...
,p_substitute_attributes=>true
,p_reference_id=>113737019268347425.4302
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
end;
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356673526869447685.4302)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_standard_attributes=>'LOGIN_PAGE'
,p_substitute_attributes=>true
,p_reference_id=>113749806821809026.4302
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
end;
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356676122950447689.4302)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_standard_attributes=>'LOGIN_PAGE'
,p_substitute_attributes=>true
,p_reference_id=>113749511183746276.4302
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
end;
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356696623544447717.4302)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_standard_attributes=>'LOGIN_PAGE'
,p_substitute_attributes=>true
,p_reference_id=>708795120396802284.4302
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356696828873447717.4302)
,p_plugin_id=>wwv_flow_api.id(356696623544447717.4302)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356697211514447717.4302)
,p_plugin_id=>wwv_flow_api.id(356696623544447717.4302)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356697625048447717.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356697211514447717.4302)
,p_display_sequence=>10
,p_display_value=>'Redirect to Built-In URL'
,p_return_value=>'BUILTIN_URL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356698106182447717.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356697211514447717.4302)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356698627598447717.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356697211514447717.4302)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356699113011447718.4302)
,p_plugin_id=>wwv_flow_api.id(356696623544447717.4302)
,p_attribute_scope=>'COMPONENT'
...
,p_display_length=>60
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(356697211514447717.4302)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356699514966447718.4302)
,p_plugin_id=>wwv_flow_api.id(356696623544447717.4302)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356699902995447718.4302)
,p_plugin_id=>wwv_flow_api.id(356696623544447717.4302)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356700320876447718.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356699902995447718.4302)
,p_display_sequence=>10
,p_display_value=>'Each Request'
,p_return_value=>'ALWAYS'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356700819744447719.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356699902995447718.4302)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356701330878447719.4302)
,p_plugin_id=>wwv_flow_api.id(356696623544447717.4302)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356765414638447769.4302)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_substitute_attributes=>true
,p_reference_id=>863910941135523528.4302
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356765732481447771.4302)
,p_plugin_id=>wwv_flow_api.id(356765414638447769.4302)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356766124243447771.4302)
,p_plugin_id=>wwv_flow_api.id(356765414638447769.4302)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356766526635447771.4302)
,p_plugin_id=>wwv_flow_api.id(356765414638447769.4302)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356766900119447771.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356766526635447771.4302)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356767428334447772.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356766526635447771.4302)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356767916882447772.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356766526635447771.4302)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356768406566447772.4302)
,p_plugin_id=>wwv_flow_api.id(356765414638447769.4302)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356768825861447772.4302)
,p_plugin_id=>wwv_flow_api.id(356765414638447769.4302)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356769223844447773.4302)
,p_plugin_id=>wwv_flow_api.id(356765414638447769.4302)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(356768825861447772.4302)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356769612451447773.4302)
,p_plugin_id=>wwv_flow_api.id(356765414638447769.4302)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356770002974447773.4302)
,p_plugin_id=>wwv_flow_api.id(356765414638447769.4302)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356770430789447773.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356770002974447773.4302)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356770908739447773.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356770002974447773.4302)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356771418301447773.4302)
,p_plugin_attribute_id=>wwv_flow_api.id(356770002974447773.4302)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356820112047447809.4302)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_standard_attributes=>'LOGIN_PAGE'
,p_substitute_attributes=>true
,p_reference_id=>113750429890071859.4302
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
end;
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(4969527595302343.4302)
...
wwv_flow_api.create_page(
 p_id=>.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236187524918490.4302)
,p_plug_name=>'APEX 5 - Header'
,p_region_css_classes=>'a-Header apex-sql-workshop'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388251521427936641.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236352716918490.4302)
,p_plug_name=>'APEX 5 - Header Left'
,p_parent_plug_id=>wwv_flow_api.id(388236187524918490.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1456614651025020.4302)
,p_plug_name=>'Application Tabs'
,p_region_name=>'a_Header_menu'
,p_parent_plug_id=>wwv_flow_api.id(388236352716918490.4302)
...
,p_list_id=>wwv_flow_api.id(718988657702143721.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(388254947243942451.4302)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236512184918491.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236787857918491.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237172510918491.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237328927918491.4302)
,p_plug_name=>'APEX 5 - Search'
,p_parent_plug_id=>wwv_flow_api.id(388237172510918491.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237583055918491.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388296571194069434.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388344712770271079.4302)
,p_plug_name=>'APEX 5 - Administration Menu'
,p_region_name=>'adminMenu'
,p_parent_plug_id=>wwv_flow_api.id(388296571194069434.4302)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388251521427936641.4302)
,p_plug_display_sequence=>60
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(697382068928001818.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(388255255364942452.4302)
,p_translate_title=>'N'
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(486771776816301727.4302)
...
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(697413399059052182.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(388255255364942452.4302)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388236965230918491.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237715059918492.4302)
,p_plug_name=>'APEX 5 - Control Bar Left'
,p_parent_plug_id=>wwv_flow_api.id(388236965230918491.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388323355246153942.4302)
,p_plug_name=>'APEX 5 - Breadcrumb'
,p_parent_plug_id=>wwv_flow_api.id(388237715059918492.4302)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388251521427936641.4302)
,p_plug_display_sequence=>1
,p_plug_display_point=>'BODY'
,p_menu_id=>wwv_flow_api.id(6678815232629976.4302)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(388324150680174551.4302)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(388237918952918492.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3773582205956301545.4302)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(388296571194069434.4302)
,p_button_name=>'SPOTLIGHT'
,p_button_static_id=>'header-spotlightSearch'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(388298732478079235.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(384688985396932804.4302)
...
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(388298521291079233.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(384689065888932805.4302)
...
,p_grid_new_grid=>false
,p_required_patch=>wwv_flow_api.id(693448447977546491.4302)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(384689133506932806.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(388350254436282356.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(388236787857918491.4302)
,p_button_name=>'HOME'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(388298732478079235.4302)
...
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_api.id(216950505720834051)
,p_step_template=>wwv_flow_api.id(716607252394788370.4302)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'AEUTL/sql_utl_exprt_imprt.htm'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2209528931524495.4302)
,p_plug_name=>unistr('R\00E9f\00E9rentiel')
...
,p_plug_template=>wwv_flow_api.id(716662948592817174.4302)
,p_plug_display_sequence=>30
,p_plug_new_grid_row=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(2202106852499122.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716623225818805411.4302)
,p_plug_column_width=>'apex-col--bottomBorder'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(170288209634031042.4302)
,p_plug_name=>unistr('Chargement des donn\00E9es')
...
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(74707671328250039.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716623225818805411.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(170288516691042569.4302)
,p_plug_name=>unistr('D\00E9chargement des donn\00E9es')
...
,p_plug_new_grid_row=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(75585889878824332.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716623225818805411.4302)
,p_plug_column_width=>'apex-col--rightBorder apex-col--bottomBorder'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(171170229200569353.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(945660876947384278.4302)
,p_name=>'RENDERING: Page - Dialog Closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(170288209634031042.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(945661141312384282.4302)
,p_event_id=>wwv_flow_api.id(945660876947384278.4302)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page(
 p_id=>2.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('D\00E9tails de chargement de feuilles de calcul')
,p_step_title=>unistr('D\00E9tails de chargement de feuilles de calcul')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(236908207860041215.4302)
,p_plug_name=>'Chargement de feuille de calcul'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(104263607591363808.4302)
,p_plug_display_sequence=>50
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>unistr('<p>Cette page affiche des informations sur l''import de feuilles de calcul. Si l''import de certaines lignes a \00E9chou\00E9, elle affiche un message d''erreur.</p>')
,p_plug_column_width=>'valign="top"'
,p_plug_query_no_data_found=>unistr('Aucune ligne en \00E9chec n''a \00E9t\00E9 trouv\00E9e.')
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(236908624285041216.4302)
,p_name=>unistr('Lignes en \00E9chec')
,p_template=>wwv_flow_api.id(716648790045817165.4302)
,p_display_sequence=>30
...
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(716692596502820893.4302)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'(null)'
,p_query_no_data_found=>unistr('Aucune ligne en \00E9chec n''a \00E9t\00E9 trouv\00E9e.')
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236909010953041218.4302)
,p_query_column_id=>1
,p_column_alias=>'ERROR'
,p_column_display_sequence=>1
,p_column_heading=>'Erreur'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236909111520041218.4302)
,p_query_column_id=>2
,p_column_alias=>'DATA'
,p_column_display_sequence=>2
,p_column_heading=>unistr('Donn\00E9es')
,p_use_as_row_header=>'N'
,p_heading_alignment=>'LEFT'
,p_lov_show_nulls=>'NO'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(236909231803041218.4302)
,p_plug_name=>'button bar'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_translate_title=>'N'
,p_attribute_01=>'N'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(236910023245041222.4302)
,p_name=>unistr('D\00E9tails sur l''import')
,p_template=>wwv_flow_api.id(388246039131933975.4302)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910621733041225.4302)
,p_query_column_id=>1
,p_column_alias=>'LOAD_DATE'
,p_column_display_sequence=>1
,p_column_heading=>'Date de l''import'
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_lov_display_extra=>'YES'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910704793041225.4302)
,p_query_column_id=>2
,p_column_alias=>'LOADED_BY'
,p_column_display_sequence=>2
,p_column_heading=>'Import par'
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_lov_display_extra=>'YES'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910825625041225.4302)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910911224041225.4302)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910405016041225.4302)
,p_query_column_id=>5
,p_column_alias=>'ROWS_LOADED'
,p_column_display_sequence=>5
,p_column_heading=>unistr('Lignes import\00E9es')
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_lov_display_extra=>'YES'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(236910524132041225.4302)
,p_query_column_id=>6
,p_column_alias=>'ROWS_FAILED'
,p_column_display_sequence=>6
,p_column_heading=>unistr('Lignes en \00E9chec')
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_lov_display_extra=>'YES'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(236911018188041226.4302)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(236909231803041218.4302)
,p_button_name=>'BACK'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
,p_button_is_hot=>'Y'
,p_button_image_alt=>unistr('Retour au r\00E9f\00E9rentiel')
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(236912309292041255.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(236911408920041236.4302)
,p_name=>'P2_LOAD_ID'
,p_item_sequence=>10
...
wwv_flow_api.create_page(
 p_id=>7.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('D\00E9tails de chargement de donn\00E9es textuelles')
,p_step_title=>unistr('D\00E9tails de chargement de donn\00E9es textuelles')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3913203962745120.4302)
,p_plug_name=>'button bar'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(55112340569377996.4302)
,p_name=>unistr('Lignes en \00E9chec')
,p_template=>wwv_flow_api.id(716648790045817165.4302)
,p_display_sequence=>30
,p_region_template_options=>'#DEFAULT#:is-expanded'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(26396310164851868.4302)
,p_query_column_id=>1
,p_column_alias=>'ERROR'
,p_column_display_sequence=>1
,p_column_heading=>'Erreur'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(26396413604851868.4302)
,p_query_column_id=>2
,p_column_alias=>'DATA'
,p_column_display_sequence=>2
,p_column_heading=>unistr('Donn\00E9es')
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(234740508574260035.4302)
,p_name=>unistr('D\00E9tails sur l''import')
,p_template=>wwv_flow_api.id(388246039131933975.4302)
,p_display_sequence=>25
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
...
,p_header=>unistr('<p>Cette page affiche des informations sur l''import de fichiers de donn\00E9es textuelles. Si l''import de certaines lignes a \00E9chou\00E9, elle affiche un message d''erreur.</p>')
,p_fixed_header=>'NONE'
,p_query_row_template=>2
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741120589260051.4302)
,p_query_column_id=>1
,p_column_alias=>'LOAD_DATE'
,p_column_display_sequence=>1
,p_column_heading=>'Date de l''import'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741209381260051.4302)
,p_query_column_id=>2
,p_column_alias=>'LOADED_BY'
,p_column_display_sequence=>2
,p_column_heading=>'Import par'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741308348260051.4302)
,p_query_column_id=>3
,p_column_alias=>'SCHEMA2'
,p_column_display_sequence=>3
,p_column_heading=>unistr('Sch\00E9ma')
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741425535260051.4302)
,p_query_column_id=>4
,p_column_alias=>'TABLE2'
,p_column_display_sequence=>4
,p_column_heading=>'Table'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741507868260052.4302)
,p_query_column_id=>5
,p_column_alias=>'ROWS_LOADED'
,p_column_display_sequence=>5
,p_column_heading=>unistr('Lignes import\00E9es')
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234741628809260052.4302)
,p_query_column_id=>6
,p_column_alias=>'ROWS_FAILED'
,p_column_display_sequence=>6
,p_column_heading=>unistr('Lignes en \00E9chec')
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(192104604688817535.4302)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3913203962745120.4302)
,p_button_name=>'BACK'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(234998201152447134.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(27172013799279694.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(234980910062392922.4302)
,p_name=>'P7_PREV_PAGE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(3913203962745120.4302)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
end;
...
wwv_flow_api.create_page(
 p_id=>8.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('R\00E9f\00E9rentiel de chargement de donn\00E9es textuelles')
,p_step_title=>unistr('R\00E9f\00E9rentiel de chargement de donn\00E9es textuelles')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_api.id(215731706086585147)
,p_step_template=>wwv_flow_api.id(716607780903788372.4302)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'AEUTL/sql_utl_imprt_rep.htm'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3921012881766600.4302)
,p_plug_name=>'Button Bar'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(220725321769721592.4302)
,p_plug_name=>unistr('R\00E9f\00E9rentiel')
,p_region_template_options=>'#DEFAULT#:a-Region--slimPadding:a-Region--sideRegion'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388246039131933975.4302)
,p_plug_display_sequence=>60
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>Cette page affiche le statut des donn\00E9es textuelles charg\00E9es.</p> '),
unistr('<p>Pour acc\00E9der au fichier charg\00E9, s\00E9lectionnez-en le nom.</p> '),
unistr('<p>Pour supprimer une entr\00E9e de statut, s\00E9lectionnez-la et cliquez sur <b>Supprimer ce qui est coch\00E9</b>.</p>')))
,p_plug_column_width=>'valign="top"'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(220741417024852608.4302)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(3648913903408259.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(3482816826549973.4302)
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(234960616202337996.4302)
,p_name=>unistr('R\00E9f\00E9rentiel')
,p_template=>wwv_flow_api.id(388251521427936641.4302)
,p_display_sequence=>40
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-Report--stretch'
,p_new_grid_column=>false
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>unistr('Aucun fichier n''a \00E9t\00E9 trouv\00E9.')
,p_query_num_rows_type=>'ROW_RANGES'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961216430338008.4302)
,p_query_column_id=>1
,p_column_alias=>'CB'
,p_column_display_sequence=>1
,p_column_heading=>'&nbsp;'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(937850430942294704.4302)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961308847338008.4302)
,p_query_column_id=>3
,p_column_alias=>'Details'
,p_column_display_sequence=>2
,p_column_heading=>unistr('D\00E9tails')
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961403149338008.4302)
,p_query_column_id=>4
,p_column_alias=>'File'
,p_column_display_sequence=>3
,p_column_heading=>'Fichier'
,p_display_as=>'WITHOUT_MODIFICATION'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961531529338008.4302)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961610894338008.4302)
,p_query_column_id=>6
,p_column_alias=>'Created on'
,p_column_display_sequence=>5
,p_column_heading=>'Import le'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961731890338010.4302)
,p_query_column_id=>7
,p_column_alias=>'Type'
,p_column_display_sequence=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961804936338010.4302)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234961924524338011.4302)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234962026814338011.4302)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234962102068338011.4302)
,p_query_column_id=>11
,p_column_alias=>'Succeeded'
,p_column_display_sequence=>10
,p_column_heading=>unistr('Succ\00E8s')
,p_column_alignment=>'RIGHT'
,p_display_as=>'WITHOUT_MODIFICATION'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234962213306338011.4302)
,p_query_column_id=>12
,p_column_alias=>'Failed'
,p_column_display_sequence=>11
,p_column_heading=>'Echec'
,p_column_alignment=>'RIGHT'
,p_display_as=>'WITHOUT_MODIFICATION'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174139107561146972.4302)
,p_query_column_id=>13
,p_column_alias=>'TO_BE_DELETED'
,p_column_display_sequence=>12
,p_column_heading=>'A supprimer'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(51804488943808398.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(3921012881766600.4302)
,p_button_name=>'F4300_P8_GO'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:a-Button--small'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
,p_button_image_alt=>unistr('D\00E9finir')
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(130487609243007078.4302)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3921012881766600.4302)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(130488219172007162.4302)
,p_branch_action=>'8'
,p_branch_point=>'AFTER_PROCESSING'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(51821394189864043.4302)
,p_name=>'F4300_P8_RESTRICT_BY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3921012881766600.4302)
,p_prompt=>'Afficher'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'RESTRICT.LOAD.FILES'
,p_lov=>'.'||wwv_flow_api.id(87918702852509211)||'.'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(716619902812799716.4302)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'NO_SPECIAL_CHAR_NL'
,p_help_text=>'Indiquer d''afficher vos fichiers ou tous les fichiers'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(165133620695131261.4302)
,p_validation_name=>'SelectAtLeastOne'
,p_validation_sequence=>10
,p_validation=>'wwv_flow.g_f01.count > 0'
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>unistr('Vous devez s\00E9lectionner au moins un fichier \00E0 supprimer.')
,p_when_button_pressed=>wwv_flow_api.id(130487609243007078.4302)
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(51823819555198806.4302)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(130807727310131197.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'    and security_group_id = :flow_security_group_id;',
'end loop;'))
,p_process_error_message=>'Erreur lors de la suppression du ou des fichiers.'
,p_process_when_button_id=>wwv_flow_api.id(130487609243007078.4302)
,p_process_when=>'wwv_flow.g_f01.count > 0'
,p_process_when_type=>'PLSQL_EXPRESSION'
,p_process_success_message=>unistr('Fichier(s) supprim\00E9(s).')
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>11.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('R\00E9f\00E9rentiel de feuilles de calcul')
,p_step_title=>unistr('R\00E9f\00E9rentiel de feuilles de calcul')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3655019491438205.4302)
,p_plug_name=>unistr('T\00E2ches')
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388246039131933975.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3925626518780012.4302)
,p_plug_name=>'button bar'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(114705422835023938.4302)
,p_plug_name=>unistr('R\00E9f\00E9rentiel de feuilles de calcul')
,p_region_template_options=>'#DEFAULT#:a-Region--slimPadding:a-Region--sideRegion'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(388246039131933975.4302)
,p_plug_display_sequence=>30
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>Cette page affiche le statut des donn\00E9es de feuille de calcul import\00E9es.</p> '),
unistr('<p>Pour supprimer une entr\00E9e de statut, s\00E9lectionnez-la et cliquez sur <b>Supprimer ce qui est coch\00E9</b>.</p>')))
,p_plug_column_width=>'valign="top"'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(234717428566209000.4302)
,p_name=>'Chargements'
,p_template=>wwv_flow_api.id(388251521427936641.4302)
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_no_data_found=>unistr('Aucun import de feuille de calcul n''a \00E9t\00E9 trouv\00E9.')
,p_query_num_rows_type=>'ROW_RANGES'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718032272209012.4302)
,p_query_column_id=>1
,p_column_alias=>'CB'
,p_column_display_sequence=>1
,p_column_heading=>'&nbsp;'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(937952072556533758.4302)
,p_query_column_id=>2
,p_column_alias=>'DETAILS_LINK'
,p_column_display_sequence=>12
,p_hidden_column=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718112718209012.4302)
,p_query_column_id=>3
,p_column_alias=>'Details'
,p_column_display_sequence=>2
,p_column_heading=>unistr('D\00E9tails')
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718206872209012.4302)
,p_query_column_id=>4
,p_column_alias=>'Created By'
,p_column_display_sequence=>3
,p_column_heading=>'Import par'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718310926209013.4302)
,p_query_column_id=>5
,p_column_alias=>'Created on'
,p_column_display_sequence=>4
,p_column_heading=>'Import le'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718429023209013.4302)
,p_query_column_id=>6
,p_column_alias=>'Type'
,p_column_display_sequence=>5
,p_column_heading=>'Type'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718526244209013.4302)
,p_query_column_id=>7
,p_column_alias=>'Schema'
,p_column_display_sequence=>6
,p_column_heading=>unistr('Sch\00E9ma')
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718631100209013.4302)
,p_query_column_id=>8
,p_column_alias=>'TABLE'
,p_column_display_sequence=>7
,p_column_heading=>'Table'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718712148209013.4302)
,p_query_column_id=>9
,p_column_alias=>'Succeeded'
,p_column_display_sequence=>8
,p_column_heading=>unistr('Succ\00E8s')
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(234718804458209013.4302)
,p_query_column_id=>10
,p_column_alias=>'Failed'
,p_column_display_sequence=>9
,p_column_heading=>'Echec'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(268495509916252852.4302)
,p_query_column_id=>11
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(268502322084284781.4302)
,p_query_column_id=>12
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(114704228365023929.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(3925626518780012.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(192155317097767347.4302)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3925626518780012.4302)
,p_button_name=>'DELETE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(114703320184023921.4302)
,p_branch_action=>'11'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(114704528502023930.4302)
,p_name=>'F4300_P11_RESTRICT_BY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3925626518780012.4302)
,p_prompt=>'Afficher'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'RESTRICT.LOAD.FILES'
,p_lov=>'.'||wwv_flow_api.id(87918702852509211)||'.'
...
,p_help_text=>'Indiquer s''il faut afficher votre import de feuille de calcul ou tous vos imports de feuille de calcul.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(165128603595116797.4302)
,p_validation_name=>'SelectAtLeastOne'
,p_validation_sequence=>10
,p_validation=>'wwv_flow.g_f01.count > 0'
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>unistr('Vous devez s\00E9lectionner au moins un fichier \00E0 supprimer.')
,p_when_button_pressed=>wwv_flow_api.id(192155317097767347.4302)
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(192159607728774014.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'     and security_group_id = :flow_security_group_id;',
'commit;'))
,p_process_error_message=>'Erreur lors de la suppression.'
,p_process_when_button_id=>wwv_flow_api.id(192155317097767347.4302)
,p_process_success_message=>unistr('D\00E9tails de chargement de donn\00E9es de feuille de calcul supprim\00E9s.')
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(114704811615023932.4302)
...
wwv_flow_api.create_page(
 p_id=>14.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es XML')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es XML')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
,p_step_template=>wwv_flow_api.id(716613771837788376.4302)
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(184012414812654843.4302)
,p_plug_name=>unistr('Charger les donn\00E9es XML')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(208585513765537107.4302)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>unistr('<p>S\00E9lectionnez le sch\00E9ma et le nom de base de donn\00E9es de la table sur laquelle charger les donn\00E9es, et localisez le document XML \00E0 t\00E9l\00E9charger.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(341792317669297384.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937839991596088902.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(341792317669297384.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(184013029848654860.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(341792317669297384.4302)
...
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
,p_button_is_hot=>'Y'
,p_button_image_alt=>unistr('Charger les donn\00E9es')
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(184013614902654876.4302)
,p_name=>'F4300_P14_TARGET_SCHEMA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(184012414812654843.4302)
...
,p_lov_null_text=>unistr('- S\00E9lectionner un sch\00E9ma - ')
,p_lov_null_value=>'0'
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(716620116614799716.4302)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>unistr('S\00E9lectionnez le sch\00E9ma de base de donn\00E9es propri\00E9taire de la table dans laquelle vous voulez charger des donn\00E9es.')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(238567106303255599.4302)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>unistr('S\00E9lectionnez  la table de base de donn\00E9es dans laquelle vous voulez charger des donn\00E9es. Par d\00E9faut, tous les noms de table sont convertis en majuscules. S\00E9lectionnez <span class="fielddatabold">Respecter maj/min</span> pour \00E9viter cette conversion p')
||unistr('ar d\00E9faut.')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(239230403195330418.4302)
...
,p_help_text=>unistr('Cliquez sur <span class="fielddatabold">Parcourir</span> pour localiser le fichier XML \00E0 t\00E9l\00E9charger vers le serveur.')
,p_attribute_01=>'WWV_FLOW_FILES'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(184014831290654966.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(238757828944271610.4302)
...
,p_when_button_pressed=>wwv_flow_api.id(184013029848654860.4302)
,p_associated_item=>wwv_flow_api.id(184013614902654876.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(238842116261277415.4302)
...
,p_when_button_pressed=>wwv_flow_api.id(184013029848654860.4302)
,p_associated_item=>wwv_flow_api.id(238567106303255599.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(239260717048334408.4302)
,p_validation_name=>'file required'
,p_validation_sequence=>40
,p_validation=>'F4300_P17_FILE'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Le fichier doit \00EAtre indiqu\00E9.')
,p_validation_condition=>'F4300_P17_FILE'
,p_validation_condition_type=>'ITEM_IS_NULL'
,p_when_button_pressed=>wwv_flow_api.id(184013029848654860.4302)
,p_associated_item=>wwv_flow_api.id(239230403195330418.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(239275721203335597.4302)
...
,p_error_message=>'Le fichier est vide.'
,p_validation_condition=>'F4300_P17_FILE'
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_when_button_pressed=>wwv_flow_api.id(184013029848654860.4302)
,p_associated_item=>wwv_flow_api.id(239230403195330418.4302)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937840169136091731.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937839991596088902.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937840425239091732.4302)
,p_event_id=>wwv_flow_api.id(937840169136091731.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(238937010159285027.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(184013029848654860.4302)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(239245612546333116.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'',
'end;'))
,p_process_error_message=>'Erreur lors du chargement de XML.'
,p_process_when_button_id=>wwv_flow_api.id(184013029848654860.4302)
,p_process_success_message=>unistr('XML charg\00E9.')
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584609866530529.4302)
...
wwv_flow_api.create_page(
 p_id=>18.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es - D\00E9tails de fichier')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es - D\00E9tails de fichier')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2157120477803132.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
,p_plug_display_sequence=>10
,p_plug_new_grid_row=>false
,p_plug_display_column=>1
,p_plug_display_point=>'BODY'
...
unistr('Le fichier \00E0 t\00E9l\00E9charger doit \00EAtre de type texte. Pour t\00E9l\00E9charger un fichier .XLS, enregistrez-le d''abord comme fichier CSV. <p />'),
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3939910944851245.4302)
...
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(3931814922814551.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444.4302)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21283612328451431.4302)
,p_plug_name=>'Globalisation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676055535817183.4302)
,p_plug_display_sequence=>20
,p_plug_new_grid_row=>false
,p_plug_display_column=>1
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208596429152553286.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937785833006812802.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208596429152553286.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2158311458803135.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208596429152553286.4302)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2158218927803135.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208596429152553286.4302)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2586909632661028.4302)
,p_branch_action=>'18'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2159723337803140.4302)
,p_branch_action=>'19'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2158311458803135.4302)
,p_branch_sequence=>20
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2159221254803139.4302)
,p_branch_action=>'230'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2158218927803135.4302)
,p_branch_sequence=>30
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2157814244803134.4302)
,p_name=>'F4300_P13_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2157120477803132.4302)
,p_prompt=>'Fichier texte'
,p_display_as=>'NATIVE_FILE'
,p_cSize=>30
,p_cMaxlength=>2000
,p_label_alignment=>'RIGHT'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'N'
,p_help_text=>unistr('Cliquez sur <span class="fielddatabold">Parcourir</span> pour localiser le fichier \00E0 t\00E9l\00E9charger vers le serveur.')
,p_attribute_01=>'WWV_FLOW_FILES'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2243727316068250.4302)
,p_name=>'F4300_P13_IS_COLUMN_NAME'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(2157120477803132.4302)
,p_item_default=>'Y'
,p_prompt=>unistr('La premi\00E8re ligne contient des noms de colonne')
,p_display_as=>'NATIVE_CHECKBOX'
,p_named_lov=>'ISCOLUMN.NAME.TEXT'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select ''<span class="instructiontext">''||',
'wwv_flow_lang.system_message(''F4300_INSTRUCT_TEXT'')||''</span>'' d, ''Y'' r from dual'))
,p_field_template=>wwv_flow_api.id(716619812724799715.4302)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>S\00E9lectionnez cette case si vos donn\00E9es contiennent des noms de colonne dans la premi\00E8re ligne.</p>'),
'',
'',
'',
'<pre>',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2329615063755442.4302)
,p_name=>'F4300_P13_SEPARATOR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(2157120477803132.4302)
,p_item_default=>','
,p_prompt=>unistr('S\00E9parateur : (\005Ct pour tabulation)')
...
,p_help_text=>unistr('Identifiez le caract\00E8re s\00E9parateur de colonnes. Utilisez <code>\005Ct</code> pour une s\00E9paration par des tabulations.')
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2583912702633467.4302)
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>unistr('Nom du fichier \00E0 t\00E9l\00E9charger vers le serveur.')
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2586326817656557.4302)
,p_name=>'F4300_P18_REUPLOAD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(2157120477803132.4302)
,p_item_default=>'N'
,p_prompt=>unistr('T\00E9l\00E9charger de nouveau un fichier')
,p_display_as=>'NATIVE_SELECT_LIST'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>unistr('Indiquer de t\00E9l\00E9charger de nouveau le fichier ')
,p_attribute_01=>'SUBMIT'
,p_attribute_03=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2764003228797653.4302)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<div class="htmldbInfoBodyP">Saisissez un caract\00E8re d\00E9limiteur. Vous pouvez utiliser ce caract\00E8re pour marquer les limites de d\00E9but et de fin d''une valeur de donn\00E9es. Si vous indiquez un caract\00E8re d\00E9limiteur, l''atelier de donn\00E9es ignore les espaces s')
||unistr('itu\00E9s avant les limites de d\00E9but et de fin d''une valeur de donn\00E9es. Vous pouvez \00E9galement utiliser cette option pour placer une valeur de donn\00E9es entre les d\00E9limiteurs indiqu\00E9s.</div>'),
unistr('<div class="htmldbInfoBodyP">Si la premi\00E8re ligne contient des noms de colonne, s\00E9lectionnez <span class="fielddatabold">La premi\00E8re ligne contient des noms de colonne.</span></div>'),
''))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21284319254453394.4302)
,p_name=>'P18_CURRENCY'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(21283612328451431.4302)
...
,p_prompt=>unistr('Symbole mon\00E9taire')
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>1
,p_cMaxlength=>1
,p_label_alignment=>'RIGHT'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>Si vos donn\00E9es contiennent un symbole mon\00E9taire international, saisissez-le ici.</p>'),
unistr('<p>Par exemple, si vos donn\00E9es comportent "&euro;1,234.56" ou "&yen;1,234.56", saisissez "&euro;" ou "&yen;". Si vous ne le faites pas, les donn\00E9es ne se chargeront pas correctement.</p>')))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21931121693474165.4302)
,p_name=>'P18_GROUP_SEPARATOR'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(21283612328451431.4302)
,p_item_default=>'return wwv_flow.get_nls_group_separator;'
,p_item_default_type=>'PLSQL_FUNCTION_BODY'
,p_prompt=>unistr('S\00E9parateur de groupes')
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>1
,p_cMaxlength=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(143068503644769301.4302)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>unistr('Choisissez le jeu de caract\00E8res dans lequel le fichier texte est encod\00E9.')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(514941714951998813.4302)
,p_name=>'F4300_P18_FILE_PREVIEW'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(2157120477803132.4302)
,p_prompt=>unistr('Aper\00E7u')
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49531609285689625.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(2601228838903096.4302)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2959116096955698.4302)
,p_validation_name=>'file name not null'
,p_validation_sequence=>10
,p_validation=>'F4300_P13_FILE'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Un fichier doit \00EAtre s\00E9lectionn\00E9 pour t\00E9l\00E9chargement.')
,p_when_button_pressed=>wwv_flow_api.id(2158311458803135.4302)
,p_associated_item=>wwv_flow_api.id(2157814244803134.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(165112819562074156.4302)
,p_validation_name=>'SeparatorMand'
,p_validation_sequence=>20
,p_validation=>'F4300_P13_SEPARATOR'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Le s\00E9parateur doit \00EAtre indiqu\00E9.')
,p_when_button_pressed=>wwv_flow_api.id(2158311458803135.4302)
,p_associated_item=>wwv_flow_api.id(2329615063755442.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52214713959981319.4302)
,p_validation_name=>'file not 0 byte'
,p_validation_sequence=>30
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'for c1 in (select id                     ',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(245259621035850537.4302)
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'L''extension du fichier n''est pas valide. Les fichiers de type binaire ne sont pas pris en charge.'
,p_when_button_pressed=>wwv_flow_api.id(2158311458803135.4302)
,p_associated_item=>wwv_flow_api.id(2583912702633467.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937786060661818197.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937785833006812802.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937786365024818199.4302)
,p_event_id=>wwv_flow_api.id(937786060661818197.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514941847752998814.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942000924998816.4302)
,p_event_id=>wwv_flow_api.id(514941847752998814.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942141088998817.4302)
,p_event_id=>wwv_flow_api.id(514941847752998814.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514941963015998815.4302)
,p_event_id=>wwv_flow_api.id(514941847752998814.4302)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514942269010998818.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942346333998819.4302)
,p_event_id=>wwv_flow_api.id(514942269010998818.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514942483195998820.4302)
,p_name=>'Disable it'
,p_event_sequence=>40
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942501168998821.4302)
,p_event_id=>wwv_flow_api.id(514942483195998820.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2324003064685753.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'  end if;',
'end;'))
,p_process_error_message=>unistr('Erreur lors de la cr\00E9ation de la collection au moyen des donn\00E9es charg\00E9es.')
,p_process_when_button_id=>wwv_flow_api.id(2158311458803135.4302)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23875226415655164.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'',
':F4300_P13_FILE := null;'))
,p_process_error_message=>'Impossible de supprimer le fichier.'
...
wwv_flow_api.create_page(
 p_id=>19.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es - Propri\00E9t\00E9s de table')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es - Propri\00E9t\00E9s de table')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2160319726803142.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2252818489103487.4302)
,p_plug_name=>unistr('D\00E9finir des propri\00E9t\00E9s de table')
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3940715792852571.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208599127898562379.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(221480323469295765.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>unistr('<p>Cette page affiche la nouvelle table telle qu''elle se pr\00E9sentera. Vous pouvez saisir un nom pour la table, changer les noms de colonne ou les types de donn\00E9es et indiquer les colonnes \00E0 inclure.</p>')
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937784823962801386.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208599127898562379.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2161511969803145.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208599127898562379.4302)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2161401612803145.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208599127898562379.4302)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2162930496803151.4302)
,p_branch_action=>'21'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2161511969803145.4302)
,p_branch_sequence=>20
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2162430587803150.4302)
,p_branch_action=>'18'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2161401612803145.4302)
,p_branch_sequence=>10
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2161012050803145.4302)
,p_name=>'F4300_P13_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2160319726803142.4302)
,p_prompt=>unistr('Sch\00E9ma')
,p_source=>'wwv_flow_user_api.get_default_schema'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_SELECT_LIST'
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>unistr('Choisissez le sch\00E9ma de base de donn\00E9es que vous voulez cr\00E9er et dans lequel vous voulez charger des donn\00E9es.')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2267110534176923.4302)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>unistr('Identifiez le nom de la table que vous voulez cr\00E9er. Par d\00E9faut, tous les noms de table sont convertis en majuscules. S\00E9lectionnez <span class="fielddatabold">Respecter maj/min</span> pour \00E9viter cette conversion par d\00E9faut.')
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2269730619182732.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(77772602360009347.4302)
,p_name=>'P19_PRESERVE_CASE'
,p_item_sequence=>25
,p_item_plug_id=>wwv_flow_api.id(2160319726803142.4302)
,p_prompt=>'Respecter maj/min'
,p_display_as=>'NATIVE_CHECKBOX'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(77778717729023209.4302)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(2611527265139214.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2615902509169951.4302)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2617025019176456.4302)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_api.id(2267110534176923.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2617811990182089.4302)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Au moins une colonne doit \00EAtre indiqu\00E9e pour inclure une nouvelle table. ')
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2618831730187776.4302)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>unistr('Ce nom est d\00E9j\00E0 utilis\00E9 par un objet existant.')
,p_associated_item=>wwv_flow_api.id(2267110534176923.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2620211429191428.4302)
,p_validation_name=>'table name not null'
,p_validation_sequence=>50
,p_validation=>'F4300_P13_TABLE_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Le nom de table doit \00EAtre indiqu\00E9.')
,p_associated_item=>wwv_flow_api.id(2267110534176923.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2622018486202935.4302)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'Erreur de longueur de colonne.'
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(290889128494860177.4302)
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Le nom de table identifi\00E9 est un mot r\00E9serv\00E9 Oracle. Choisissez un autre nom.')
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(291061510906810726.4302)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>unistr('Le nom de colonne identifi\00E9 est un mot r\00E9serv\00E9 Oracle. Choisissez un autre nom.')
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(25617203076189584.4302)
...
,p_when_button_pressed=>wwv_flow_api.id(2161511969803145.4302)
,p_associated_item=>wwv_flow_api.id(2161012050803145.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937785042471804309.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937784823962801386.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937785344680804311.4302)
,p_event_id=>wwv_flow_api.id(937785042471804309.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432754819513077103.4302)
,p_process_sequence=>10
...
wwv_flow_api.create_page(
 p_id=>21.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es - Cl\00E9 primaire')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es - Cl\00E9 primaire')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2163507507803153.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>unistr('<p>Cette page permet d''identifier la cl\00E9 primaire de la table. Si aucune colonne unique dans l''ensemble de donn\00E9es ne convient comme cl\00E9 primaire, identifiez une nouvelle colonne en tant que cl\00E9 primaire. Une cl\00E9 primaire sert \00E0 identifier une ligne ')
||unistr('de table de mani\00E8re unique.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_plug_comment=>'Region generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3941420987854137.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208600405997574943.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937792840943888300.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208600405997574943.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2164724759803154.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208600405997574943.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2164626737803154.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208600405997574943.4302)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(29899701983651170.4302)
,p_branch_action=>'21'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>20
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(52491202943423441.4302)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2165605436803157.4302)
,p_branch_action=>'19'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2164626737803154.4302)
,p_branch_sequence=>40
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2164212316803154.4302)
,p_name=>'F4300_P21_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2163507507803153.4302)
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>unistr('Sch\00E9ma propri\00E9taire de la table dans laquelle vous voulez charger des donn\00E9es.')
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2290019463274070.4302)
...
,p_protection_level=>'I'
,p_escape_on_http_output=>'N'
,p_help_text=>unistr('Nom de la table dans laquelle charger les donn\00E9es.')
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29865802488537862.4302)
,p_name=>'P13_PK1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(2163507507803153.4302)
,p_prompt=>unistr('Cl\00E9 primaire')
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
''))
,p_lov_display_null=>'YES'
,p_lov_null_text=>unistr('- S\00E9lectionner une cl\00E9 primaire -')
,p_lov_null_value=>'0'
,p_cHeight=>1
,p_cAttributes=>'nowrap="nowrap"'
,p_label_alignment=>'RIGHT'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>unistr('Indiquez la colonne correspondant \00E0 la cl\00E9 primaire de votre table. Une cl\00E9 primaire est une colonne qui identifie une ligne de fa\00E7on unique. Bien qu''Oracle n''exige pas que votre table ait une cl\00E9 primaire, cet assistant vous demande d''en identifier ')
||'une.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29868930193545840.4302)
,p_name=>'P13_PK1_NAME'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(2163507507803153.4302)
,p_prompt=>unistr('Nom de contrainte de cl\00E9 primaire')
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>2000
,p_cAttributes=>'nowrap="nowrap"'
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4302)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('Indiquez le nom de contrainte de la cl\00E9 primaire.')
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29871919935552356.4302)
,p_name=>'P13_PK_TYPE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(2163507507803153.4302)
,p_item_default=>'NEW_SEQUENCE'
,p_prompt=>unistr('Remplissage des cl\00E9s primaires :')
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>unistr('Choisissez le mode de calcul de votre cl\00E9 primaire. Vous pouvez \00E9galement ne pas d\00E9finir la valeur de votre cl\00E9 primaire.')
,p_attribute_01=>'1'
,p_attribute_02=>'SUBMIT'
,p_attribute_03=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29874226299563636.4302)
,p_name=>'P13_EXISTING_SEQUENCE'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(2163507507803153.4302)
,p_prompt=>unistr('S\00E9quence')
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_lov_display_null=>'YES'
,p_lov_null_text=>unistr('- S\00E9lectionner une s\00E9quence -')
,p_lov_null_value=>'0'
,p_cHeight=>1
,p_cAttributes=>'nowrap="nowrap"'
,p_label_alignment=>'RIGHT'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>unistr('Identifiez le nom d''une s\00E9quence de base de donn\00E9es existante qui servira \00E0 remplir la valeur de cl\00E9 primaire.')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29876013271569281.4302)
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4302)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('Identifiez le nom de la nouvelle s\00E9quence de base de donn\00E9es qui sera cr\00E9\00E9e afin de remplir cette nouvelle cl\00E9 primaire de tables.')
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(52479416748399039.4302)
,p_name=>'P13_PK1_OPTION'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(2163507507803153.4302)
,p_item_default=>'NEW_KEY'
,p_prompt=>unistr('Cl\00E9 primaire de d\00E9part :')
,p_display_as=>'NATIVE_RADIOGROUP'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>unistr('Vous pouvez s\00E9lectionner une colonne existante ou ajouter une nouvelle colonne en tant que cl\00E9 primaire.')
,p_attribute_01=>'1'
,p_attribute_02=>'SUBMIT'
,p_attribute_03=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(52483906836405605.4302)
,p_name=>'P13_PK1_2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(2163507507803153.4302)
,p_item_default=>'ID'
,p_prompt=>unistr('Nouvelle colonne de cl\00E9 primaire')
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>2000
,p_cAttributes=>'nowrap="nowrap"'
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4302)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('Saisissez le nom de la nouvelle colonne de cl\00E9 primaire.')
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29883807645586566.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(48784624982313991.4302)
,p_computation_sequence=>20
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29887722321600349.4302)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29885422537590887.4302)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29890322799609950.4302)
,p_validation_name=>'ExSEQUENCE not null'
,p_validation_sequence=>10
,p_validation=>'P13_EXISTING_SEQUENCE'
,p_validation_type=>'ITEM_NOT_ZERO'
,p_error_message=>unistr('La s\00E9quence doit \00EAtre indiqu\00E9e.')
,p_validation_condition=>'P13_PK_TYPE'
,p_validation_condition2=>'EXISTING_SEQUENCE'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154.4302)
,p_associated_item=>wwv_flow_api.id(29874226299563636.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29894220852618813.4302)
...
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154.4302)
,p_associated_item=>wwv_flow_api.id(29868930193545840.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29895317520627355.4302)
,p_validation_name=>'ExistingPK not null'
,p_validation_sequence=>30
,p_validation=>'P13_PK1'
,p_validation_type=>'ITEM_NOT_NULL_OR_ZERO'
,p_error_message=>unistr('La cl\00E9 primaire doit \00EAtre indiqu\00E9e.')
,p_validation_condition=>'P13_PK1_OPTION'
,p_validation_condition2=>'EXISTING_KEY'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154.4302)
,p_associated_item=>wwv_flow_api.id(29865802488537862.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52517420651456956.4302)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154.4302)
,p_associated_item=>wwv_flow_api.id(52483906836405605.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52521315588464886.4302)
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Le nom de la colonne de cl\00E9 primaire ne doit pas d\00E9passer 30 caract\00E8res.')
,p_validation_condition=>'P13_PK1_OPTION'
,p_validation_condition2=>'NEW_KEY'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154.4302)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52522413641473849.4302)
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Lors de sa cr\00E9ation, une nouvelle cl\00E9 primaire doit \00EAtre g\00E9n\00E9r\00E9e \00E0 partir d''une s\00E9quence.')
,p_validation_condition=>'P13_PK1_OPTION'
,p_validation_condition2=>'NEW_KEY'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154.4302)
,p_associated_item=>wwv_flow_api.id(29871919935552356.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29896704837633092.4302)
,p_validation_name=>'PK_NAME not null'
,p_validation_sequence=>70
,p_validation=>'P13_PK1_NAME'
,p_validation_type=>'ITEM_NOT_NULL_OR_ZERO'
,p_error_message=>unistr('Le nom de cl\00E9 primaire doit \00EAtre indiqu\00E9.')
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154.4302)
,p_associated_item=>wwv_flow_api.id(29868930193545840.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29898416743646038.4302)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154.4302)
,p_associated_item=>wwv_flow_api.id(29876013271569281.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(48786206675337067.4302)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937793190642890959.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937792840943888300.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937793478434890959.4302)
,p_event_id=>wwv_flow_api.id(937793190642890959.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2632715940268420.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'  ); ',
'end;'))
,p_process_when_button_id=>wwv_flow_api.id(2164724759803154.4302)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2634021612279507.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698583885660530521.4302)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(2164724759803154.4302)
,p_process_success_message=>unistr('Donn\00E9es charg\00E9es.')
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(69940020626931717.4302)
,p_process_sequence=>30
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(122951803454637884.4302)
...
wwv_flow_api.create_page(
 p_id=>22.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es - Nom et propri\00E9taire de table')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es - Nom et propri\00E9taire de table')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2166903406803173.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>unistr('<p>S\00E9lectionnez le sch\00E9ma de base de donn\00E9es et le nom de la table dans laquelle vous voulez charger des donn\00E9es.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_plug_comment=>'Region generated 20-SEP-2002 14:00:18'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3942229644856578.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(3934205141830584.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444.4302)
,p_translate_title=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208603801195601913.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937794354347915984.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208603801195601913.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2167814861803176.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208603801195601913.4302)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4117018823640385.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208603801195601913.4302)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2169404691803182.4302)
,p_branch_action=>'24'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(2167814861803176.4302)
,p_branch_sequence=>10
,p_branch_comment=>'Generated 20-SEP-2002 14:00:18'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4117328710640389.4302)
,p_branch_action=>'230'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(4117018823640385.4302)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2167519385803175.4302)
,p_name=>'F4300_P22_TABLE_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2166903406803173.4302)
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>unistr('<p>S\00E9lectionnez le sch\00E9ma de base de donn\00E9es qui est propri\00E9taire de la table dans laquelle vous voulez charger des donn\00E9es.</p>')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:18'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(236284414381765839.4302)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>unistr('<p>S\00E9lectionnez la table de base de donn\00E9es dans laquelle vous voulez charger des donn\00E9es.</p>')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3375200229249004.4302)
,p_validation_name=>'F4300_P22_TABLE_OWNER Not Null'
,p_validation_sequence=>10
,p_validation=>'F4300_P22_TABLE_OWNER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Le sch\00E9ma doit \00EAtre indiqu\00E9.')
,p_associated_item=>wwv_flow_api.id(2167519385803175.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 25-SEP-2002 14:41'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(236299719922767422.4302)
...
,p_validation_condition_type=>'ITEM_IS_NULL'
,p_when_button_pressed=>wwv_flow_api.id(2167814861803176.4302)
,p_associated_item=>wwv_flow_api.id(236284414381765839.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 25-SEP-2002 14:40'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937794586888918217.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937794354347915984.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937794833959918218.4302)
,p_event_id=>wwv_flow_api.id(937794586888918217.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(236513721363871972.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>unistr('Sch\00E9ma non valide')
,p_process_when_button_id=>wwv_flow_api.id(2167814861803176.4302)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>24.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es - D\00E9tails des fichiers')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es - D\00E9tails des fichiers')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3829922094433887.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
,p_plug_column_width=>'valign="top"'
,p_plug_header=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<label for="file-upload" class="hideMe508">T\00E9l\00E9chargement de fichier</label><p>Cette page permet de localiser le fichier \00E0 t\00E9l\00E9charger. Si la premi\00E8re ligne contient des noms de colonne, s\00E9lectionnez <b>La premi\00E8re ligne contient des noms de colonne.')
||'</b></p>',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3943707265859631.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21249425216360552.4302)
,p_plug_name=>'Globalisation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676055535817183.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208605727861609658.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937795591496921755.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208605727861609658.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3830706637433895.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208605727861609658.4302)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3830402542433895.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208605727861609658.4302)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3834709806433923.4302)
,p_branch_action=>'24'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3834410468433923.4302)
,p_branch_action=>'25'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(3830706637433895.4302)
,p_branch_sequence=>20
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3834101310433921.4302)
,p_branch_action=>'22'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(3830402542433895.4302)
,p_branch_sequence=>30
,p_branch_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3831104189433900.4302)
,p_name=>'F4300_P24_REUPLOAD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(3829922094433887.4302)
,p_use_cache_before_default=>'NO'
,p_item_default=>'N'
,p_prompt=>unistr('T\00E9l\00E9charger de nouveau un fichier')
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3831424650433904.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3832007249433909.4302)
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4302)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('<p>Cliquez sur <strong>Parcourir</strong> pour localiser le fichier \00E0 t\00E9l\00E9charger.</p>')
,p_attribute_01=>'WWV_FLOW_FILES'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3832316073433910.4302)
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>S\00E9lectionnez cette option si la premi\00E8re ligne des donn\00E9es contient des noms de colonne. Exemple :</p>'),
'<pre>',
'Nom      Salaire    Commission',
'Clark    1000       10',
'Scott    2000       20',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3832614597433912.4302)
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4302)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('<p>Identifiez un caract\00E8re de s\00E9paration de colonnes. Utilisez <strong>\005Ct</strong> pour les s\00E9parateurs d''onglets.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3832902320433912.4302)
...
,p_field_template=>wwv_flow_api.id(716619902812799716.4302)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('<p>Identifiez un caract\00E8re \00E9ventuellement d\00E9limit\00E9 par.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21250401452363148.4302)
,p_name=>'P24_CURRENCY'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(21249425216360552.4302)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_return_val varchar2(30) := ''$'';',
'begin',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21979404565582755.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21983213138604079.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(143065000827740153.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(514942629282998822.4302)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(3835011019433929.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49535021883702753.4302)
,p_computation_sequence=>20
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(3835314069433929.4302)
,p_computation_sequence=>30
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3835908087433932.4302)
,p_validation_name=>'file name not null'
,p_validation_sequence=>10
,p_validation=>'F4300_P22_FILE'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Le fichier doit \00EAtre indiqu\00E9.')
,p_when_button_pressed=>wwv_flow_api.id(3830706637433895.4302)
,p_associated_item=>wwv_flow_api.id(3832007249433909.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937795797046923768.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937795591496921755.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937796033082923768.4302)
,p_event_id=>wwv_flow_api.id(937795797046923768.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514942747761998823.4302)
,p_name=>'get Preview'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942957612998825.4302)
,p_event_id=>wwv_flow_api.id(514942747761998823.4302)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514943056692998826.4302)
,p_event_id=>wwv_flow_api.id(514942747761998823.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514942843162998824.4302)
,p_event_id=>wwv_flow_api.id(514942747761998823.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514943111796998827.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514943293338998828.4302)
,p_event_id=>wwv_flow_api.id(514943111796998827.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_DISABLE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(514943352636998829.4302)
,p_name=>'Refresh Preview'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(514943486298998830.4302)
,p_event_id=>wwv_flow_api.id(514943352636998829.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3836525951433937.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'create table info collection'
...
'end;'))
,p_process_error_message=>unistr('Erreur lors de la cr\00E9ation de la collection au moyen des donn\00E9es charg\00E9es.')
,p_process_when_button_id=>wwv_flow_api.id(3830706637433895.4302)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>25.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es - Mapping de colonne')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es - Mapping de colonne')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3379027934257020.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>Cette page pr\00E9sente les donn\00E9es telles qu''elles seront charg\00E9es. Mettez en correspondance les noms de colonne de la base de donn\00E9es et les colonnes des donn\00E9es. Pour t\00E9l\00E9charger les colonnes, s\00E9lectionnez <b>Oui</b> ou <b>Non</b>. Les colonnes obl')
||unistr('igatoires sont signal\00E9es par un ast\00E9risque (*). Pour t\00E9l\00E9charger des donn\00E9es vers la table s\00E9lectionn\00E9e, cliquez sur <b>Charger les donn\00E9es</b>.</p> '),
'<!--',
'<p>Utilisez SQL Workshop pour modifier les attributs de table, par exemple pour modifier la taille des colonnes, rendre des colonnes non NULL ou modifier leur type.</p> ',
'-->',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3382431874267620.4302)
,p_plug_name=>unistr('D\00E9finir un mapping de colonne')
,p_region_name=>'dataload_properties'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
'    );'))
,p_plug_source_type=>'NATIVE_PLSQL'
,p_plug_query_row_template=>wwv_flow_api.id(7082409118250737.4302)
,p_plug_query_num_rows=>15
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3944611767860950.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208608528123628623.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937797370499933217.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208608528123628623.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3749803794082687.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208608528123628623.4302)
,p_button_name=>'FINISH'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3748622363078595.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208608528123628623.4302)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3748901903078596.4302)
,p_branch_action=>'24'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(3748622363078595.4302)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3753406349092940.4302)
,p_name=>'F4300_P25_TABLE_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3379027934257020.4302)
,p_use_cache_before_default=>'NO'
,p_prompt=>unistr('Sch\00E9ma :')
...
,p_escape_on_http_output=>'N'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>unistr('Sch\00E9ma propri\00E9taire de la table dans laquelle charger les donn\00E9es.')
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3754218816096550.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3872807706566435.4302)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(3874326752571910.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3758426912108293.4302)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Les noms de colonne ne peuvent pas avoir la valeur Null.'
,p_when_button_pressed=>wwv_flow_api.id(3749803794082687.4302)
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3759521849116267.4302)
,p_validation_name=>'at least one upload selected'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Au moins une colonne doit \00EAtre indiqu\00E9e pour t\00E9l\00E9charger les donn\00E9es.')
,p_when_button_pressed=>wwv_flow_api.id(3749803794082687.4302)
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3762021418135076.4302)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Il y a des colonnes NOT NULL dans &F4300_P22_TABLE_OWNER..&F4300_P22_TABLE_NAME.. Effectuez une s\00E9lection pour que le t\00E9l\00E9chargement des donn\00E9es s''effectue sans erreur.')
,p_when_button_pressed=>wwv_flow_api.id(3749803794082687.4302)
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(3804414642293989.4302)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('S\00E9lection de noms de colonne en double.')
,p_when_button_pressed=>wwv_flow_api.id(3749803794082687.4302)
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937797560733935376.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937797370499933217.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937797853562935376.4302)
,p_event_id=>wwv_flow_api.id(937797560733935376.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3813707079395907.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insert data'
...
'   );',
'end;'))
,p_process_error_message=>unistr('Erreur lors de l''insertion des donn\00E9es.')
,p_process_when_button_id=>wwv_flow_api.id(3749803794082687.4302)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584313626530526.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432755516873085837.4302)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(122950027302616323.4302)
,p_process_sequence=>30
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'security check'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(242928263721.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(341984427776830221.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(944846820724951476.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(341984427776830221.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(242954438477.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(341984427776830221.4302)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(242922263709.4302)
,p_branch_name=>'Go To Page 90'
,p_branch_action=>'f?p=&APP_ID.:90:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(242954438477.4302)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(242926263712.4302)
,p_name=>'F4300_P90_XML_EXPORT_COLUMNS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(242928263721.4302)
,p_prompt=>'Colonnes'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73486104619415064.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(196680604705342464.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(254954327846848756.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(254973402004850698.4302)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(241192503550535804.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(255090131917868798.4302)
...
,p_validation_condition_type=>'ITEM_IS_NULL_OR_ZERO'
,p_when_button_pressed=>wwv_flow_api.id(242954438477.4302)
,p_associated_item=>wwv_flow_api.id(254973402004850698.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(61180608448820628.4302)
...
,p_when_button_pressed=>wwv_flow_api.id(242954438477.4302)
,p_associated_item=>wwv_flow_api.id(242926263712.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(99812303853555653.4302)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(255075127415867567.4302)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(944847063502954022.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(944846820724951476.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(944847397350954024.4302)
,p_event_id=>wwv_flow_api.id(944847063502954022.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(242990422910.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
''))
,p_process_when_button_id=>wwv_flow_api.id(242954438477.4302)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584852702530531.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432755700382090489.4302)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432755918043095637.4302)
,p_process_sequence=>30
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330053465240161850.4302)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(3778470772251502290.4302)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165285158264988786.4302)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_hidden_column=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165287955834988791.4302)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165285524623988787.4302)
,p_query_column_id=>3
,p_column_alias=>'NAME'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165285973857988788.4302)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(641957658752558630.4302)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165287145567988790.4302)
,p_query_column_id=>6
,p_column_alias=>'SCHEMA'
,p_column_display_sequence=>6
,p_column_heading=>unistr('Sch\00E9ma')
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165286394141988788.4302)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(164835701829930737.4302)
,p_query_column_id=>8
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164832857367930708.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164832997966930709.4302)
,p_event_id=>wwv_flow_api.id(164832857367930708.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164833090606930710.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164833102194930711.4302)
,p_event_id=>wwv_flow_api.id(164833090606930710.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164834970156930729.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164835041955930730.4302)
,p_event_id=>wwv_flow_api.id(164834970156930729.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164833255037930712.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164833301631930713.4302)
,p_event_id=>wwv_flow_api.id(164833255037930712.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164833425409930714.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164833531975930715.4302)
,p_event_id=>wwv_flow_api.id(164833425409930714.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164835187682930731.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164835243210930732.4302)
,p_event_id=>wwv_flow_api.id(164835187682930731.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(164835865574930738.4302)
,p_name=>'Close Dialog'
,p_event_sequence=>70
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(3778470772251502290.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(164835904250930739.4302)
,p_event_id=>wwv_flow_api.id(164835865574930738.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(3778470772251502290.4302)
,p_stop_execution_on_error=>'Y'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330021358989147650.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330022012396147656.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(494815871075820816.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3778445591701489866.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165267847428976362.4302)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(494815871075820816.4302)
,p_button_name=>'Cancel'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165268233939976362.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(494815871075820816.4302)
,p_button_name=>'Next'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165267451506976361.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(494815871075820816.4302)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(165276015613976370.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165259372494976347.4302)
,p_name=>'P110_WWV_SAMPLE_DATASET_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3778445591701489866.4302)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165259735050976348.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165260108947976348.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165260576622976348.4302)
,p_name=>'P110_SCHEMA'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(3778445591701489866.4302)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165260905911976349.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165261302805976349.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165261787301976351.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165262159006976351.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165262515243976351.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165263205345976352.4302)
,p_name=>'P110_INSTALL_LANGUAGE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(330022012396147656.4302)
,p_prompt=>'Langue'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165263690720976357.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165264335101976358.4302)
,p_name=>'P110_CURRENT_LANGUAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(330021358989147650.4302)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165264703771976358.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165265534088976359.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165265928698976360.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165266396519976360.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165266788350976360.4302)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165270521898976364.4302)
,p_name=>'Set Language (Install)'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165271086377976366.4302)
,p_event_id=>wwv_flow_api.id(165270521898976364.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165271422717976366.4302)
,p_name=>'Set Language (New)'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165271921726976367.4302)
,p_event_id=>wwv_flow_api.id(165271422717976366.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165274107396976368.4302)
,p_name=>'Set Language (New) To Null'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P110_NEW_LANGUAGE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165274652074976368.4302)
,p_event_id=>wwv_flow_api.id(165274107396976368.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165272323947976367.4302)
,p_name=>'Set Schema (Install)'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165272816965976367.4302)
,p_event_id=>wwv_flow_api.id(165272323947976367.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165273218983976368.4302)
,p_name=>'Set Schema (New)'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165273756466976368.4302)
,p_event_id=>wwv_flow_api.id(165273218983976368.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(165275094457976369.4302)
,p_name=>'Set Schema (New) to Null'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P110_NEW_SCHEMA'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(165275579663976369.4302)
,p_event_id=>wwv_flow_api.id(165275094457976369.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(688504349584608701.4302)
,p_name=>'Close Dialog'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(165267847428976362.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(688504404058608702.4302)
,p_event_id=>wwv_flow_api.id(688504349584608701.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165268929551976363.4302)
,p_process_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165269327216976364.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165269742263976364.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(165267451506976361.4302)
,p_process_success_message=>unistr('Ensemble de donn\00E9es enlev\00E9.')
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165270191879976364.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330011953426141488.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330012048288141489.4302)
,p_plug_name=>'Boutons d''assistant'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330012499418141494.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165249902570970173.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(330012048288141489.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165250361689970173.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(330012048288141489.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165250702403970174.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165251165088970174.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165251539054970174.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165249149475970172.4302)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(330012048288141489.4302)
,p_button_name=>'Previous'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165249541794970173.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(330012048288141489.4302)
,p_button_name=>'Cancel'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(165257051790970189.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100577660782284434.4302)
,p_name=>'P120_WWV_SAMPLE_JSON_ID'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(330012499418141494.4302)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165252242208970175.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165252654670970178.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165253069432970179.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165253486682970179.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165253804915970179.4302)
,p_name=>'P120_ACTION'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(330012499418141494.4302)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165254296586970179.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165254618700970180.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165255026129970182.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(165255412190970183.4302)
,p_name=>'P120_SCHEMA'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(330012499418141494.4302)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(688504543571608703.4302)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(165249541794970173.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(688504660736608704.4302)
,p_event_id=>wwv_flow_api.id(688504543571608703.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CLOSE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165256108353970184.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(165256583211970188.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(330008940251134479.4302)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(330077439097893864.4302)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165244053073963194.4302)
,p_query_column_id=>1
,p_column_alias=>'NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Nom'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(165244494381963196.4302)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(494820662196439205.4302)
,p_plug_name=>'Boutons d''assistant'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(165245577956963204.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(494820662196439205.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(57831151733033944.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(494820662196439205.4302)
,p_button_name=>'FINISH'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(57831237009033945.4302)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(57831151733033944.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(57831397741033946.4302)
,p_event_id=>wwv_flow_api.id(57831237009033945.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CLOSE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(27155313458825518.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(27155716362825519.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(104358211508848205.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444.4302)
,p_translate_title=>'N'
,p_plug_query_num_rows_type=>'ROWS_X_TO_Y_OF_Z'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208611722282655337.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(250661318515297280.4302)
,p_name=>unistr('Les colonnes ne permettent pas de d\00E9chargement.')
,p_template=>wwv_flow_api.id(716676747173817184.4302)
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_display_point=>'BODY'
...
,p_display_condition_type=>'EXISTS'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(10583525904875984.4302)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(250661515424297282.4302)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(250661627810297284.4302)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(250661730665297284.4302)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(250661827095297284.4302)
,p_query_column_id=>4
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(940815743000894347.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208611722282655337.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(27154700232825500.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208611722282655337.4302)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(27154924917825505.4302)
,p_branch_action=>'180'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(27154700232825500.4302)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(27155123411825508.4302)
,p_name=>'F4300_P150_SCHEMA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(27155313458825518.4302)
,p_prompt=>unistr('Sch\00E9ma')
,p_source=>'wwv_flow_user_api.get_default_schema'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(249987629719234198.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(250371231151263023.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(250444929550272065.4302)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(250598322886289033.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(65600608761173558.4302)
,p_validation_name=>'schema not null'
,p_validation_sequence=>10
,p_validation=>'F4300_P150_SCHEMA'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Le sch\00E9ma doit \00EAtre indiqu\00E9.')
,p_when_button_pressed=>wwv_flow_api.id(27154700232825500.4302)
,p_associated_item=>wwv_flow_api.id(27155123411825508.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(250138105739246184.4302)
...
,p_validation_condition_type=>'ITEM_IS_NULL_OR_ZERO'
,p_when_button_pressed=>wwv_flow_api.id(27154700232825500.4302)
,p_associated_item=>wwv_flow_api.id(249987629719234198.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(250624431197291449.4302)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(940816209580897014.4302)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(940815743000894347.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(940816584358897016.4302)
,p_event_id=>wwv_flow_api.id(940816209580897014.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432756705015101278.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432756921291105974.4302)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(27163003595914791.4302)
,p_plug_name=>unistr('D\00E9charger au format texte')
,p_region_template_options=>'#DEFAULT#:a-Form--fixedLabels'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(27163907693981199.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208613222760664930.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(941533206074201078.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208613222760664930.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(27163504640971637.4302)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(208613222760664930.4302)
,p_button_name=>'EXPORTDATA'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(27164230828990784.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208613222760664930.4302)
,p_button_name=>'previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(151088609408189516.4302)
,p_branch_action=>'f?p=&APP_ID.:180:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(27163504640971637.4302)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(27164522069990788.4302)
,p_branch_action=>'150'
,p_branch_point=>'BEFORE_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(27164230828990784.4302)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5580720856115889.4302)
,p_name=>'F4300_P180_INC_COLUMN_NAME'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(27163003595914791.4302)
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>unistr('Si vous voulez exporter les donn\00E9es avec les noms de colonne, cochez cet \00E9l\00E9ment.')
,p_attribute_01=>'1'
,p_attribute_02=>'VERTICAL'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(27163402948965482.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(142827824937224518.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(143184623384792499.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(162884825010392552.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(196667304565257203.4302)
,p_name=>'P180_TABLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(27163003595914791.4302)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(941533402851204296.4302)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(941533206074201078.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(941533765949204298.4302)
,p_event_id=>wwv_flow_api.id(941533402851204296.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1155235261732489540.4302)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1155235386805489541.4302)
,p_event_id=>wwv_flow_api.id(1155235261732489540.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DISABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(27163504640971637.4302)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(27164904458230351.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(27163504640971637.4302)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584798226530530.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(196670309198268035.4302)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(196684208130390717.4302)
,p_process_sequence=>30
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'validate schema'
...
wwv_flow_api.create_page(
 p_id=>200.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es - Donn\00E9es')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es - Donn\00E9es')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21272823578416828.4302)
,p_plug_name=>'Globalisation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676055535817183.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112725909100220750.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(208585513765537107.4302)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>unistr('<p>Copiez les donn\00E9es que vous voulez charger \00E0 partir d''un tableur tel que Microsoft Excel et collez-les dans le champ Donn\00E9es.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112730325478228304.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(112716503290208213.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444.4302)
,p_translate_title=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208614921852674151.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937840947040120496.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208614921852674151.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(112736203452235067.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208614921852674151.4302)
,p_button_name=>'NEXT'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204374305269310796.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208614921852674151.4302)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(51886005938559488.4302)
,p_branch_action=>'210'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(112736203452235067.4302)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204374726822310798.4302)
,p_branch_action=>'230'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(204374305269310796.4302)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4208210436082721.4302)
,p_name=>'F4300_P200_SEPARATOR'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(112725909100220750.4302)
,p_item_default=>'\t'
,p_prompt=>unistr('S\00E9parateur')
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>2
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4302)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>unistr('<p>Identifiez un caract\00E8re de s\00E9paration de colonnes. Utilisez <strong>\005Ct</strong> pour les s\00E9parateurs d''onglets et <strong>,</strong> pour les s\00E9parateurs de virgules.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
,p_reference_id=>3832614597433912.4302
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4209527059087470.4302)
,p_name=>'F4300_P200_ENCLOSED_BY'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(112725909100220750.4302)
,p_prompt=>unistr('D\00E9limit\00E9 par')
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>2
,p_cMaxlength=>2
,p_display_when=>'F4300_P230_LOAD_TYPE'
...
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
,p_reference_id=>3832902320433912.4302
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21275331197419000.4302)
,p_name=>'P200_CURRENCY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(21272823578416828.4302)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_return_val varchar2(30) := ''$'';',
'begin',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21710714544355494.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21713607056362785.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112740117271247331.4302)
,p_name=>'F4300_P200_EXCEL_DATA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(112725909100220750.4302)
,p_prompt=>unistr('Donn\00E9es')
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>80
,p_cHeight=>10
,p_tag_attributes=>'spellcheck="false"'
,p_field_template=>wwv_flow_api.id(716620262276799717.4302)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>unistr('Copiez et collez les donn\00E9es que vous voulez charger \00E0 partir d''un tableur.')
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112749902593269315.4302)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49528010062670927.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(118390630315447740.4302)
,p_validation_name=>'data not null'
,p_validation_sequence=>10
,p_validation=>'F4300_P200_EXCEL_DATA'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Les donn\00E9es doivent \00EAtre indiqu\00E9es.')
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_api.id(112740117271247331.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4210720957095218.4302)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(112736203452235067.4302)
,p_associated_item=>wwv_flow_api.id(4208210436082721.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(1856338767985918224.4302)
...
,p_error_message=>unistr('Les donn\00E9es coll\00E9es sont trop volumineuses. Enregistrez le fichier dans un format \00E0 d\00E9limitation par des virgules (csv) ou des tabulations. T\00E9l\00E9chargez ensuite le fichier pour charger les donn\00E9es.')
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937841145052122532.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937840947040120496.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937841453405122532.4302)
,p_event_id=>wwv_flow_api.id(937841145052122532.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(117624930761654964.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'   );',
'end;'))
,p_process_error_message=>unistr('Erreur lors du chargement des donn\00E9es Excel.')
,p_process_when_button_id=>wwv_flow_api.id(112736203452235067.4302)
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112768526710303685.4302)
,p_plug_name=>unistr('D\00E9finir des propri\00E9t\00E9s de table')
,p_region_name=>'dataload_properties'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112771111398310853.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112785418706337777.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#:a-Form--fixedLabels'
,p_component_template_options=>'#DEFAULT#'
...
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_header=>unistr('<p>Cette page pr\00E9sente la table telle qu''elle sera d\00E9finie. Saisissez un nom de table, puis v\00E9rifiez les noms de colonne, les types de donn\00E9es et les longueurs de colonne. Pour t\00E9l\00E9charger des colonnes, s\00E9lectionnez <b>Oui</b> ou <b>Non</b>.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208626820868128034.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937846775380244224.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208626820868128034.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(116940415820894908.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208626820868128034.4302)
,p_button_name=>'Next'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(112777203593320251.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208626820868128034.4302)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(116940829853894912.4302)
,p_branch_action=>'220'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(116940415820894908.4302)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(112777626990320254.4302)
,p_branch_name=>'Go To Page 200'
,p_branch_action=>'f?p=&APP_ID.:200:&SESSION.::&DEBUG.:RP,CLOB_CONTENT::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(112777203593320251.4302)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(77784300806046762.4302)
,p_name=>'P210_PRESERVE_CASE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(112785418706337777.4302)
,p_prompt=>'Respecter maj/min'
,p_display_as=>'NATIVE_CHECKBOX'
,p_named_lov=>'PRESERVE.CASE.Y'
,p_lov=>'.'||wwv_flow_api.id(87931511182663028)||'.'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100051613844477110.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112792123870350640.4302)
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>unistr('S\00E9lectionnez le sch\00E9ma de base de donn\00E9es que vous voulez cr\00E9er et dans lequel vous voulez charger des donn\00E9es.')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112794014812354843.4302)
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>unistr('<div class="htmldbInfoBodyP">Identifiez le nom de la table que vous voulez cr\00E9er. Par d\00E9faut, tous les noms de table sont convertis en majuscules. S\00E9lectionnez <span class="fielddatabold">Respecter maj/min</span> pour \00E9viter cette conversion par d\00E9fa')
||'ut.</div>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(77787115351050931.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(100053005864480800.4302)
,p_computation_sequence=>20
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(114893927053188792.4302)
,p_validation_name=>'column name not null, not > 30 (11g) or > 128 (12.2)'
,p_validation_sequence=>10
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(118154731285520466.4302)
,p_validation_name=>'table name not > 30 (11g) or > 128 (12.2)'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_api.id(112794014812354843.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(91385502544995259.4302)
,p_validation_name=>'column length not zero or null'
,p_validation_sequence=>30
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(114895819289192431.4302)
,p_validation_name=>'table name not null'
,p_validation_sequence=>40
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(115047225043539180.4302)
,p_validation_name=>'cannot have same table name'
,p_validation_sequence=>50
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'if wwv_flow_load_excel_data.table_exists(',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(117872306579291939.4302)
,p_validation_name=>'at least one upload selected'
,p_validation_sequence=>70
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Au moins une colonne \00E0 inclure dans la nouvelle table doit \00EAtre indiqu\00E9e. ')
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(289728718255300356.4302)
,p_validation_name=>'reserved name'
,p_validation_sequence=>80
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(291055332677788667.4302)
,p_validation_name=>'column name reserved word'
,p_validation_sequence=>90
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(25730909453566476.4302)
,p_validation_name=>'F4300_P200_OWNER'
,p_validation_sequence=>100
,p_validation=>'F4300_P200_OWNER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Le sch\00E9ma doit \00EAtre indiqu\00E9.')
,p_when_button_pressed=>wwv_flow_api.id(116940415820894908.4302)
,p_associated_item=>wwv_flow_api.id(112792123870350640.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(460448021945064666.4302)
...
'return TRUE;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Il existe au moins un nom de colonne en double.'
,p_when_button_pressed=>wwv_flow_api.id(116940415820894908.4302)
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937847166341246211.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937846775380244224.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937847496378246211.4302)
,p_event_id=>wwv_flow_api.id(937847166341246211.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432757616574114106.4302)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(117056604391055559.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(117059228102059736.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208627826540139171.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937848432173255988.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208627826540139171.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(117073012899083351.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208627826540139171.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(117070800779079776.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208627826540139171.4302)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(117073412886083354.4302)
,p_branch_action=>'11'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(117073012899083351.4302)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(29278228032445971.4302)
,p_branch_action=>'220'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>20
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(52010014229160977.4302)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(117071203531079778.4302)
,p_branch_action=>'210'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(117070800779079776.4302)
,p_branch_sequence=>40
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29225226404227933.4302)
,p_name=>'P200_PK1_NAME'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(117056604391055559.4302)
,p_prompt=>'Nom de contrainte'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>2000
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29231303248249589.4302)
,p_name=>'P200_PK_TYPE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(117056604391055559.4302)
,p_item_default=>'NEW_SEQUENCE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29236325197265446.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29241232039286358.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(52007705655139616.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(52012902417204955.4302)
,p_name=>'P200_PK1_2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(117056604391055559.4302)
,p_item_default=>'ID'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Saisissez le nom de la nouvelle colonne permettant d''identifier la ligne dans la table.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(117095028927104885.4302)
,p_name=>'P220_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(117056604391055559.4302)
,p_use_cache_before_default=>'NO'
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>unistr('Sch\00E9ma propri\00E9taire de la table.')
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(117097720517108862.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(117102827837120664.4302)
,p_name=>'P200_PK1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(117056604391055559.4302)
,p_prompt=>unistr('Cl\00E9 primaire')
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(13590021101989074.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29253014255347439.4302)
,p_computation_sequence=>20
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29250213170318666.4302)
,p_computation_sequence=>30
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(29248007498307620.4302)
,p_computation_sequence=>40
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29254418196358029.4302)
...
,p_validation_condition2=>'EXISTING_SEQUENCE'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351.4302)
,p_associated_item=>wwv_flow_api.id(29236325197265446.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29266319281386761.4302)
,p_validation_name=>'PK_NAME available'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'Erreur.'
,p_associated_item=>wwv_flow_api.id(29225226404227933.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52417430985005732.4302)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351.4302)
,p_associated_item=>wwv_flow_api.id(117102827837120664.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52419018303011469.4302)
,p_validation_name=>'PK not null'
,p_validation_sequence=>40
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351.4302)
,p_associated_item=>wwv_flow_api.id(52012902417204955.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52420808391018166.4302)
,p_validation_name=>'PK not > 30 chars'
,p_validation_sequence=>50
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(52424804066054749.4302)
,p_validation_name=>'PK gen option needs to be auto'
,p_validation_sequence=>60
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351.4302)
,p_associated_item=>wwv_flow_api.id(29231303248249589.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29270400759419169.4302)
,p_validation_name=>'PK_NAME not null'
,p_validation_sequence=>70
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(29274101928429039.4302)
,p_validation_name=>'SEQ_NAME available'
,p_validation_sequence=>80
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(117073012899083351.4302)
,p_associated_item=>wwv_flow_api.id(29241232039286358.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(48704226490898036.4302)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937848654142258327.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937848432173255988.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937848917746258327.4302)
,p_event_id=>wwv_flow_api.id(937848654142258327.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(117113015507171948.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'  );',
'end;'))
,p_process_error_message=>unistr('Erreur lors de la cr\00E9ation de la table.')
,p_process_when_button_id=>wwv_flow_api.id(117073012899083351.4302)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(117884026167328458.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insert data'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584506824530528.4302)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432758606662120691.4302)
,p_process_sequence=>30
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page(
 p_id=>230.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es - Cible et m\00E9thode')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es - Cible et m\00E9thode')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23238502857624260.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204342305194256542.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208631500137150436.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(755293959966836805.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208631500137150436.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204360203968291570.4302)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(208631500137150436.4302)
,p_button_name=>'Next'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4107407002608653.4302)
,p_branch_action=>'f?p=&APP_ID.:18:&SESSION.::&DEBUG.:18,19,21::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(204360203968291570.4302)
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(101365129882269401.4302)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(7218508617368954.4302)
,p_branch_name=>'Go To Page 200'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(7222330435375211.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4077631590265585.4302)
,p_name=>'F4300_P230_LOAD_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(204342305194256542.4302)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4085714930308101.4302)
,p_name=>'F4300_P230_LOAD_TO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(204342305194256542.4302)
,p_item_default=>'NEW'
,p_prompt=>'Charger vers :'
,p_display_as=>'NATIVE_RADIOGROUP'
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>unistr('Choisissez o\00F9 charger vos donn\00E9es. Si la table de base de donn\00E9es existe, choisissez Table existante. Si vous voulez qu''une nouvelle table soit cr\00E9\00E9e, choisissez Nouvelle table.')
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4087612637316960.4302)
,p_name=>'F4300_P230_LOAD_FROM'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(204342305194256542.4302)
,p_item_default=>'PASTE'
,p_prompt=>unistr('Charger \00E0 partir de :')
,p_display_as=>'NATIVE_RADIOGROUP'
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>unistr('Indiquez si les donn\00E9es doivent \00EAtre t\00E9l\00E9charg\00E9es \00E0 partir d''un fichier ou copi\00E9es et coll\00E9es \00E0 partir d''une feuille de calcul.')
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(144922211438995306.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(755294096977836806.4302)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(755293959966836805.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(755294125459836807.4302)
,p_event_id=>wwv_flow_api.id(755294096977836806.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_api.id(215729525348581243)
,p_step_template=>wwv_flow_api.id(716604580917788355.4302)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_attributes=>'resizable:true,minWidth:500,minHeight:400'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'AEUTL/sql_utl_imprt.htm'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204401222157339825.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204716203535971465.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(204693724897946351.4302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(716635374633805444.4302)
,p_translate_title=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208632630958159342.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937854111825355772.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208632630958159342.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204420610772359727.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208632630958159342.4302)
,p_button_name=>'Next'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204423219430362194.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208632630958159342.4302)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204421016156359729.4302)
,p_branch_name=>'Go To Page 270'
,p_branch_action=>'f?p=&APP_ID.:270:&SESSION.::&DEBUG.:RP,CLOB_CONTENT::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(204420610772359727.4302)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204423618157362195.4302)
,p_branch_action=>'230'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(204423219430362194.4302)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204430218669387043.4302)
,p_name=>'F4300_P240_TABLE_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(204401222157339825.4302)
,p_prompt=>unistr('Propri\00E9taire de table')
,p_source=>'wwv_flow_user_api.get_default_schema'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_SELECT_LIST'
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>unistr('Indiquez le sch\00E9ma de base de donn\00E9es propri\00E9taire de la table dans laquelle vous voulez charger des donn\00E9es Excel.')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(246102019809840383.4302)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>unistr('Choisissez  la table de base de donn\00E9es dans laquelle vous voulez charger des donn\00E9es. Par d\00E9faut, tous les noms de table sont convertis en majuscules. S\00E9lectionnez <span class="fielddatabold">Respecter maj/min</span> pour \00E9viter cette conversion par')
||unistr(' d\00E9faut.')
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(204445117363402835.4302)
,p_validation_name=>'F4300_P240_TABLE_OWNER Not Null'
,p_validation_sequence=>10
,p_validation=>'F4300_P240_TABLE_OWNER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Le propri\00E9taire de table doit \00EAtre indiqu\00E9.')
,p_associated_item=>wwv_flow_api.id(204430218669387043.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 16-APR-2002 11:44'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(249092017542126655.4302)
,p_validation_name=>'Table Name Must Be Selected'
,p_validation_sequence=>20
...
,p_validation_condition_type=>'ITEM_IS_NULL_OR_ZERO'
,p_when_button_pressed=>wwv_flow_api.id(204420610772359727.4302)
,p_associated_item=>wwv_flow_api.id(246102019809840383.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937854390691357948.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937854111825355772.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937854626445357948.4302)
,p_event_id=>wwv_flow_api.id(937854390691357948.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page(
 p_id=>260.4302
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4302)
,p_name=>unistr('Charger les donn\00E9es')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Charger les donn\00E9es')
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204491026143474742.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#:a-Form--fixedLabels'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
,p_plug_display_point=>'BODY'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>unistr('<p>Cette page pr\00E9sente les donn\00E9es telles qu''elles seront charg\00E9es. Etablissez des correspondances entre les noms de colonne de la base de donn\00E9es et les colonnes des donn\00E9es. Pour t\00E9l\00E9charger les colonnes, s\00E9lectionnez <b>Oui</b> ou <b>Non</b>. Les ')
||unistr('colonnes obligatoires sont signal\00E9es par un ast\00E9risque (*). Pour t\00E9l\00E9charger des donn\00E9es dans la table s\00E9lectionn\00E9e, cliquez sur <b>Charger les donn\00E9es</b>.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204502624837490516.4302)
,p_plug_name=>unistr('D\00E9finir un mapping de colonne')
,p_region_name=>'dataload_properties'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204723028108975231.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208634426933167651.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937859839834424223.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208634426933167651.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204499923557486442.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208634426933167651.4302)
,p_button_name=>'LOAD_SPREADSHEET'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204496812129483108.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208634426933167651.4302)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204500300920486444.4302)
,p_branch_name=>'Go To Page 11'
,p_branch_action=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:RP:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(204499923557486442.4302)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204497212696483110.4302)
,p_branch_name=>'Go To Page 270'
,p_branch_action=>'f?p=&APP_ID.:270:&SESSION.::&DEBUG.:RP,CLOB_CONTENT::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(204496812129483108.4302)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3876124806580817.4302)
,p_name=>'F4300_P260_DUMMY'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(204491026143474742.4302)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204576022341643606.4302)
...
,p_escape_on_http_output=>'N'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>unistr('Nom du propri\00E9taire de la table')
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204580511127648778.4302)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(3877004851584509.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(1970910321700429.4302)
,p_validation_name=>'column name not null'
,p_validation_sequence=>10
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(1976413962729112.4302)
,p_validation_name=>'at least one upload selected'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Au moins une colonne \00E0 inclure doit \00EAtre indiqu\00E9e pour t\00E9l\00E9charger les donn\00E9es.')
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2246727491917184.4302)
,p_validation_name=>'not null columns must be loaded'
,p_validation_sequence=>30
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('Il y a des colonnes NOT NULL dans &F4300_P240_TABLE_OWNER..&F4300_P250_TABLE_NAME.. Effectuez une s\00E9lection pour que le t\00E9l\00E9chargement des donn\00E9es s''effectue sans erreur.')
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2416102541642929.4302)
,p_validation_name=>'duplicate column names'
,p_validation_sequence=>40
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937860168589426014.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937859839834424223.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937860430093426015.4302)
,p_event_id=>wwv_flow_api.id(937860168589426014.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1998328769813398.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insert data'
...
'end;'))
,p_process_error_message=>unistr('Erreur lors de l''insertion des donn\00E9es.')
,p_process_when_button_id=>wwv_flow_api.id(204499923557486442.4302)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(698584417528530527.4302)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Modal'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(432759525709126193.4302)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Validate Schema'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21176307696090495.4302)
,p_plug_name=>'Globalisation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676055535817183.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204523926135583458.4302)
,p_plug_name=>unistr('Charger les donn\00E9es')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
,p_plug_display_point=>'BODY'
,p_plug_column_width=>'valign="top"'
,p_plug_header=>unistr('<p>Copiez les donn\00E9es que vous voulez importer \00E0 partir d''un tableur tel que Microsoft Excel et collez-les dans le champ Donn\00E9es.</p>')
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204526605078583471.4302)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716676747173817184.4302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(208636709187181466.4302)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(716643236475817156.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(937854870258362997.4302)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(208636709187181466.4302)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(716616681872794730.4302)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204524413345583460.4302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(208636709187181466.4302)
,p_button_name=>'NEXT'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(204524712263583462.4302)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(208636709187181466.4302)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204526930972583473.4302)
,p_branch_action=>'260'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(204527202242583475.4302)
,p_branch_action=>'240'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'BRANCH_TO_STEP'
,p_branch_when_button_id=>wwv_flow_api.id(204524712263583462.4302)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4182706815845162.4302)
,p_name=>'F4300_P270_SEPARATOR'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(204523926135583458.4302)
,p_item_default=>','
,p_prompt=>unistr('S\00E9parateur')
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>2
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4184502444853276.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21177230552097084.4302)
,p_name=>'P270_CURRENCY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(21176307696090495.4302)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_return_val varchar2(30) := ''$'';',
'begin',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21863704163128428.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21865509835139517.4302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204525129697583464.4302)
...
,p_field_template=>wwv_flow_api.id(716620262276799717.4302)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>unistr('Vous pouvez coller dans ce champ jusqu''\00E0 30 ko de donn\00E9es.')
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(204525430553583465.4302)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49537626170713419.4302)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4186717812867171.4302)
,p_validation_name=>'separator not null'
,p_validation_sequence=>10
...
,p_validation_condition2=>'CSV'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(4182706815845162.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(83593200492080009.4302)
,p_validation_name=>'clob collection exists'
,p_validation_sequence=>20
,p_validation=>'select null from apex_collections where collection_name=''CLOB_CONTENT'';'
,p_validation_type=>'EXISTS'
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_when_button_pressed=>wwv_flow_api.id(204524413345583460.4302)
,p_associated_item=>wwv_flow_api.id(.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(204527804107583477.4302)
,p_validation_name=>'data not null'
,p_validation_sequence=>30
,p_validation=>'F4300_P270_EXCEL_DATA'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>unistr('Les donn\00E9es doivent \00EAtre indiqu\00E9es.')
,p_associated_item=>wwv_flow_api.id(204525129697583464.4302)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(937856058957374906.4302)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(937854870258362997.4302)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(937856350408374907.4302)
,p_event_id=>wwv_flow_api.id(937856058957374906.4302)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(204528110232583479.4302)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'read collection and get table info'
