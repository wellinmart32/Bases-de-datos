...
,p_default_application_id=>4550
,p_default_owner=>'APEX_180200'
);
end;
/
 
prompt APPLICATION 4550 - Oracle APEX Login
--
-- Application Export:
--   Application:     4550
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,4550)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'LOGIN')
...
,p_checksum_salt_last_reset=>'20180725055800'
...
,p_documentation_banner=>'Oracle Application Express (APEX) developer login and password management application.'
,p_authentication=>'PLUGIN'
,p_authentication_id=>wwv_flow_api.id(540118315091694248)
,p_populate_roles=>'A'
...
,p_flow_version=>'&PRODUCT_NAME. 18.2.0.00.01'
...
,p_substitution_value_03=>'Close'
,p_substitution_string_04=>'DATE_FORMAT'
,p_substitution_value_04=>'mm/dd/yyyy'
,p_substitution_string_05=>'LONG_DATE_FORMAT'
,p_substitution_value_05=>'fmDay, Month dd, yyyy'
,p_substitution_string_06=>'TIME_FORMAT'
,p_substitution_value_06=>'hh:mi:ss AM'
,p_substitution_string_07=>'DATE_TIME_FORMAT'
,p_substitution_value_07=>'mm/dd/yyyy hh:mi:ss AM'
,p_substitution_string_08=>'RETURN_TO_APPLICATION'
,p_substitution_value_08=>'Return to Application'
,p_substitution_string_09=>'MSG_LANGUAGE'
,p_substitution_value_09=>'Language'
...
,p_substitution_value_12=>'View'
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180725055800'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(8560508234436339)
,p_name=>'More Information'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8561901018538328)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8561519934534279)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8565818427600114)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(8566004359605487)
,p_name=>'Getting Started'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8567403776605488)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Learn More'
,p_list_item_link_target=>'https://apex.oracle.com/learnmore'
,p_list_text_01=>'A page for those just getting started or wanting to learn more about Oracle Application Express.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8567723889605492)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'apex.oracle.com'
,p_list_item_link_target=>'https://apex.oracle.com'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'A free, hosted service where you can try out the latest version of Oracle Application Express.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8568019160605492)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(115315832368341144)
,p_name=>'Tasks'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(155871030948668683)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(22951230716918778)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6096909608250810)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(11365419809816264)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(787389949330441085)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(788072921346081694)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1779057191405033)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14859123746941041)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92013858147572468)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1082517774399623391)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1765072874220712055)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1831780317545994155)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1917654134230939994)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(6153929631135099)
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(387608696699373799)
,p_name=>'COMPANY'
,p_scope=>'GLOBAL'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(47291523209584096)
,p_name=>'ERROR_OCCURRED'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(16763020509404219)
,p_name=>'F4550_SERVICE_REQUEST_URL'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(510231751281890)
,p_name=>'FSP_AFTER_LOGIN_URL'
,p_item_comment=>'Used by Custom2 authentication for deep linking support'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(1788752932141210549)
,p_name=>'G_CLOUD_RETURN_URL'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(6109409795714510)
,p_name=>'LOGIN_MESSAGE'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(5714319922471249)
,p_name=>'PRODUCT_TYPE'
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(387608942992380280)
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(16766113976430755)
,p_computation_sequence=>10
...
,p_computation_error_message=>'Error in computation of F4550_SERVICE_REQUEST_URL: #SQLERRM#'
);
end;
/
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(20203615154961597)
,p_lov_name=>'HR_OR_NEW'
,p_lov_query=>'.'||wwv_flow_api.id(20203615154961597)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(20203830364961608)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Unlock the HR sample user account'
,p_lov_return_value=>'HR'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(20204016953961621)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'Create a new user account'
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(176634981412406067)
,p_lov_name=>'REMEMBER_WORKSPACE_USERNAME'
,p_lov_query=>'.'||wwv_flow_api.id(176634981412406067)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(176635264449406069)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Remember workspace and username'
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(20420213496266810)
,p_lov_name=>'ROLES'
,p_lov_query=>'.'||wwv_flow_api.id(20420213496266810)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(20420400631266813)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Database Development (RESOURCE)'
,p_lov_return_value=>'RESOURCE'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(20420610391266814)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'Administrative (DBA)'
...
wwv_flow_api.create_page_group(
 p_id=>wwv_flow_api.id(222575208632450607)
,p_group_name=>'Login'
,p_group_desc=>'Login page, accept username and password from user.'
);
wwv_flow_api.create_page_group(
 p_id=>wwv_flow_api.id(222579123308464377)
,p_group_name=>'Logout'
,p_group_desc=>'Confirm logout event.'
);
wwv_flow_api.create_page_group(
 p_id=>wwv_flow_api.id(222577907724459883)
,p_group_name=>'Password Management'
,p_group_desc=>'Allow for reseting or changing password.'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5673029423553132)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29105717034457536)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(418461011594533008)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(781636565276262406)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(787783544361971642)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(788153963797526843)
,p_theme_id=>3
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20301506730451152)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(300732121515523410)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(629209698915957087)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(781649650278313424)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(781653829819356486)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(781654005571356486)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(781654809938356489)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(781655181102356490)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5717529496540150)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(232001428000934216)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(232017629436983931)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(232050622441068133)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(355286322831861132)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(781646415851311877)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(781705991385407800)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(781720832587518133)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(788096697713098503)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="a-Login-region a-Form--stretchInputs #REGION_CSS_CLASSES#" id="#REGION_ID#" #REGION_ATTRIBUTES#>',
'  <div class="a-Login-header">',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5724325438599633)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(85971030932131423)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(781726379075536728)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(3698594943076)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(232064200547094797)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14882217773748275)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(44225917854582269)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(176608736253329086)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(781639159048309153)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(14576615815371062)
,p_page_name=>'winlov'
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(75129413870047038)
,p_theme_id=>3
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(29105717034457536)
,p_error_template=>wwv_flow_api.id(788153963797526843)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(204024031242767851)
,p_theme_id=>3
,p_name=>'Standard'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(697232742091708847)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746428295086414612)
,p_theme_id=>3
,p_name=>'HEIGHT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746429553628414613)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746429875641414613)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746430157627414613)
,p_theme_id=>3
,p_name=>'BUTTON_SET'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746431250391414613)
,p_theme_id=>3
,p_name=>'LABEL_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746431589295414613)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746431892249414614)
,p_theme_id=>3
,p_name=>'BUTTON_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746432147133414614)
,p_theme_id=>3
,p_name=>'SPACING_LEFT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746432402204414614)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746432988180414614)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746433200088414615)
,p_theme_id=>3
,p_name=>'BUTTON_TYPE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(781726734648536732)
,p_theme_id=>3
,p_name=>'LAYOUT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746428338221414612)
,p_theme_id=>3
,p_name=>'180PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746428558714414612)
,p_theme_id=>3
,p_name=>'240PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746428773348414612)
,p_theme_id=>3
,p_name=>'320PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746428915729414613)
,p_theme_id=>3
,p_name=>'480PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746429163650414613)
,p_theme_id=>3
,p_name=>'540PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746429366543414613)
,p_theme_id=>3
,p_name=>'640PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746429653045414613)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746429958855414613)
,p_theme_id=>3
,p_name=>'AUTOWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746430220624414613)
,p_theme_id=>3
,p_name=>'FIRSTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746430482398414613)
,p_theme_id=>3
,p_name=>'FIXEDLARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746430657805414613)
,p_theme_id=>3
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746430847159414613)
,p_theme_id=>3
,p_name=>'FIXEDWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746431042745414613)
,p_theme_id=>3
,p_name=>'INNERBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746431384717414613)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746431600411414613)
,p_theme_id=>3
,p_name=>'LABELSABOVE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746431947434414614)
,p_theme_id=>3
,p_name=>'LARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746432282865414614)
,p_theme_id=>3
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746432501781414614)
,p_theme_id=>3
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746432705519414614)
,p_theme_id=>3
,p_name=>'LASTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433079620414614)
,p_theme_id=>3
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433329167414615)
,p_theme_id=>3
,p_name=>'PRIMARY'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433496690414615)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433643645414615)
,p_theme_id=>3
,p_name=>'SMALL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433877160414615)
,p_theme_id=>3
,p_name=>'SMALLLEFT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746434030153414615)
,p_theme_id=>3
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746434121281414615)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746434226618414615)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781728246980536738)
,p_theme_id=>3
,p_name=>'2COLUMNGRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(781726379075536728)
,p_css_classes=>'a-MediaList--cols a-MediaList--2cols'
,p_group_id=>wwv_flow_api.id(781726734648536732)
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781728430077536738)
,p_theme_id=>3
,p_name=>'3COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781728646908536739)
,p_theme_id=>3
,p_name=>'4COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781728899483536739)
,p_theme_id=>3
,p_name=>'5COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729002341536739)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729164307536739)
,p_theme_id=>3
,p_name=>'HIDEBADGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729218881536739)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729383509536739)
,p_theme_id=>3
,p_name=>'HIDETITLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729426857536739)
,p_theme_id=>3
,p_name=>'HIDEICONS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729513060536739)
,p_theme_id=>3
,p_name=>'SLIMLIST'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1199562975588032438)
,p_theme_id=>3
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(781654005571356486)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_api.id(746432988180414614)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652253865182060)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(85971030932131423)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652342428182060)
,p_theme_id=>3
,p_name=>'SHOWBADGES'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652435549182060)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652539590182060)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652722059182061)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652918075182061)
,p_theme_id=>3
,p_name=>'FORALLITEMS'
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(9152708051846605)
,p_build_option_name=>'XE'
,p_build_option_status=>'EXCLUDE'
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(388938859612826437)
,p_build_option_name=>'Commented Out'
,p_build_option_status=>'EXCLUDE'
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(836093046470445605)
...
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72247424865976156)
,p_translation_flow_id=>4551
,p_translation_flow_language_cd=>'es'
,p_translation_comments=>'Development Service Login - Spanish'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72247515181976156)
,p_translation_flow_id=>4552
,p_translation_flow_language_cd=>'fr'
,p_translation_comments=>'Development Service Login - French'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72247626970976156)
,p_translation_flow_id=>4553
,p_translation_flow_language_cd=>'de'
,p_translation_comments=>'Development Service Login - German'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72247714631976157)
,p_translation_flow_id=>4554
,p_translation_flow_language_cd=>'it'
,p_translation_comments=>'Development Service Login - Italian'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72247823189976157)
,p_translation_flow_id=>4555
,p_translation_flow_language_cd=>'pt-br'
,p_translation_comments=>'Development Service Login - Brazilian Portuguese'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72247920708976157)
,p_translation_flow_id=>4556
,p_translation_flow_language_cd=>'zh-cn'
,p_translation_comments=>'Development Service Login - Simplified Chinese'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72248005893976157)
,p_translation_flow_id=>4557
,p_translation_flow_language_cd=>'zh-tw'
,p_translation_comments=>'Development Service Login - Traditional Chinese'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72248123976976157)
,p_translation_flow_id=>4558
,p_translation_flow_language_cd=>'ko'
,p_translation_comments=>'Development Service Login - Korean'
,p_direction_right_to_left=>'N'
);
wwv_flow_api.create_language_map(
 p_id=>wwv_flow_api.id(72248208931976157)
,p_translation_flow_id=>4559
,p_translation_flow_language_cd=>'ja'
,p_translation_comments=>'Development Service Login - Japanese'
,p_direction_right_to_left=>'N'
);
end;
/
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(174421670078)
...
begin
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(14805026971629745)
...
begin
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(47306820184100081)
,p_shortcut_name=>'WELCOMETEXT'
,p_shortcut_type=>'HTML_TEXT'
,p_shortcut=>'Gain instant access to an integrated online application development suite. With &PRODUCT_NAME. you can build robust dynamic web applications and leverage the full power of the Oracle database all from your favorite browser.'
);
end;
/
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(540118315091694248)
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(113745616947665430)
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356673124532447685)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356675509593447689)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356684625134447706)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356684817976447706)
,p_plugin_id=>wwv_flow_api.id(356684625134447706)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356685218513447707)
,p_plugin_id=>wwv_flow_api.id(356684625134447706)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356685616471447707)
,p_plugin_attribute_id=>wwv_flow_api.id(356685218513447707)
,p_display_sequence=>10
,p_display_value=>'Redirect to Built-In URL'
,p_return_value=>'BUILTIN_URL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356686110431447707)
,p_plugin_attribute_id=>wwv_flow_api.id(356685218513447707)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356686604523447707)
,p_plugin_attribute_id=>wwv_flow_api.id(356685218513447707)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356687116374447708)
,p_plugin_id=>wwv_flow_api.id(356684625134447706)
,p_attribute_scope=>'COMPONENT'
...
,p_display_length=>60
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(356685218513447707)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356687527311447708)
,p_plugin_id=>wwv_flow_api.id(356684625134447706)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356687918741447708)
,p_plugin_id=>wwv_flow_api.id(356684625134447706)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356688324675447708)
,p_plugin_attribute_id=>wwv_flow_api.id(356687918741447708)
,p_display_sequence=>10
,p_display_value=>'Each Request'
,p_return_value=>'ALWAYS'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356688823918447709)
,p_plugin_attribute_id=>wwv_flow_api.id(356687918741447708)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356689316958447709)
,p_plugin_id=>wwv_flow_api.id(356684625134447706)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356751824591447757)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356752109391447757)
,p_plugin_id=>wwv_flow_api.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356752525978447757)
,p_plugin_id=>wwv_flow_api.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356752909762447757)
,p_plugin_id=>wwv_flow_api.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356753326801447757)
,p_plugin_attribute_id=>wwv_flow_api.id(356752909762447757)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356753802092447757)
,p_plugin_attribute_id=>wwv_flow_api.id(356752909762447757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356754317185447758)
,p_plugin_attribute_id=>wwv_flow_api.id(356752909762447757)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356754811521447759)
,p_plugin_id=>wwv_flow_api.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356755216699447759)
,p_plugin_id=>wwv_flow_api.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356755624517447759)
,p_plugin_id=>wwv_flow_api.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(356755216699447759)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356756013940447759)
,p_plugin_id=>wwv_flow_api.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356756416287447760)
,p_plugin_id=>wwv_flow_api.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356756825663447760)
,p_plugin_attribute_id=>wwv_flow_api.id(356756416287447760)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356757310563447761)
,p_plugin_attribute_id=>wwv_flow_api.id(356756416287447760)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356757815197447761)
,p_plugin_attribute_id=>wwv_flow_api.id(356756416287447760)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356819703353447808)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(4972214035302345)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(4972214035302345)
...
,p_last_upd_yyyymmddhh24miss=>'20150213104933'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(787803699949238365)
,p_plug_name=>'Header'
,p_region_css_classes=>'a-Header a-Header--login'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781705991385407800)
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(4972214035302345)
,p_name=>'Oracle Application Express - Sign In'
,p_step_title=>'&PRODUCT_NAME. - Sign In'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(222575208632450607)
,p_step_template=>wwv_flow_api.id(781636565276262406)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_deep_linking=>'Y'
,p_help_text=>'start_login.htm'
,p_page_comment=>'intro_login'
,p_last_upd_yyyymmddhh24miss=>'20180306081627'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5734329754154454)
,p_plug_name=>'Tasks'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133)
,p_plug_display_sequence=>70
,p_plug_new_grid_row=>false
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(115315832368341144)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28278406447321936)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28357414269339279)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(8560508234436339)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28359019857369284)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(8566004359605487)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30251320176465048)
,p_plug_name=>'Oracle Application Express'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781646415851311877)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(201971822038420445)
,p_plug_name=>'Languages'
,p_parent_plug_id=>wwv_flow_api.id(30251320176465048)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(59842604093647546)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(787389949330441085)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728)
,p_plug_query_row_template=>wwv_flow_api.id(232064200547094797)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(327446700231264735)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(698802056584413313)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(30251320176465048)
,p_button_name=>'REQUEST_WORKSPACE'
,p_button_action=>'REDIRECT_APP'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(781649650278313424)
,p_button_image_alt=>'Request a Workspace'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(698801968369413312)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47399509230712591)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(300732121515523410)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(232005500580944564)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(30251320176465048)
,p_button_name=>'LOGIN_BUTTON'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:a-Button--large'
,p_button_template_id=>wwv_flow_api.id(781653829819356486)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(9141131880673724)
,p_branch_action=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
,p_required_patch=>wwv_flow_api.id(9152708051846605)
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17417718747637820)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30250621039456935)
,p_name=>'F4550_P1_COMPANY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30251320176465048)
,p_prompt=>'Workspace'
...
,p_field_template=>wwv_flow_api.id(781639159048309153)
,p_item_css_classes=>'icon-login-workspace'
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'N'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Enter your workspace. The workspace name is case insensitive.</div>',
'<div class="htmldbInfoBodyP">This is an online development service which provides access to a virtual private database. Since the same username may exist in multiple workspaces, you are required to enter your workspace when using this service.</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30251012844458645)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Enter your username. The username is case insensitive.</div>',
'<div class="htmldbInfoBodyP">Once you are authenticated and assuming you have the proper credentials, you can create additional users.</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30251520608467092)
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Enter your password. Passwords are case sensitive. This password is specific to this service. Note that each workspace can have multiple users.</div>',
'<div class="htmldbInfoBodyP">If you forget your password, select <span class="fielddatabold">Reset Password</span>.</div>'))
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95189738956614247)
,p_name=>'F4550_P1_REMEMBER'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(30251320176465048)
,p_prompt=>'Remember Workspace and Username'
...
,p_field_template=>wwv_flow_api.id(176608736253329086)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>',
'If you select this checkbox, &PRODUCT_NAME. will save your workspace and username in a persistent browser cookie named "ORA_WWV_REMEMBER_UN".  When you go to the login page the next time, the workspace and username fields will be automatically popula'
||'ted with these values.',
'</p>',
'<p>',
'If you deselect this checkbox and your workspace and username are already saved in the cookie,',
'&PRODUCT_NAME. will overwrite it with an empty value.  You can also use your browser''s developer tools to completely remove the cookie.',
'</p>'))
,p_attribute_01=>'1'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(232291604030150875)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1778434620188603210)
,p_name=>'P1_NEXT_APP'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(30251320176465048)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1778434823687603211)
,p_name=>'P1_NEXT_PAGE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(30251320176465048)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1778435028760603211)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1778435208234603211)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(5714811395478232)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(14794408194619070)
,p_validation_name=>'F4550_P1_COMPANY Not Null'
,p_validation_sequence=>10
,p_validation=>'F4550_P1_COMPANY'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Please enter a workspace name'
,p_associated_item=>wwv_flow_api.id(30250621039456935)
,p_error_display_location=>'INLINE_WITH_FIELD'
,p_validation_comment=>'generated 06-MAY-2002 18:28'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(14794718743619076)
,p_validation_name=>'F4550_P1_USERNAME Not Null'
,p_validation_sequence=>20
,p_validation=>'F4550_P1_USERNAME'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Please enter your username'
,p_associated_item=>wwv_flow_api.id(30251012844458645)
,p_error_display_location=>'INLINE_WITH_FIELD'
,p_validation_comment=>'generated 06-MAY-2002 18:28'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(14795009696619077)
,p_validation_name=>'F4550_P1_PASSWORD Not Null'
,p_validation_sequence=>30
,p_validation=>'F4550_P1_PASSWORD'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Please enter your password'
,p_associated_item=>wwv_flow_api.id(30251520608467092)
,p_error_display_location=>'INLINE_WITH_FIELD'
,p_validation_comment=>'generated 06-MAY-2002 18:28'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(698802352859413316)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(698802474866413317)
,p_event_id=>wwv_flow_api.id(698802352859413316)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(698802512740413318)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(698802638841413319)
,p_event_id=>wwv_flow_api.id(698802512740413318)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_FOCUS'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(698802182978413314)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(698802286696413315)
,p_event_id=>wwv_flow_api.id(698802182978413314)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_FOCUS'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362587120355512597)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(359371008265397285)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(491225097024458)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(297447517593238309)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362585625418504590)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28292524174506792)
...
,p_last_upd_yyyymmddhh24miss=>'20140523141153'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(134636703889796037)
...
wwv_flow_api.create_page(
 p_id=>4
,p_user_interface_id=>wwv_flow_api.id(4972214035302345)
,p_name=>'Find My Workspace'
,p_alias=>'REQUESTWORKSPACE'
,p_step_title=>'Find My Workspace'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_api.id(787783544361971642)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20171009062342'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(22878608880410975)
,p_plug_name=>'Find My Workspace'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781646415851311877)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(26487014153670357)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(22878608880410975)
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Find Workspace'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(22883630052445491)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(22878608880410975)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(26487310047670358)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:4::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(26487014153670357)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(22891903920551475)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(22883630052445491)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17445301703727502)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22881822648433869)
,p_name=>'F4550_P4_EMAIL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(22878608880410975)
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Enter the email address associated with your workspace.  We will send your workspace name to this email.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(5717205948533393)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(22955710724969695)
...
,p_when_button_pressed=>wwv_flow_api.id(26487014153670357)
,p_associated_item=>wwv_flow_api.id(22881822648433869)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(22891011754544211)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(26487014153670357)
,p_process_success_message=>'If &F4550_P4_EMAIL. exists in our records, we will send the workspace names associated with this email address. If you are having problems receiving the workspace names, please contact your administrator.'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(8570511463645379)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47285769528327391)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47286811980358498)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(47285769528327391)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14635328375431475)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(47285769528327391)
,p_button_name=>'Cancel'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(60120000609053928)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(60096028904579631)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17445722481733542)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22923025971699756)
,p_name=>'F4550_P7_ERROR_TEXT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(47285769528327391)
,p_prompt=>'<span class="instructiontext">You did not provide a valid combination of workspace name and email address.</span>'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47286220449334625)
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'N'
,p_help_text=>'Enter your workspace.  If you do not know your workspace, use the Find My Workspace link.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47286414702337991)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Enter your email address so we can email you your password.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'EMAIL'
,p_attribute_05=>'BOTH'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(232259213858994463)
,p_name=>'P7_FIND_MY_WORKSPACE_LABEL'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(8570511463645379)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(22910528694672171)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(74605102595685181)
,p_validation_name=>'F4550_P7_EMAIL Not Null'
,p_validation_sequence=>10
,p_validation=>'F4550_P7_EMAIL'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Email cannot be blank'
,p_associated_item=>wwv_flow_api.id(47286414702337991)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 23-JAN-2007 07:29'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(74605307525685181)
,p_validation_name=>'F4550_P7_COMPANY Not Null'
,p_validation_sequence=>20
,p_validation=>'F4550_P7_COMPANY'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Workspace cannot be blank'
,p_associated_item=>wwv_flow_api.id(47286220449334625)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 23-JAN-2007 07:29'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(359674223295887132)
,p_validation_name=>'do not allow internal'
,p_validation_sequence=>30
,p_validation=>'nvl(upper(:F4550_P7_COMPANY),''x'') != ''INTERNAL'''
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Password reset operation not supported for INTERNAL workspace.'
,p_associated_item=>wwv_flow_api.id(47286220449334625)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47291128490577452)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'Unable to reset password.'
,p_process_when_button_id=>wwv_flow_api.id(47286811980358498)
,p_process_success_message=>'Reset password request has been sent for processing.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>8
,p_user_interface_id=>wwv_flow_api.id(4972214035302345)
,p_name=>'Logout Confirmation'
,p_step_title=>'Logout Confirmation'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47289611174520429)
,p_plug_name=>'Signed out successfully'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(781646415851311877)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(235943023326098156)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(47289611174520429)
,p_button_name=>'LOGIN'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:a-Button--large'
,p_button_template_id=>wwv_flow_api.id(781653829819356486)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Return to Sign In Page'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_redirect_url=>'apex'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17445927460744406)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(47290514531564696)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72005820105419587)
,p_name=>'P8_NEXTPAGE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(47289611174520429)
,p_item_default=>'1'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(698805599458413348)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(698805641444413349)
,p_event_id=>wwv_flow_api.id(698805599458413348)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_FOCUS'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(235943023326098156)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(48179495483070440)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page(
 p_id=>10
,p_user_interface_id=>wwv_flow_api.id(4972214035302345)
,p_name=>'Internal Administration Login'
,p_step_title=>'&PRODUCT_NAME. Administration Services'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1043922209309491)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(694607830412810101)
,p_plug_name=>'Language Selector'
,p_parent_plug_id=>wwv_flow_api.id(1043922209309491)
,p_region_css_classes=>'a-Login-links a-Login-links--languages'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781705991385407800)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23205800319914944)
,p_plug_name=>'init'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(232279713795102725)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1043922209309491)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:a-Button--large'
,p_button_template_id=>wwv_flow_api.id(781653829819356486)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Sign In to Administration'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17446617202750916)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1046305318309559)
,p_name=>'P10_USERNAME'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(1043922209309491)
,p_prompt=>'Username'
,p_placeholder=>'username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>25
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Enter your username.  The username is case insensitive.  Once you are authenticated and assuming you have the proper credentials you can create additional usernames.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1046904764309561)
,p_name=>'P10_PASSWORD'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(1043922209309491)
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Enter your password.  Passwords are case sensitive.  If you forget your password click on the "forget your password" link.  Note that each workspace can have multiple users.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(5714704123476099)
,p_computation_sequence=>10
,p_computation_item=>'PRODUCT_TYPE'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'FUNCTION_BODY'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(239007203778570571)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'disabled login check'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(359608213674439626)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Login'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1048720322309594)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(297445926120231391)
,p_process_sequence=>40
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'ip range check'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362591402740535889)
,p_process_sequence=>50
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'disabled login check'
...
wwv_flow_api.create_page(
 p_id=>20
,p_user_interface_id=>wwv_flow_api.id(4972214035302345)
,p_name=>'Oracle Application Express Login'
,p_alias=>'WORKSPACES'
,p_step_title=>'&PRODUCT_NAME. Login'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_last_updated_by=>''
,p_last_upd_yyyymmddhh24miss=>'20180716092708'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(355244609672857359)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(356825125052947229)
,p_plug_name=>'Announcements'
,p_region_css_classes=>'a-Login-message'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788148989693515940)
,p_plug_name=>'Site-Specific Tasks'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noDesc:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788149141438516546)
,p_plug_name=>'Getting Started'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788149365141517128)
,p_plug_name=>'More Information'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788149510285517814)
,p_plug_name=>'Social Networking Links'
,p_region_css_classes=>'a-Login-social'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788149776764518791)
,p_plug_name=>'Tasks'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1903077399430433037)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788098255248103123)
,p_plug_name=>'Oracle Application Express'
,p_parent_plug_id=>wwv_flow_api.id(1903077399430433037)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(788096697713098503)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(784426701644840009)
,p_plug_name=>'Additional Information Required'
,p_parent_plug_id=>wwv_flow_api.id(788098255248103123)
,p_region_css_classes=>'a-Login-message'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781705991385407800)
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>One or more feedback entries you entered has a status of ''Additional information requested''!  Please select a workspace and then go to the Early Adopter Public Feedback application to review the feedback.</p>',
'<p><em>Note: This warning will display until you have entered follow-up on the feedback entries.</em></p>'))
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_display_condition_type=>'FUNCTION_BODY'
,p_plug_display_when_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'end loop;',
'return FALSE;'))
,p_required_patch=>wwv_flow_api.id(836093046470445605)
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788095677913088930)
,p_plug_name=>'List of Workspaces'
,p_parent_plug_id=>wwv_flow_api.id(788098255248103123)
,p_component_template_options=>'a-MediaList--slim'
,p_plug_display_sequence=>50
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(788072921346081694)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(825234084074277602)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2024382717374138701)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1959512182339704219)
,p_plug_name=>'Languages'
,p_parent_plug_id=>wwv_flow_api.id(1903077399430433037)
,p_region_css_classes=>'a-Login-links a-Login-links--languages'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(355343217768869136)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(788098255248103123)
,p_button_name=>'NEW_WORKSPACE'
,p_button_action=>'REDIRECT_APP'
,p_button_template_options=>'#DEFAULT#:a-Button--large'
,p_button_template_id=>wwv_flow_api.id(781653829819356486)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Request a New Workspace'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_redirect_url=>'f?p=4700:1:&SESSION.::&DEBUG.:RP:::'
,p_button_condition=>'wwv_flow_platform.get_preference( p_preference_name => ''SERVICE_REQUEST_FLOW'' ) <> ''MANUAL'''
,p_button_condition_type=>'PLSQL_EXPRESSION'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(787948171855029003)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(788098255248103123)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20780723786489096)
,p_name=>'P20_WORKSPACE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(355244609672857359)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23554931773705253)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5499919566405279)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17346400590121618)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(6152921076915006)
);
end;
/
