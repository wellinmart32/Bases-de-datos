...
prompt APPLICATION 4556 - Oracle APEX Login
--
-- Application Export:
--   Application:     4556
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,4556)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A285109289461220421')
...
,p_authentication_id=>wwv_flow_api.id(540118315091694248.4556)
,p_populate_roles=>'A'
...
,p_substitution_value_11=>unistr('\7248\6743\6240\6709 &copy; 1999\FF0C2018\FF0COracle\3002\4FDD\7559\6240\6709\6743\5229\3002')
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(8560508234436339.4556)
,p_name=>'More Information'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8561901018538328.4556)
...
,p_list_text_01=>unistr('Oracle Application Express \4E3B\9875, \60A8\53EF\4EE5\5728\6B64\9875\4E0A\4E0B\8F7D\6700\65B0\7248\672C, \590D\67E5\6587\6863, \4EE5\53CA\8BBF\95EE\5E7F\6CDB\7684\9644\4EF6\3002')
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8561519934534279.4556)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('\8BBA\575B')
,p_list_item_link_target=>'https://apex.oracle.com/forum'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>' alt=""'
,p_list_text_01=>unistr('\5728 OTN \8BBA\575B\4E0A\83B7\53D6\5BF9 Application Express \95EE\9898\7684\793E\533A\9A71\52A8\7684\514D\8D39\652F\6301\3002')
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8565818427600114.4556)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>unistr('Application Express \793E\533A')
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(8566004359605487.4556)
,p_name=>'Getting Started'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8567403776605488.4556)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('\4E86\89E3\8BE6\7EC6\4FE1\606F')
,p_list_item_link_target=>'https://apex.oracle.com/learnmore'
,p_list_text_01=>unistr('\6B64\9875\9002\5408\521A\5F00\59CB\63A5\89E6 Oracle Application Express \6216\5E0C\671B\4E86\89E3\5176\66F4\591A\4FE1\606F\7684\4EBA\5458\3002')
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8567723889605492.4556)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'apex.oracle.com'
,p_list_item_link_target=>'https://apex.oracle.com'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>unistr('\4E00\4E2A\514D\8D39\7684\6258\7BA1\670D\52A1\FF0C\60A8\53EF\4EE5\901A\8FC7\6B64\670D\52A1\6765\8BD5\7528\6700\65B0\7248\672C\7684 Oracle Application Express\3002')
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(8568019160605492.4556)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(115315832368341144.4556)
,p_name=>'Tasks'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(155871030948668683.4556)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(22951230716918778.4556)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6096909608250810.4556)
,p_list_item_display_sequence=>30
...
,p_list_text_01=>unistr('\767B\5F55\5230\5B9E\4F8B\7BA1\7406\3002')
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(11365419809816264.4556)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(787389949330441085.4556)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(788072921346081694.4556)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1779057191405033.4556)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14859123746941041.4556)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92013858147572468.4556)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1082517774399623391.4556)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1765072874220712055.4556)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1831780317545994155.4556)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1917654134230939994.4556)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(6153929631135099.4556)
...
,p_reference_id=>6738410669854771.4556
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(387608696699373799.4556)
,p_name=>'COMPANY'
,p_scope=>'GLOBAL'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(47291523209584096.4556)
,p_name=>'ERROR_OCCURRED'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(16763020509404219.4556)
,p_name=>'F4550_SERVICE_REQUEST_URL'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(510231751281890.4556)
,p_name=>'FSP_AFTER_LOGIN_URL'
,p_item_comment=>'Used by Custom2 authentication for deep linking support'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(1788752932141210549.4556)
,p_name=>'G_CLOUD_RETURN_URL'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(6109409795714510.4556)
,p_name=>'LOGIN_MESSAGE'
,p_protection_level=>'I'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(5714319922471249.4556)
,p_name=>'PRODUCT_TYPE'
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(387608942992380280.4556)
...
wwv_flow_api.create_flow_computation(
 p_id=>wwv_flow_api.id(16766113976430755.4556)
,p_computation_sequence=>10
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(176634981412406067.4556)
,p_lov_name=>'REMEMBER_WORKSPACE_USERNAME'
,p_lov_query=>'.'||wwv_flow_api.id(176634981412406067)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(176635264449406069.4556)
,p_lov_disp_sequence=>1
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(20420213496266810.4556)
,p_lov_name=>'ROLES'
,p_lov_query=>'.'||wwv_flow_api.id(20420213496266810)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(20420400631266813.4556)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>unistr('\6570\636E\5E93\5F00\53D1 (RESOURCE)')
,p_lov_return_value=>'RESOURCE'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(20420610391266814.4556)
,p_lov_disp_sequence=>20
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5673029423553132.4556)
,p_theme_id=>3
,p_name=>'APEX 4.2 - Login.zh-cn'
...
,p_reference_id=>5670419456547088.4556
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29105717034457536.4556)
,p_theme_id=>3
,p_name=>'APEX 4.0 - Centered.zh-cn'
...
,p_grid_emit_empty_trail_cols=>false
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>29091918876244613.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(418461011594533008.4556)
,p_theme_id=>3
,p_name=>'APEX 4.2 - Error Page.zh-cn'
...
,p_grid_emit_empty_trail_cols=>false
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>269976808683160781.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(781636565276262406.4556)
,p_theme_id=>3
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>781632627194221102.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(787783544361971642.4556)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(788153963797526843.4556)
,p_theme_id=>3
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>702684260095026477.4556
,p_translate_this_template=>'N'
);
end;
/
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20301506730451152.4556)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(300732121515523410.4556)
...
,p_reference_id=>275775519061831382.4556
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_template_comment=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(629209698915957087.4556)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(781649650278313424.4556)
...
,p_reference_id=>781637176150282829.4556
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_theme_id=>3
);
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(781653829819356486.4556)
,p_template_name=>'APEX 5.0 - Button'
,p_internal_name=>'APEX_5.0_BUTTON'
,p_template=>'<button onclick="#JAVASCRIPT#" class="a-Button #BUTTON_CSS_CLASSES#" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">#LABEL!HTML#</button>'
,p_hot_template=>'<button onclick="#JAVASCRIPT#" class="a-Button a-Button--hot #BUTTON_CSS_CLASSES#" type="button" #BUTTON_ATTRIBUTES# id="#BUTTON_ID#">#LABEL!HTML#</button>'
,p_reference_id=>174750904387485475.4556
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_theme_id=>3
);
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(781654809938356489.4556)
...
,p_reference_id=>3705338883615.4556
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_theme_id=>3
);
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(781655181102356490.4556)
...
,p_reference_id=>353820721334283301.4556
,p_translate_this_template=>'N'
,p_theme_class_id=>1
,p_theme_id=>3
);
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5717529496540150.4556)
,p_layout=>'TABLE'
...
,p_reference_id=>354965805166572999.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(232001428000934216.4556)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#BODY#',
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>231996531355924985.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(232017629436983931.4556)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>232012105475974354.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(232050622441068133.4556)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>232045826042061939.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(355286322831861132.4556)
,p_layout=>'TABLE'
...
,p_reference_id=>245224629509817478.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(781646415851311877.4556)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>781637364422290692.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(781705991385407800.4556)
,p_layout=>'TABLE'
...
,p_default_field_alignment=>'LEFT'
,p_form_table_attr=>'class="htmldbInstruct"'
,p_reference_id=>716895227337398760.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(781720832587518133.4556)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>781713093380502210.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(788096697713098503.4556)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="a-Login-region a-Form--stretchInputs #REGION_CSS_CLASSES#" id="#REGION_ID#" #REGION_ATTRIBUTES#>',
'  <div class="a-Login-header">',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5724325438599633.4556)
...
,p_reference_id=>32421627622986728.4556
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(85971030932131423.4556)
...
||'</li>'
,p_reference_id=>60219508156141083.4556
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(781726379075536728.4556)
...
,p_list_template_after_rows=>'</ul>'
,p_reference_id=>692720897220784060.4556
);
end;
/
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(3698594943076.4556)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(232064200547094797.4556)
...
,p_theme_id=>3
,p_theme_class_id=>0
,p_reference_id=>232059713281090127.4556
,p_translate_this_template=>'N'
);
begin
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14882217773748275.4556)
...
,p_theme_id=>3
,p_theme_class_id=>2
,p_reference_id=>17388508175892042.4556
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(44225917854582269.4556)
...
,p_theme_id=>3
,p_theme_class_id=>1
,p_reference_id=>17388415351892041.4556
,p_translate_this_template=>'N'
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(176608736253329086.4556)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(781639159048309153.4556)
...
,p_theme_id=>3
,p_theme_class_id=>4
,p_reference_id=>781637020106265852.4556
,p_translate_this_template=>'N'
);
end;
/
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(14576615815371062.4556)
,p_page_name=>'winlov'
...
,p_theme_id=>3
,p_theme_class_id=>1
,p_reference_id=>17343114994581872.4556
,p_translate_this_template=>'N'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(204024031242767851.4556)
,p_theme_id=>3
,p_name=>'Standard'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(697232742091708847.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746428295086414612.4556)
,p_theme_id=>3
,p_name=>'HEIGHT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746429553628414613.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746429875641414613.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746430157627414613.4556)
,p_theme_id=>3
,p_name=>'BUTTON_SET'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746431250391414613.4556)
,p_theme_id=>3
,p_name=>'LABEL_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746431589295414613.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746431892249414614.4556)
,p_theme_id=>3
,p_name=>'BUTTON_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746432147133414614.4556)
,p_theme_id=>3
,p_name=>'SPACING_LEFT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746432402204414614.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746432988180414614.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(746433200088414615.4556)
,p_theme_id=>3
,p_name=>'BUTTON_TYPE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(781726734648536732.4556)
,p_theme_id=>3
,p_name=>'LAYOUT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746428338221414612.4556)
,p_theme_id=>3
,p_name=>'180PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746428558714414612.4556)
,p_theme_id=>3
,p_name=>'240PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746428773348414612.4556)
,p_theme_id=>3
,p_name=>'320PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746428915729414613.4556)
,p_theme_id=>3
,p_name=>'480PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746429163650414613.4556)
,p_theme_id=>3
,p_name=>'540PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746429366543414613.4556)
,p_theme_id=>3
,p_name=>'640PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746429653045414613.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746429958855414613.4556)
,p_theme_id=>3
,p_name=>'AUTOWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746430220624414613.4556)
,p_theme_id=>3
,p_name=>'FIRSTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746430482398414613.4556)
,p_theme_id=>3
,p_name=>'FIXEDLARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746430657805414613.4556)
,p_theme_id=>3
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746430847159414613.4556)
,p_theme_id=>3
,p_name=>'FIXEDWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746431042745414613.4556)
,p_theme_id=>3
,p_name=>'INNERBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746431384717414613.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746431600411414613.4556)
,p_theme_id=>3
,p_name=>'LABELSABOVE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746431947434414614.4556)
,p_theme_id=>3
,p_name=>'LARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746432282865414614.4556)
,p_theme_id=>3
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746432501781414614.4556)
,p_theme_id=>3
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746432705519414614.4556)
,p_theme_id=>3
,p_name=>'LASTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433079620414614.4556)
,p_theme_id=>3
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433329167414615.4556)
,p_theme_id=>3
,p_name=>'PRIMARY'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433496690414615.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433643645414615.4556)
,p_theme_id=>3
,p_name=>'SMALL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746433877160414615.4556)
,p_theme_id=>3
,p_name=>'SMALLLEFT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746434030153414615.4556)
,p_theme_id=>3
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746434121281414615.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(746434226618414615.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781728246980536738.4556)
,p_theme_id=>3
,p_name=>'2COLUMNGRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(781726379075536728.4556)
,p_css_classes=>'a-MediaList--cols a-MediaList--2cols'
,p_group_id=>wwv_flow_api.id(781726734648536732)
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781728430077536738.4556)
,p_theme_id=>3
,p_name=>'3COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781728646908536739.4556)
,p_theme_id=>3
,p_name=>'4COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781728899483536739.4556)
,p_theme_id=>3
,p_name=>'5COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729002341536739.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729164307536739.4556)
,p_theme_id=>3
,p_name=>'HIDEBADGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729218881536739.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729383509536739.4556)
,p_theme_id=>3
,p_name=>'HIDETITLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729426857536739.4556)
,p_theme_id=>3
,p_name=>'HIDEICONS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(781729513060536739.4556)
,p_theme_id=>3
,p_name=>'SLIMLIST'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1199562975588032438.4556)
,p_theme_id=>3
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(781654005571356486.4556)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_api.id(746432988180414614)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652253865182060.4556)
,p_theme_id=>3
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(85971030932131423.4556)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652342428182060.4556)
,p_theme_id=>3
,p_name=>'SHOWBADGES'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652435549182060.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652539590182060.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652722059182061.4556)
,p_theme_id=>3
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(1525652918075182061.4556)
,p_theme_id=>3
,p_name=>'FORALLITEMS'
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(9152708051846605.4556)
,p_build_option_name=>'XE'
,p_build_option_status=>'EXCLUDE'
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(388938859612826437.4556)
,p_build_option_name=>'Commented Out'
,p_build_option_status=>'EXCLUDE'
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(836093046470445605.4556)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(174421670078.4556)
...
begin
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(47306820184100081.4556)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(540118315091694248.4556)
...
,p_ras_mode=>0
,p_reference_id=>540226219724705040.4556
);
end;
/
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(113745616947665430.4556)
...
,p_reference_id=>113737019268347425.4556
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356673124532447685.4556)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_standard_attributes=>'LOGIN_PAGE'
,p_substitute_attributes=>true
,p_reference_id=>113749806821809026.4556
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
end;
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356675509593447689.4556)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_standard_attributes=>'LOGIN_PAGE'
,p_substitute_attributes=>true
,p_reference_id=>113749511183746276.4556
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
end;
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356684625134447706.4556)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_standard_attributes=>'LOGIN_PAGE'
,p_substitute_attributes=>true
,p_reference_id=>708795120396802284.4556
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356684817976447706.4556)
,p_plugin_id=>wwv_flow_api.id(356684625134447706.4556)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356685218513447707.4556)
,p_plugin_id=>wwv_flow_api.id(356684625134447706.4556)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356685616471447707.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356685218513447707.4556)
,p_display_sequence=>10
,p_display_value=>'Redirect to Built-In URL'
,p_return_value=>'BUILTIN_URL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356686110431447707.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356685218513447707.4556)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356686604523447707.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356685218513447707.4556)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356687116374447708.4556)
,p_plugin_id=>wwv_flow_api.id(356684625134447706.4556)
,p_attribute_scope=>'COMPONENT'
...
,p_display_length=>60
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(356685218513447707.4556)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356687527311447708.4556)
,p_plugin_id=>wwv_flow_api.id(356684625134447706.4556)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356687918741447708.4556)
,p_plugin_id=>wwv_flow_api.id(356684625134447706.4556)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356688324675447708.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356687918741447708.4556)
,p_display_sequence=>10
,p_display_value=>'Each Request'
,p_return_value=>'ALWAYS'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356688823918447709.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356687918741447708.4556)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356689316958447709.4556)
,p_plugin_id=>wwv_flow_api.id(356684625134447706.4556)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356751824591447757.4556)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_substitute_attributes=>true
,p_reference_id=>863910941135523528.4556
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356752109391447757.4556)
,p_plugin_id=>wwv_flow_api.id(356751824591447757.4556)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356752525978447757.4556)
,p_plugin_id=>wwv_flow_api.id(356751824591447757.4556)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356752909762447757.4556)
,p_plugin_id=>wwv_flow_api.id(356751824591447757.4556)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356753326801447757.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356752909762447757.4556)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356753802092447757.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356752909762447757.4556)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356754317185447758.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356752909762447757.4556)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356754811521447759.4556)
,p_plugin_id=>wwv_flow_api.id(356751824591447757.4556)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356755216699447759.4556)
,p_plugin_id=>wwv_flow_api.id(356751824591447757.4556)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356755624517447759.4556)
,p_plugin_id=>wwv_flow_api.id(356751824591447757.4556)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(356755216699447759.4556)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356756013940447759.4556)
,p_plugin_id=>wwv_flow_api.id(356751824591447757.4556)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(356756416287447760.4556)
,p_plugin_id=>wwv_flow_api.id(356751824591447757.4556)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356756825663447760.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356756416287447760.4556)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356757310563447761.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356756416287447760.4556)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(356757815197447761.4556)
,p_plugin_attribute_id=>wwv_flow_api.id(356756416287447760.4556)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(356819703353447808.4556)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
,p_standard_attributes=>'LOGIN_PAGE'
,p_substitute_attributes=>true
,p_reference_id=>113750429890071859.4556
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
end;
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(4972214035302345.4556)
...
wwv_flow_api.create_page(
 p_id=>.4556
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(787803699949238365.4556)
,p_plug_name=>'Header'
,p_region_css_classes=>'a-Header a-Header--login'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781705991385407800.4556)
...
wwv_flow_api.create_page(
 p_id=>1.4556
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4556)
,p_name=>unistr('Oracle Application Express - \767B\5F55')
...
,p_step_template=>wwv_flow_api.id(781636565276262406.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5734329754154454.4556)
,p_plug_name=>unistr('\4EFB\52A1')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133.4556)
,p_plug_display_sequence=>70
,p_plug_new_grid_row=>false
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(115315832368341144.4556)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728.4556)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28278406447321936.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28357414269339279.4556)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(8560508234436339.4556)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728.4556)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28359019857369284.4556)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(8566004359605487.4556)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728.4556)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30251320176465048.4556)
,p_plug_name=>'Oracle Application Express'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781646415851311877.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(201971822038420445.4556)
,p_plug_name=>'Languages'
,p_parent_plug_id=>wwv_flow_api.id(30251320176465048.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(59842604093647546.4556)
,p_plug_name=>unistr('\7AD9\70B9\7279\5B9A\7684\4EFB\52A1')
,p_region_template_options=>'#DEFAULT#'
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(787389949330441085.4556)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728.4556)
,p_plug_query_row_template=>wwv_flow_api.id(232064200547094797.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(327446700231264735.4556)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(698802056584413313.4556)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(30251320176465048.4556)
,p_button_name=>'REQUEST_WORKSPACE'
,p_button_action=>'REDIRECT_APP'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(781649650278313424.4556)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(698801968369413312.4556)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47399509230712591.4556)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(300732121515523410.4556)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(232005500580944564.4556)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(30251320176465048.4556)
,p_button_name=>'LOGIN_BUTTON'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:a-Button--large'
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4556)
,p_button_is_hot=>'Y'
,p_button_image_alt=>unistr('\767B\5F55')
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_grid_new_grid=>false
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(9141131880673724.4556)
,p_branch_action=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
,p_required_patch=>wwv_flow_api.id(9152708051846605.4556)
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17417718747637820.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30250621039456935.4556)
,p_name=>'F4550_P1_COMPANY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30251320176465048.4556)
...
,p_field_template=>wwv_flow_api.id(781639159048309153.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30251012844458645.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30251520608467092.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95189738956614247.4556)
...
,p_field_template=>wwv_flow_api.id(176608736253329086.4556)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>',
unistr('\5982\679C\9009\4E2D\6B64\590D\9009\6846\FF0C&PRODUCT_NAME. \4F1A\5C06\5DE5\4F5C\533A\548C\7528\6237\540D\4FDD\5B58\5728\540D\4E3A "ORA_WWV_REMEMBER_UN" \7684\6301\4E45\6027\6D4F\89C8\5668 Cookie \4E2D\3002\5728\60A8\4E0B\6B21\8F6C\5230\767B\5F55\9875\65F6\FF0C\5DE5\4F5C\533A\548C\7528\6237\540D\5B57\6BB5\5C06\81EA\52A8\4F7F\7528\8FD9\4E9B\503C\586B\5145\3002'),
'</p>',
'<p>',
unistr('\5982\679C\53D6\6D88\9009\4E2D\6B64\590D\9009\6846\FF0C\5E76\4E14\60A8\7684\5DE5\4F5C\533A\548C\7528\6237\540D\5DF2\4FDD\5B58\5728 Cookie \4E2D\FF0C'),
unistr('&PRODUCT_NAME. \5C06\7528\7A7A\503C\8986\76D6 Cookie\3002\60A8\8FD8\53EF\4EE5\4F7F\7528\6D4F\89C8\5668\7684\5F00\53D1\8005\5DE5\5177\6765\5F7B\5E95\5220\9664 Cookie\3002'),
'</p>'))
,p_attribute_01=>'1'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(232291604030150875.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1778434620188603210.4556)
,p_name=>'P1_NEXT_APP'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(30251320176465048.4556)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1778434823687603211.4556)
,p_name=>'P1_NEXT_PAGE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(30251320176465048.4556)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1778435028760603211.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1778435208234603211.4556)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(5714811395478232.4556)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(14794408194619070.4556)
...
,p_associated_item=>wwv_flow_api.id(30250621039456935.4556)
,p_error_display_location=>'INLINE_WITH_FIELD'
,p_validation_comment=>'generated 06-MAY-2002 18:28'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(14794718743619076.4556)
...
,p_associated_item=>wwv_flow_api.id(30251012844458645.4556)
,p_error_display_location=>'INLINE_WITH_FIELD'
,p_validation_comment=>'generated 06-MAY-2002 18:28'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(14795009696619077.4556)
...
,p_associated_item=>wwv_flow_api.id(30251520608467092.4556)
,p_error_display_location=>'INLINE_WITH_FIELD'
,p_validation_comment=>'generated 06-MAY-2002 18:28'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(698802352859413316.4556)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(698802474866413317.4556)
,p_event_id=>wwv_flow_api.id(698802352859413316.4556)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(698802512740413318.4556)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(698802638841413319.4556)
,p_event_id=>wwv_flow_api.id(698802512740413318.4556)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_FOCUS'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(698802182978413314.4556)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(698802286696413315.4556)
,p_event_id=>wwv_flow_api.id(698802182978413314.4556)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_FOCUS'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362587120355512597.4556)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(359371008265397285.4556)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(491225097024458.4556)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(297447517593238309.4556)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362585625418504590.4556)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28292524174506792.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(134636703889796037.4556)
...
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_api.id(787783544361971642.4556)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(22878608880410975.4556)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(26487014153670357.4556)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(22878608880410975.4556)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(22883630052445491.4556)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(22878608880410975.4556)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(26487310047670358.4556)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:4::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(26487014153670357.4556)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(22891903920551475.4556)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(22883630052445491.4556)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17445301703727502.4556)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22881822648433869.4556)
,p_name=>'F4550_P4_EMAIL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(22878608880410975.4556)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(5717205948533393.4556)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(22955710724969695.4556)
...
,p_when_button_pressed=>wwv_flow_api.id(26487014153670357.4556)
,p_associated_item=>wwv_flow_api.id(22881822648433869.4556)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(22891011754544211.4556)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(26487014153670357.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(8570511463645379.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47285769528327391.4556)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47286811980358498.4556)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(47285769528327391.4556)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14635328375431475.4556)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(47285769528327391.4556)
,p_button_name=>'Cancel'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(60120000609053928.4556)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(60096028904579631.4556)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17445722481733542.4556)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22923025971699756.4556)
,p_name=>'F4550_P7_ERROR_TEXT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(47285769528327391.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47286220449334625.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47286414702337991.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(232259213858994463.4556)
,p_name=>'P7_FIND_MY_WORKSPACE_LABEL'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(8570511463645379.4556)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(22910528694672171.4556)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(74605102595685181.4556)
...
,p_associated_item=>wwv_flow_api.id(47286414702337991.4556)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 23-JAN-2007 07:29'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(74605307525685181.4556)
...
,p_associated_item=>wwv_flow_api.id(47286220449334625.4556)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_validation_comment=>'generated 23-JAN-2007 07:29'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(359674223295887132.4556)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47291128490577452.4556)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_api.id(47286811980358498.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47289611174520429.4556)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(235943023326098156.4556)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(47289611174520429.4556)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17445927460744406.4556)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(47290514531564696.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72005820105419587.4556)
,p_name=>'P8_NEXTPAGE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(47289611174520429.4556)
,p_item_default=>'1'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(698805599458413348.4556)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(698805641444413349.4556)
,p_event_id=>wwv_flow_api.id(698805599458413348.4556)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_FOCUS'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(235943023326098156.4556)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(48179495483070440.4556)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page(
 p_id=>10.4556
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4556)
,p_name=>unistr('\5185\90E8\7BA1\7406\767B\5F55')
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1043922209309491.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(694607830412810101.4556)
,p_plug_name=>'Language Selector'
,p_parent_plug_id=>wwv_flow_api.id(1043922209309491.4556)
,p_region_css_classes=>'a-Login-links a-Login-links--languages'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781705991385407800.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23205800319914944.4556)
,p_plug_name=>'init'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(232279713795102725.4556)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1043922209309491.4556)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:a-Button--large'
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4556)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17446617202750916.4556)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1046305318309559.4556)
,p_name=>'P10_USERNAME'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(1043922209309491.4556)
,p_prompt=>unistr('\7528\6237\540D')
,p_placeholder=>unistr('\7528\6237\540D')
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>25
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1046904764309561.4556)
,p_name=>'P10_PASSWORD'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(1043922209309491.4556)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(5714704123476099.4556)
,p_computation_sequence=>10
,p_computation_item=>'PRODUCT_TYPE'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'FUNCTION_BODY'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(239007203778570571.4556)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'disabled login check'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(359608213674439626.4556)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Login'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1048720322309594.4556)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(297445926120231391.4556)
,p_process_sequence=>40
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'ip range check'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362591402740535889.4556)
,p_process_sequence=>50
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'disabled login check'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(355244609672857359.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(356825125052947229.4556)
,p_plug_name=>unistr('\516C\544A')
,p_region_css_classes=>'a-Login-message'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788148989693515940.4556)
,p_plug_name=>unistr('\7AD9\70B9\7279\5B9A\7684\4EFB\52A1')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noDesc:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788149141438516546.4556)
,p_plug_name=>unistr('\5165\95E8')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788149365141517128.4556)
,p_plug_name=>unistr('\66F4\591A\4FE1\606F')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788149510285517814.4556)
,p_plug_name=>'Social Networking Links'
,p_region_css_classes=>'a-Login-social'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788149776764518791.4556)
,p_plug_name=>unistr('\4EFB\52A1')
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_api.id(781720832587518133.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1903077399430433037.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788098255248103123.4556)
,p_plug_name=>'Oracle Application Express'
,p_parent_plug_id=>wwv_flow_api.id(1903077399430433037.4556)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(788096697713098503.4556)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(784426701644840009.4556)
,p_plug_name=>unistr('\9700\8981\9644\52A0\4FE1\606F')
,p_parent_plug_id=>wwv_flow_api.id(788098255248103123.4556)
,p_region_css_classes=>'a-Login-message'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781705991385407800.4556)
...
'end loop;',
'return FALSE;'))
,p_required_patch=>wwv_flow_api.id(836093046470445605.4556)
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788095677913088930.4556)
,p_plug_name=>'List of Workspaces'
,p_parent_plug_id=>wwv_flow_api.id(788098255248103123.4556)
,p_component_template_options=>'a-MediaList--slim'
,p_plug_display_sequence=>50
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(788072921346081694.4556)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(781726379075536728.4556)
,p_translate_title=>'N'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(825234084074277602.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2024382717374138701.4556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1959512182339704219.4556)
,p_plug_name=>'Languages'
,p_parent_plug_id=>wwv_flow_api.id(1903077399430433037.4556)
,p_region_css_classes=>'a-Login-links a-Login-links--languages'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(355343217768869136.4556)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(788098255248103123.4556)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(787948171855029003.4556)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(788098255248103123.4556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20780723786489096.4556)
,p_name=>'P20_WORKSPACE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(355244609672857359.4556)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23554931773705253.4556)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5499919566405279.4556)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17346400590121618.4556)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
