...
Rem
Rem    DESCRIPTION
Rem      This script installs Application Express in a multitenant container database.
Rem
Rem    NOTES
...
Rem      cneumuel  11/28/2016 - Added phases parameter to call of apexins_nocdb.sql
...
host ^OH_HOME/perl/bin/perl -I ^OH_HOME/rdbms/admin ^OH_HOME/rdbms/admin/catcon.pl -b apexins_cdb apexins_nocdb.sql --p^1 --p^2 --p^3 --p^4 --p1,2,3
